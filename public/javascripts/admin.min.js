...
{parent:o.asJSON()}).replace("#new-page-container")})});this.post("#/pages/:page_id",function(j){Page.find(j.params.page_id);Page.create(j.params.page,function(o){h.refresh_pages=true;jQuery(".notice").text("Successfully created template");j.redirect("#/pages/"+o.id+"/edit")})});this.get("#/pages/:id",function(j){Galerie.close();this.loadPages(function(){var o=j.params.id,t=Page.find(o);if(!h.do_not_refresh){if(t)j.renderPagePreview(t);else{t=new Page({id:o});t.load(function(){j.renderPagePreview(t)})}h.modal=
