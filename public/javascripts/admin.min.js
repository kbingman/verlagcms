(function(c,a){function e(b){return d.isWindow(b)?b:b.nodeType===9?b.defaultView||b.parentWindow:false}function f(b){if(!fb[b]){var g=T.body,k=d("<"+b+">").appendTo(g),m=k.css("display");k.remove();if(m==="none"||m===""){Da||(Da=T.createElement("iframe"),Da.frameBorder=Da.width=Da.height=0);g.appendChild(Da);if(!Qa||!Da.createElement){Qa=(Da.contentWindow||Da.contentDocument).document;Qa.write((T.compatMode==="CSS1Compat"?"<!doctype html>":"")+"<html><body>");Qa.close()}k=Qa.createElement(b);Qa.body.appendChild(k);
...
this.style.overflowX,this.style.overflowY],d.css(this,"display")==="inline"&&d.css(this,"float")==="none"&&(d.support.inlineBlockNeedsLayout?(ba=f(this.nodeName),ba==="inline"?(this.style.display="inline-block"):(this.style.display="inline",this.style.zoom=1)):(this.style.display="inline-block")))}q.overflow!=null&&(this.style.overflow="hidden");for(N in b){t=new d.fx(this,q,N);G=b[N];oc.test(G)?t[G==="toggle"?z?"show":"hide":G]():(ha=pc.exec(G),fa=t.cur(),ha?(ja=parseFloat(ha[2]),za=ha[3]||(d.cssNumber[N]?
...
this.offsetParent||T.body;b&&!Fb.test(b.nodeName)&&d.css(b,"position")==="static";)b=b.offsetParent;return b})}});d.each(["Left","Top"],function(b,g){var k="scroll"+g;d.fn[k]=function(m){var o,q;if(m===a){o=this[0];if(!o)return null;return(q=e(o))?"pageXOffset"in q?q[b?"pageYOffset":"pageXOffset"]:d.support.boxModel&&q.document.documentElement[k]||q.document.body[k]:o[k]}return this.each(function(){(q=e(this))?q.scrollTo(b?d(q).scrollLeft():m,b?m:d(q).scrollTop()):(this[k]=m)})}});d.each(["Height",
...
(function(c,a){function e(h,l){var n=h.nodeName.toLowerCase();if("area"===n){n=h.parentNode;var v=n.name;if(!h.href||!v||n.nodeName.toLowerCase()!=="map")return false;n=c("img[usemap=#"+v+"]")[0];return!!n&&f(n)}return(/input|select|textarea|button|object/.test(n)?!h.disabled:"a"==n?h.href||l:l)&&f(h)}function f(h){return!c(h).parents().andSelf().filter(function(){return c.curCSS(this,"visibility")==="hidden"||c.expr.filters.hidden(this)}).length}c.ui=c.ui||{};if(!c.ui.version){c.extend(c.ui,{version:"1.8.16",
...
(function(c,a){if(c.cleanData){var e=c.cleanData;c.cleanData=function(h){for(var l=0,n;(n=h[l])!=null;l++)try{c(n).triggerHandler("remove")}catch(v){}e(h)}}else{var f=c.fn.remove;c.fn.remove=function(h,l){return this.each(function(){if(!l)if(!h||c.filter(h,[this]).length)c("*",this).add([this]).each(function(){try{c(this).triggerHandler("remove")}catch(n){}});return f.call(c(this),h,l)})}}c.widget=function(h,l,n){var v=h.split(".")[0],D;h=h.split(".")[1];D=v+"-"+h;if(!n){n=l;l=c.Widget}c.expr[":"][D]=
...
this.widgetName)},_mouseDown:function(e){if(!a){this._mouseStarted&&this._mouseUp(e);this._mouseDownEvent=e;var f=this,h=e.which==1,l=typeof this.options.cancel=="string"&&e.target.nodeName?c(e.target).closest(this.options.cancel).length:false;if(!h||l||!this._mouseCapture(e))return true;this.mouseDelayMet=!this.options.delay;if(!this.mouseDelayMet)this._mouseDelayTimer=setTimeout(function(){f.mouseDelayMet=true},this.options.delay);if(this._mouseDistanceMet(e)&&this._mouseDelayMet(e)){this._mouseStarted=
this._mouseStart(e)!==false;if(!this._mouseStarted){e.preventDefault();return true}}true===c.data(e.target,this.widgetName+".preventClickEvent")&&c.removeData(e.target,this.widgetName+".preventClickEvent");this._mouseMoveDelegate=function(n){return f._mouseMove(n)};this._mouseUpDelegate=function(n){return f._mouseUp(n)};c(document).bind("mousemove."+this.widgetName,this._mouseMoveDelegate).bind("mouseup."+this.widgetName,this._mouseUpDelegate);e.preventDefault();return a=true}},_mouseMove:function(e){if(c.browser.msie&&
...
_mouseDrag:function(a,e){this.position=this._generatePosition(a);this.positionAbs=this._convertPositionTo("absolute");if(!e){var f=this._uiHash();if(this._trigger("drag",a,f)===false){this._mouseUp({});return false}this.position=f.position}if(!this.options.axis||this.options.axis!="y")this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||this.options.axis!="x")this.helper[0].style.top=this.position.top+"px";c.ui.ddmanager&&c.ui.ddmanager.drag(this,a);return false},_mouseStop:function(a){var e=
false;if(c.ui.ddmanager&&!this.options.dropBehaviour)e=c.ui.ddmanager.drop(this,a);if(this.dropped){e=this.dropped;this.dropped=false}if((!this.element[0]||!this.element[0].parentNode)&&this.options.helper=="original")return false;if(this.options.revert=="invalid"&&!e||this.options.revert=="valid"&&e||this.options.revert===true||c.isFunction(this.options.revert)&&this.options.revert.call(this.element,e)){var f=this;c(this.helper).animate(this.originalPosition,parseInt(this.options.revertDuration,
...
(a.containment=="document"?0:c(window).scrollLeft())+c(a.containment=="document"?document:window).width()-this.helperProportions.width-this.margins.left,(a.containment=="document"?0:c(window).scrollTop())+(c(a.containment=="document"?document:window).height()||document.body.parentNode.scrollHeight)-this.helperProportions.height-this.margins.top];if(!/^(document|window|parent)$/.test(a.containment)&&a.containment.constructor!=Array){a=c(a.containment);var e=a[0];if(e){a.offset();var f=c(e).css("overflow")!=
"hidden";this.containment=[(parseInt(c(e).css("borderLeftWidth"),10)||0)+(parseInt(c(e).css("paddingLeft"),10)||0),(parseInt(c(e).css("borderTopWidth"),10)||0)+(parseInt(c(e).css("paddingTop"),10)||0),(f?Math.max(e.scrollWidth,e.offsetWidth):e.offsetWidth)-(parseInt(c(e).css("borderLeftWidth"),10)||0)-(parseInt(c(e).css("paddingRight"),10)||0)-this.helperProportions.width-this.margins.left-this.margins.right,(f?Math.max(e.scrollHeight,e.offsetHeight):e.offsetHeight)-(parseInt(c(e).css("borderTopWidth"),
10)||0)-(parseInt(c(e).css("paddingBottom"),10)||0)-this.helperProportions.height-this.margins.top-this.margins.bottom];this.relative_container=a}}else if(a.containment.constructor==Array)this.containment=a.containment},_convertPositionTo:function(a,e){if(!e)e=this.position;var f=a=="absolute"?1:-1,h=this.cssPosition=="absolute"&&!(this.scrollParent[0]!=document&&c.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,l=/(html|body)/i.test(h[0].tagName);return{top:e.top+
this.offset.relative.top*f+this.offset.parent.top*f-(c.browser.safari&&c.browser.version<526&&this.cssPosition=="fixed"?0:(this.cssPosition=="fixed"?-this.scrollParent.scrollTop():l?0:h.scrollTop())*f),left:e.left+this.offset.relative.left*f+this.offset.parent.left*f-(c.browser.safari&&c.browser.version<526&&this.cssPosition=="fixed"?0:(this.cssPosition=="fixed"?-this.scrollParent.scrollLeft():l?0:h.scrollLeft())*f)}},_generatePosition:function(a){var e=this.options,f=this.cssPosition=="absolute"&&
!(this.scrollParent[0]!=document&&c.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,h=/(html|body)/i.test(f[0].tagName),l=a.pageX,n=a.pageY;if(this.originalPosition){var v;if(this.containment){if(this.relative_container){v=this.relative_container.offset();v=[this.containment[0]+v.left,this.containment[1]+v.top,this.containment[2]+v.left,this.containment[3]+v.top]}else v=this.containment;if(a.pageX-this.offset.click.left<v[0])l=v[0]+this.offset.click.left;
...
this.instance.placeholder.remove();f._trigger("fromSortable",a);f.dropped=false}})}});c.ui.plugin.add("draggable","cursor",{start:function(){var a=c("body"),e=c(this).data("draggable").options;if(a.css("cursor"))e._cursor=a.css("cursor");a.css("cursor",e.cursor)},stop:function(){var a=c(this).data("draggable").options;a._cursor&&c("body").css("cursor",a._cursor)}});c.ui.plugin.add("draggable","opacity",{start:function(a,e){var f=c(e.helper),h=c(this).data("draggable").options;if(f.css("opacity"))h._opacity=
f.css("opacity");f.css("opacity",h.opacity)},stop:function(a,e){var f=c(this).data("draggable").options;f._opacity&&c(e.helper).css("opacity",f._opacity)}});c.ui.plugin.add("draggable","scroll",{start:function(){var a=c(this).data("draggable");if(a.scrollParent[0]!=document&&a.scrollParent[0].tagName!="HTML")a.overflowOffset=a.scrollParent.offset()},drag:function(a){var e=c(this).data("draggable"),f=e.options,h=false;if(e.scrollParent[0]!=document&&e.scrollParent[0].tagName!="HTML"){if(!f.axis||f.axis!=
"x")if(e.overflowOffset.top+e.scrollParent[0].offsetHeight-a.pageY<f.scrollSensitivity)e.scrollParent[0].scrollTop=h=e.scrollParent[0].scrollTop+f.scrollSpeed;else if(a.pageY-e.overflowOffset.top<f.scrollSensitivity)e.scrollParent[0].scrollTop=h=e.scrollParent[0].scrollTop-f.scrollSpeed;if(!f.axis||f.axis!="y")if(e.overflowOffset.left+e.scrollParent[0].offsetWidth-a.pageX<f.scrollSensitivity)e.scrollParent[0].scrollLeft=h=e.scrollParent[0].scrollLeft+f.scrollSpeed;else if(a.pageX-e.overflowOffset.left<
f.scrollSensitivity)e.scrollParent[0].scrollLeft=h=e.scrollParent[0].scrollLeft-f.scrollSpeed}else{if(!f.axis||f.axis!="x")if(a.pageY-c(document).scrollTop()<f.scrollSensitivity)h=c(document).scrollTop(c(document).scrollTop()-f.scrollSpeed);else if(c(window).height()-(a.pageY-c(document).scrollTop())<f.scrollSensitivity)h=c(document).scrollTop(c(document).scrollTop()+f.scrollSpeed);if(!f.axis||f.axis!="y")if(a.pageX-c(document).scrollLeft()<f.scrollSensitivity)h=c(document).scrollLeft(c(document).scrollLeft()-
f.scrollSpeed);else if(c(window).width()-(a.pageX-c(document).scrollLeft())<f.scrollSensitivity)h=c(document).scrollLeft(c(document).scrollLeft()+f.scrollSpeed)}h!==false&&c.ui.ddmanager&&!f.dropBehaviour&&c.ui.ddmanager.prepareOffsets(e,a)}});c.ui.plugin.add("draggable","snap",{start:function(){var a=c(this).data("draggable"),e=a.options;a.snapElements=[];c(e.snap.constructor!=String?e.snap.items||":data(draggable)":e.snap).each(function(){var f=c(this),h=f.offset();this!=a.element[0]&&a.snapElements.push({item:this,
width:f.outerWidth(),height:f.outerHeight(),top:h.top,left:h.left})})},drag:function(a,e){for(var f=c(this).data("draggable"),h=f.options,l=h.snapTolerance,n=e.offset.left,v=n+f.helperProportions.width,D=e.offset.top,C=D+f.helperProportions.height,O=f.snapElements.length-1;O>=0;O--){var P=f.snapElements[O].left,X=P+f.snapElements[O].width,ea=f.snapElements[O].top,ma=ea+f.snapElements[O].height;if(P-l<n&&n<X+l&&ea-l<D&&D<ma+l||P-l<n&&n<X+l&&ea-l<C&&C<ma+l||P-l<v&&v<X+l&&ea-l<D&&D<ma+l||P-l<v&&v<X+
l&&ea-l<C&&C<ma+l){if(h.snapMode!="inner"){var r=Math.abs(ea-C)<=l,u=Math.abs(ma-D)<=l,A=Math.abs(P-v)<=l,H=Math.abs(X-n)<=l;if(r)e.position.top=f._convertPositionTo("relative",{top:ea-f.helperProportions.height,left:0}).top-f.margins.top;if(u)e.position.top=f._convertPositionTo("relative",{top:ma,left:0}).top-f.margins.top;if(A)e.position.left=f._convertPositionTo("relative",{top:0,left:P-f.helperProportions.width}).left-f.margins.left;if(H)e.position.left=f._convertPositionTo("relative",{top:0,
left:X}).left-f.margins.left}var Z=r||u||A||H;if(h.snapMode!="outer"){r=Math.abs(ea-D)<=l;u=Math.abs(ma-C)<=l;A=Math.abs(P-n)<=l;H=Math.abs(X-v)<=l;if(r)e.position.top=f._convertPositionTo("relative",{top:ea,left:0}).top-f.margins.top;if(u)e.position.top=f._convertPositionTo("relative",{top:ma-f.helperProportions.height,left:0}).top-f.margins.top;if(A)e.position.left=f._convertPositionTo("relative",{top:0,left:P}).left-f.margins.left;if(H)e.position.left=f._convertPositionTo("relative",{top:0,left:X-
f.helperProportions.width}).left-f.margins.left}if(!f.snapElements[O].snapping&&(r||u||A||H||Z))f.options.snap.snap&&f.options.snap.snap.call(f.element,a,c.extend(f._uiHash(),{snapItem:f.snapElements[O].item}));f.snapElements[O].snapping=r||u||A||H||Z}else{f.snapElements[O].snapping&&f.options.snap.release&&f.options.snap.release.call(f.element,a,c.extend(f._uiHash(),{snapItem:f.snapElements[O].item}));f.snapElements[O].snapping=false}}}});c.ui.plugin.add("draggable","stack",{start:function(){var a=
c(this).data("draggable").options;a=c.makeArray(c(a.stack)).sort(function(f,h){return(parseInt(c(f).css("zIndex"),10)||0)-(parseInt(c(h).css("zIndex"),10)||0)});if(a.length){var e=parseInt(a[0].style.zIndex)||0;c(a).each(function(f){this.style.zIndex=e+f});this[0].style.zIndex=e+a.length}}});c.ui.plugin.add("draggable","zIndex",{start:function(a,e){var f=c(e.helper),h=c(this).data("draggable").options;if(f.css("zIndex"))h._zIndex=f.css("zIndex");f.css("zIndex",h.zIndex)},stop:function(a,e){var f=
c(this).data("draggable").options;f._zIndex&&c(e.helper).css("zIndex",f._zIndex)}})})(jQuery);
(function(c){c.widget("ui.droppable",{widgetEventPrefix:"drop",options:{accept:"*",activeClass:false,addClasses:true,greedy:false,hoverClass:false,scope:"default",tolerance:"intersect"},_create:function(){var a=this.options,e=a.accept;this.isover=0;this.isout=1;this.accept=c.isFunction(e)?e:function(f){return f.is(e)};this.proportions={width:this.element[0].offsetWidth,height:this.element[0].offsetHeight};c.ui.ddmanager.droppables[a.scope]=c.ui.ddmanager.droppables[a.scope]||[];c.ui.ddmanager.droppables[a.scope].push(this);
a.addClasses&&this.element.addClass("ui-droppable")},destroy:function(){for(var a=c.ui.ddmanager.droppables[this.options.scope],e=0;e<a.length;e++)a[e]==this&&a.splice(e,1);this.element.removeClass("ui-droppable ui-droppable-disabled").removeData("droppable").unbind(".droppable");return this},_setOption:function(a,e){if(a=="accept")this.accept=c.isFunction(e)?e:function(f){return f.is(e)};c.Widget.prototype._setOption.apply(this,arguments)},_activate:function(a){var e=c.ui.ddmanager.current;this.options.activeClass&&
...
this._trigger("over",a,this.ui(e))}},_out:function(a){var e=c.ui.ddmanager.current;if(!(!e||(e.currentItem||e.element)[0]==this.element[0]))if(this.accept.call(this.element[0],e.currentItem||e.element)){this.options.hoverClass&&this.element.removeClass(this.options.hoverClass);this._trigger("out",a,this.ui(e))}},_drop:function(a,e){var f=e||c.ui.ddmanager.current;if(!f||(f.currentItem||f.element)[0]==this.element[0])return false;var h=false;this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function(){var l=
c.data(this,"droppable");if(l.options.greedy&&!l.options.disabled&&l.options.scope==f.options.scope&&l.accept.call(l.element[0],f.currentItem||f.element)&&c.ui.intersect(f,c.extend(l,{offset:l.element.offset()}),l.options.tolerance)){h=true;return false}});if(h)return false;if(this.accept.call(this.element[0],f.currentItem||f.element)){this.options.activeClass&&this.element.removeClass(this.options.activeClass);this.options.hoverClass&&this.element.removeClass(this.options.hoverClass);this._trigger("drop",
a,this.ui(f));return this.element}return false},ui:function(a){return{draggable:a.currentItem||a.element,helper:a.helper,position:a.position,offset:a.positionAbs}}});c.extend(c.ui.droppable,{version:"1.8.16"});c.ui.intersect=function(a,e,f){if(!e.offset)return false;var h=(a.positionAbs||a.position.absolute).left,l=h+a.helperProportions.width,n=(a.positionAbs||a.position.absolute).top,v=n+a.helperProportions.height,D=e.offset.left,C=D+e.proportions.width,O=e.offset.top,P=O+e.proportions.height;switch(f){case "fit":return D<=
h&&l<=C&&O<=n&&v<=P;case "intersect":return D<h+a.helperProportions.width/2&&l-a.helperProportions.width/2<C&&O<n+a.helperProportions.height/2&&v-a.helperProportions.height/2<P;case "pointer":return c.ui.isOver((a.positionAbs||a.position.absolute).top+(a.clickOffset||a.offset.click).top,(a.positionAbs||a.position.absolute).left+(a.clickOffset||a.offset.click).left,O,D,e.proportions.height,e.proportions.width);case "touch":return(n>=O&&n<=P||v>=O&&v<=P||n<O&&v>P)&&(h>=D&&h<=C||l>=D&&l<=C||h<D&&l>C);
default:return false}};c.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(a,e){var f=c.ui.ddmanager.droppables[a.options.scope]||[],h=e?e.type:null,l=(a.currentItem||a.element).find(":data(droppable)").andSelf(),n=0;a:for(;n<f.length;n++)if(!(f[n].options.disabled||a&&!f[n].accept.call(f[n].element[0],a.currentItem||a.element))){for(var v=0;v<l.length;v++)if(l[v]==f[n].element[0]){f[n].proportions.height=0;continue a}f[n].visible=f[n].element.css("display")!="none";if(f[n].visible){h==
"mousedown"&&f[n]._activate.call(f[n],e);f[n].offset=f[n].element.offset();f[n].proportions={width:f[n].element[0].offsetWidth,height:f[n].element[0].offsetHeight}}}},drop:function(a,e){var f=false;c.each(c.ui.ddmanager.droppables[a.options.scope]||[],function(){if(this.options){if(!this.options.disabled&&this.visible&&c.ui.intersect(a,this,this.options.tolerance))f=f||this._drop.call(this,e);if(!this.options.disabled&&this.visible&&this.accept.call(this.element[0],a.currentItem||a.element)){this.isout=
1;this.isover=0;this._deactivate.call(this,e)}}});return f},dragStart:function(a,e){a.element.parents(":not(body,html)").bind("scroll.droppable",function(){a.options.refreshPositions||c.ui.ddmanager.prepareOffsets(a,e)})},drag:function(a,e){a.options.refreshPositions&&c.ui.ddmanager.prepareOffsets(a,e);c.each(c.ui.ddmanager.droppables[a.options.scope]||[],function(){if(!(this.options.disabled||this.greedyChild||!this.visible)){var f=c.ui.intersect(a,this,this.options.tolerance);if(f=!f&&this.isover==
1?"isout":f&&this.isover==0?"isover":null){var h;if(this.options.greedy){var l=this.element.parents(":data(droppable):eq(0)");if(l.length){h=c.data(l[0],"droppable");h.greedyChild=f=="isover"?1:0}}if(h&&f=="isover"){h.isover=0;h.isout=1;h._out.call(h,e)}this[f]=1;this[f=="isout"?"isover":"isout"]=0;this[f=="isover"?"_over":"_out"].call(this,e);if(h&&f=="isout"){h.isout=0;h.isover=1;h._over.call(h,e)}}}})},dragStop:function(a,e){a.element.parents(":not(body,html)").unbind("scroll.droppable");a.options.refreshPositions||
c.ui.ddmanager.prepareOffsets(a,e)}}})(jQuery);
(function(c){c.widget("ui.resizable",c.ui.mouse,{widgetEventPrefix:"resize",options:{alsoResize:false,animate:false,animateDuration:"slow",animateEasing:"swing",aspectRatio:false,autoHide:false,containment:false,ghost:false,grid:false,handles:"e,s,se",helper:false,maxHeight:null,maxWidth:null,minHeight:10,minWidth:10,zIndex:1E3},_create:function(){var f=this,h=this.options;this.element.addClass("ui-resizable");c.extend(this,{_aspectRatio:!!h.aspectRatio,aspectRatio:h.aspectRatio,originalElement:this.element,
...
this._handles.mouseover(function(){if(!f.resizing){if(this.className)var C=this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i);f.axis=C&&C[1]?C[1]:"se"}});if(h.autoHide){this._handles.hide();c(this.element).addClass("ui-resizable-autohide").hover(function(){if(!h.disabled){c(this).removeClass("ui-resizable-autohide");f._handles.show()}},function(){if(!h.disabled)if(!f.resizing){c(this).addClass("ui-resizable-autohide");f._handles.hide()}})}this._mouseInit()},destroy:function(){this._mouseDestroy();
var f=function(l){c(l).removeClass("ui-resizable ui-resizable-disabled ui-resizable-resizing").removeData("resizable").unbind(".resizable").find(".ui-resizable-handle").remove()};if(this.elementIsWrapper){f(this.element);var h=this.element;h.after(this.originalElement.css({position:h.css("position"),width:h.outerWidth(),height:h.outerHeight(),top:h.css("top"),left:h.css("left")})).remove()}this.originalElement.css("resize",this.originalResizeStyle);f(this.originalElement);return this},_mouseCapture:function(f){var h=
false;for(var l in this.handles)if(c(this.handles[l])[0]==f.target)h=true;return!this.options.disabled&&h},_mouseStart:function(f){var h=this.options,l=this.element.position(),n=this.element;this.resizing=true;this.documentScroll={top:c(document).scrollTop(),left:c(document).scrollLeft()};if(n.is(".ui-draggable")||/absolute/.test(n.css("position")))n.css({position:"absolute",top:l.top,left:l.left});c.browser.opera&&/relative/.test(n.css("position"))&&n.css({position:"relative",top:"auto",left:"auto"});
...
{width:n.outerWidth()-n.width(),height:n.outerHeight()-n.height()};this.originalMousePosition={left:f.pageX,top:f.pageY};this.aspectRatio=typeof h.aspectRatio=="number"?h.aspectRatio:this.originalSize.width/this.originalSize.height||1;h=c(".ui-resizable-"+this.axis).css("cursor");c("body").css("cursor",h=="auto"?this.axis+"-resize":h);n.addClass("ui-resizable-resizing");this._propagate("start",f);return true},_mouseDrag:function(f){var h=this.helper,l=this.originalMousePosition,n=this._change[this.axis];
if(!n)return false;l=n.apply(this,[f,f.pageX-l.left||0,f.pageY-l.top||0]);this._updateVirtualBoundaries(f.shiftKey);if(this._aspectRatio||f.shiftKey)l=this._updateRatio(l,f);l=this._respectSize(l,f);this._propagate("resize",f);h.css({top:this.position.top+"px",left:this.position.left+"px",width:this.size.width+"px",height:this.size.height+"px"});!this._helper&&this._proportionallyResizeElements.length&&this._proportionallyResize();this._updateCache(l);this._trigger("resize",f,this.ui());return false},
_mouseStop:function(f){this.resizing=false;var h=this.options;if(this._helper){var l=this._proportionallyResizeElements,n=l.length&&/textarea/i.test(l[0].nodeName);l=n&&c.ui.hasScroll(l[0],"left")?0:this.sizeDiff.height;n=n?0:this.sizeDiff.width;n={width:this.helper.width()-n,height:this.helper.height()-l};l=parseInt(this.element.css("left"),10)+(this.position.left-this.originalPosition.left)||null;var v=parseInt(this.element.css("top"),10)+(this.position.top-this.originalPosition.top)||null;h.animate||
this.element.css(c.extend(n,{top:v,left:l}));this.helper.height(this.size.height);this.helper.width(this.size.width);this._helper&&!h.animate&&this._proportionallyResize()}c("body").css("cursor","auto");this.element.removeClass("ui-resizable-resizing");this._propagate("stop",f);this._helper&&this.helper.remove();return false},_updateVirtualBoundaries:function(f){var h=this.options,l,n,v;h={minWidth:e(h.minWidth)?h.minWidth:0,maxWidth:e(h.maxWidth)?h.maxWidth:Infinity,minHeight:e(h.minHeight)?h.minHeight:
0,maxHeight:e(h.maxHeight)?h.maxHeight:Infinity};if(this._aspectRatio||f){f=h.minHeight*this.aspectRatio;n=h.minWidth/this.aspectRatio;l=h.maxHeight*this.aspectRatio;v=h.maxWidth/this.aspectRatio;if(f>h.minWidth)h.minWidth=f;if(n>h.minHeight)h.minHeight=n;if(l<h.maxWidth)h.maxWidth=l;if(v<h.maxHeight)h.maxHeight=v}this._vBoundaries=h},_updateCache:function(f){this.offset=this.helper.offset();if(e(f.left))this.position.left=f.left;if(e(f.top))this.position.top=f.top;if(e(f.height))this.size.height=
f.height;if(e(f.width))this.size.width=f.width},_updateRatio:function(f){var h=this.position,l=this.size,n=this.axis;if(e(f.height))f.width=f.height*this.aspectRatio;else if(e(f.width))f.height=f.width/this.aspectRatio;if(n=="sw"){f.left=h.left+(l.width-f.width);f.top=null}if(n=="nw"){f.top=h.top+(l.height-f.height);f.left=h.left+(l.width-f.width)}return f},_respectSize:function(f){var h=this._vBoundaries,l=this.axis,n=e(f.width)&&h.maxWidth&&h.maxWidth<f.width,v=e(f.height)&&h.maxHeight&&h.maxHeight<
f.height,D=e(f.width)&&h.minWidth&&h.minWidth>f.width,C=e(f.height)&&h.minHeight&&h.minHeight>f.height;if(D)f.width=h.minWidth;if(C)f.height=h.minHeight;if(n)f.width=h.maxWidth;if(v)f.height=h.maxHeight;var O=this.originalPosition.left+this.originalSize.width,P=this.position.top+this.size.height,X=/sw|nw|w/.test(l);l=/nw|ne|n/.test(l);if(D&&X)f.left=O-h.minWidth;if(n&&X)f.left=O-h.maxWidth;if(C&&l)f.top=P-h.minHeight;if(v&&l)f.top=P-h.maxHeight;if((h=!f.width&&!f.height)&&!f.left&&f.top)f.top=null;
else if(h&&!f.top&&f.left)f.left=null;return f},_proportionallyResize:function(){if(this._proportionallyResizeElements.length)for(var f=this.helper||this.element,h=0;h<this._proportionallyResizeElements.length;h++){var l=this._proportionallyResizeElements[h];if(!this.borderDif){var n=[l.css("borderTopWidth"),l.css("borderRightWidth"),l.css("borderBottomWidth"),l.css("borderLeftWidth")],v=[l.css("paddingTop"),l.css("paddingRight"),l.css("paddingBottom"),l.css("paddingLeft")];this.borderDif=c.map(n,
function(D,C){var O=parseInt(D,10)||0,P=parseInt(v[C],10)||0;return O+P})}c.browser.msie&&(c(f).is(":hidden")||c(f).parents(":hidden").length)||l.css({height:f.height()-this.borderDif[0]-this.borderDif[2]||0,width:f.width()-this.borderDif[1]-this.borderDif[3]||0})}},_renderProxy:function(){var f=this.options;this.elementOffset=this.element.offset();if(this._helper){this.helper=this.helper||c('<div style="overflow:hidden;"></div>');var h=c.browser.msie&&c.browser.version<7,l=h?1:0;h=h?2:-1;this.helper.addClass(this._helper).css({width:this.element.outerWidth()+
h,height:this.element.outerHeight()+h,position:"absolute",left:this.elementOffset.left-l+"px",top:this.elementOffset.top-l+"px",zIndex:++f.zIndex});this.helper.appendTo("body").disableSelection()}else this.helper=this.element},_change:{e:function(f,h){return{width:this.originalSize.width+h}},w:function(f,h){return{left:this.originalPosition.left+h,width:this.originalSize.width-h}},n:function(f,h,l){return{top:this.originalPosition.top+l,height:this.originalSize.height-l}},s:function(f,h,l){return{height:this.originalSize.height+
l}},se:function(f,h,l){return c.extend(this._change.s.apply(this,arguments),this._change.e.apply(this,[f,h,l]))},sw:function(f,h,l){return c.extend(this._change.s.apply(this,arguments),this._change.w.apply(this,[f,h,l]))},ne:function(f,h,l){return c.extend(this._change.n.apply(this,arguments),this._change.e.apply(this,[f,h,l]))},nw:function(f,h,l){return c.extend(this._change.n.apply(this,arguments),this._change.w.apply(this,[f,h,l]))}},_propagate:function(f,h){c.ui.plugin.call(this,f,[h,this.ui()]);
f!="resize"&&this._trigger(f,h,this.ui())},plugins:{},ui:function(){return{originalElement:this.originalElement,element:this.element,helper:this.helper,position:this.position,size:this.size,originalSize:this.originalSize,originalPosition:this.originalPosition}}});c.extend(c.ui.resizable,{version:"1.8.16"});c.ui.plugin.add("resizable","alsoResize",{start:function(){var f=c(this).data("resizable").options,h=function(l){c(l).each(function(){var n=c(this);n.data("resizable-alsoresize",{width:parseInt(n.width(),
10),height:parseInt(n.height(),10),left:parseInt(n.css("left"),10),top:parseInt(n.css("top"),10),position:n.css("position")})})};if(typeof f.alsoResize=="object"&&!f.alsoResize.parentNode)if(f.alsoResize.length){f.alsoResize=f.alsoResize[0];h(f.alsoResize)}else c.each(f.alsoResize,function(l){h(l)});else h(f.alsoResize)},resize:function(f,h){var l=c(this).data("resizable"),n=l.options,v=l.originalSize,D=l.originalPosition,C={height:l.size.height-v.height||0,width:l.size.width-v.width||0,top:l.position.top-
...
!n.alsoResize.nodeType?c.each(n.alsoResize,function(P,X){O(P,X)}):O(n.alsoResize)},stop:function(){var f=c(this).data("resizable"),h=f.options,l=function(n){c(n).each(function(){var v=c(this);v.css({position:v.data("resizable-alsoresize").position})})};if(f._revertToRelativePosition){f._revertToRelativePosition=false;typeof h.alsoResize=="object"&&!h.alsoResize.nodeType?c.each(h.alsoResize,function(n){l(n)}):l(h.alsoResize)}c(this).removeData("resizable-alsoresize")}});c.ui.plugin.add("resizable",
"animate",{stop:function(f){var h=c(this).data("resizable"),l=h.options,n=h._proportionallyResizeElements,v=n.length&&/textarea/i.test(n[0].nodeName),D=v&&c.ui.hasScroll(n[0],"left")?0:h.sizeDiff.height;v={width:h.size.width-(v?0:h.sizeDiff.width),height:h.size.height-D};D=parseInt(h.element.css("left"),10)+(h.position.left-h.originalPosition.left)||null;var C=parseInt(h.element.css("top"),10)+(h.position.top-h.originalPosition.top)||null;h.element.animate(c.extend(v,C&&D?{top:C,left:D}:{}),{duration:l.animateDuration,
easing:l.animateEasing,step:function(){var O={width:parseInt(h.element.css("width"),10),height:parseInt(h.element.css("height"),10),top:parseInt(h.element.css("top"),10),left:parseInt(h.element.css("left"),10)};n&&n.length&&c(n[0]).css({width:O.width,height:O.height});h._updateCache(O);h._propagate("resize",f)}})}});c.ui.plugin.add("resizable","containment",{start:function(){var f=c(this).data("resizable"),h=f.element,l=f.options.containment;if(h=l instanceof c?l.get(0):/parent/.test(l)?h.parent().get(0):
l){f.containerElement=c(h);if(/document/.test(l)||l==document){f.containerOffset={left:0,top:0};f.containerPosition={left:0,top:0};f.parentData={element:c(document),left:0,top:0,width:c(document).width(),height:c(document).height()||document.body.parentNode.scrollHeight}}else{var n=c(h),v=[];c(["Top","Right","Left","Bottom"]).each(function(O,P){v[O]=a(n.css("padding"+P))});f.containerOffset=n.offset();f.containerPosition=n.position();f.containerSize={height:n.innerHeight()-v[3],width:n.innerWidth()-
v[1]};l=f.containerOffset;var D=f.containerSize.height,C=f.containerSize.width;C=c.ui.hasScroll(h,"left")?h.scrollWidth:C;D=c.ui.hasScroll(h)?h.scrollHeight:D;f.parentData={element:h,left:l.left,top:l.top,width:C,height:D}}}},resize:function(f){var h=c(this).data("resizable"),l=h.options,n=h.containerOffset,v=h.position;f=h._aspectRatio||f.shiftKey;var D={top:0,left:0},C=h.containerElement;if(C[0]!=document&&/static/.test(C.css("position")))D=n;if(v.left<(h._helper?n.left:0)){h.size.width+=h._helper?
h.position.left-n.left:h.position.left-D.left;if(f)h.size.height=h.size.width/l.aspectRatio;h.position.left=l.helper?n.left:0}if(v.top<(h._helper?n.top:0)){h.size.height+=h._helper?h.position.top-n.top:h.position.top;if(f)h.size.width=h.size.height*l.aspectRatio;h.position.top=h._helper?n.top:0}h.offset.left=h.parentData.left+h.position.left;h.offset.top=h.parentData.top+h.position.top;l=Math.abs((h._helper?h.offset.left-D.left:h.offset.left-D.left)+h.sizeDiff.width);n=Math.abs((h._helper?h.offset.top-
D.top:h.offset.top-n.top)+h.sizeDiff.height);v=h.containerElement.get(0)==h.element.parent().get(0);D=/relative|absolute/.test(h.containerElement.css("position"));if(v&&D)l-=h.parentData.left;if(l+h.size.width>=h.parentData.width){h.size.width=h.parentData.width-l;if(f)h.size.height=h.size.width/h.aspectRatio}if(n+h.size.height>=h.parentData.height){h.size.height=h.parentData.height-n;if(f)h.size.width=h.size.height*h.aspectRatio}},stop:function(){var f=c(this).data("resizable"),h=f.options,l=f.containerOffset,
n=f.containerPosition,v=f.containerElement,D=c(f.helper),C=D.offset(),O=D.outerWidth()-f.sizeDiff.width;D=D.outerHeight()-f.sizeDiff.height;f._helper&&!h.animate&&/relative/.test(v.css("position"))&&c(this).css({left:C.left-n.left-l.left,width:O,height:D});f._helper&&!h.animate&&/static/.test(v.css("position"))&&c(this).css({left:C.left-n.left-l.left,width:O,height:D})}});c.ui.plugin.add("resizable","ghost",{start:function(){var f=c(this).data("resizable"),h=f.options,l=f.size;f.ghost=f.originalElement.clone();
f.ghost.css({opacity:0.25,display:"block",position:"relative",height:l.height,width:l.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass(typeof h.ghost=="string"?h.ghost:"");f.ghost.appendTo(f.helper)},resize:function(){var f=c(this).data("resizable");f.ghost&&f.ghost.css({position:"relative",height:f.size.height,width:f.size.width})},stop:function(){var f=c(this).data("resizable");f.ghost&&f.helper&&f.helper.get(0).removeChild(f.ghost.get(0))}});c.ui.plugin.add("resizable","grid",
{resize:function(){var f=c(this).data("resizable"),h=f.options,l=f.size,n=f.originalSize,v=f.originalPosition,D=f.axis;h.grid=typeof h.grid=="number"?[h.grid,h.grid]:h.grid;var C=Math.round((l.width-n.width)/(h.grid[0]||1))*(h.grid[0]||1);h=Math.round((l.height-n.height)/(h.grid[1]||1))*(h.grid[1]||1);if(/^(se|s|e)$/.test(D)){f.size.width=n.width+C;f.size.height=n.height+h}else if(/^(ne)$/.test(D)){f.size.width=n.width+C;f.size.height=n.height+h;f.position.top=v.top-h}else{if(/^(sw)$/.test(D)){f.size.width=
n.width+C;f.size.height=n.height+h}else{f.size.width=n.width+C;f.size.height=n.height+h;f.position.top=v.top-h}f.position.left=v.left-C}}});var a=function(f){return parseInt(f,10)||0},e=function(f){return!isNaN(parseInt(f,10))}})(jQuery);
(function(c){c.widget("ui.selectable",c.ui.mouse,{options:{appendTo:"body",autoRefresh:true,distance:0,filter:"*",tolerance:"touch"},_create:function(){var a=this;this.element.addClass("ui-selectable");this.dragged=false;var e;this.refresh=function(){e=c(a.options.filter,a.element[0]);e.each(function(){var f=c(this),h=f.offset();c.data(this,"selectable-item",{element:this,$element:f,left:h.left,top:h.top,right:h.left+f.outerWidth(),bottom:h.top+f.outerHeight(),startselected:false,selected:f.hasClass("ui-selected"),
...
a.pageY];if(!this.options.disabled){var f=this.options;this.selectees=c(f.filter,this.element[0]);this._trigger("start",a);c(f.appendTo).append(this.helper);this.helper.css({left:a.clientX,top:a.clientY,width:0,height:0});f.autoRefresh&&this.refresh();this.selectees.filter(".ui-selected").each(function(){var h=c.data(this,"selectable-item");h.startselected=true;if(!a.metaKey){h.$element.removeClass("ui-selected");h.selected=false;h.$element.addClass("ui-unselecting");h.unselecting=true;e._trigger("unselecting",
a,{unselecting:h.element})}});c(a.target).parents().andSelf().each(function(){var h=c.data(this,"selectable-item");if(h){var l=!a.metaKey||!h.$element.hasClass("ui-selected");h.$element.removeClass(l?"ui-unselecting":"ui-selected").addClass(l?"ui-selecting":"ui-unselecting");h.unselecting=!l;h.selecting=l;(h.selected=l)?e._trigger("selecting",a,{selecting:h.element}):e._trigger("unselecting",a,{unselecting:h.element});return false}})}},_mouseDrag:function(a){var e=this;this.dragged=true;if(!this.options.disabled){var f=
this.options,h=this.opos[0],l=this.opos[1],n=a.pageX,v=a.pageY;if(h>n){var D=n;n=h;h=D}if(l>v){D=v;v=l;l=D}this.helper.css({left:h,top:l,width:n-h,height:v-l});this.selectees.each(function(){var C=c.data(this,"selectable-item");if(!(!C||C.element==e.element[0])){var O=false;if(f.tolerance=="touch")O=!(C.left>n||C.right<h||C.top>v||C.bottom<l);else if(f.tolerance=="fit")O=C.left>h&&C.right<n&&C.top>l&&C.bottom<v;if(O){if(C.selected){C.$element.removeClass("ui-selected");C.selected=false}if(C.unselecting){C.$element.removeClass("ui-unselecting");
C.unselecting=false}if(!C.selecting){C.$element.addClass("ui-selecting");C.selecting=true;e._trigger("selecting",a,{selecting:C.element})}}else{if(C.selecting)if(a.metaKey&&C.startselected){C.$element.removeClass("ui-selecting");C.selecting=false;C.$element.addClass("ui-selected");C.selected=true}else{C.$element.removeClass("ui-selecting");C.selecting=false;if(C.startselected){C.$element.addClass("ui-unselecting");C.unselecting=true}e._trigger("unselecting",a,{unselecting:C.element})}if(C.selected)if(!a.metaKey&&
!C.startselected){C.$element.removeClass("ui-selected");C.selected=false;C.$element.addClass("ui-unselecting");C.unselecting=true;e._trigger("unselecting",a,{unselecting:C.element})}}}});return false}},_mouseStop:function(a){var e=this;this.dragged=false;c(".ui-unselecting",this.element[0]).each(function(){var f=c.data(this,"selectable-item");f.$element.removeClass("ui-unselecting");f.unselecting=false;f.startselected=false;e._trigger("unselected",a,{unselected:f.element})});c(".ui-selecting",this.element[0]).each(function(){var f=
c.data(this,"selectable-item");f.$element.removeClass("ui-selecting").addClass("ui-selected");f.selecting=false;f.selected=true;f.startselected=true;e._trigger("selected",a,{selected:f.element})});this._trigger("stop",a);this.helper.remove();return false}});c.extend(c.ui.selectable,{version:"1.8.16"})})(jQuery);
...
return true},_mouseDrag:function(a){this.position=this._generatePosition(a);this.positionAbs=this._convertPositionTo("absolute");if(!this.lastPositionAbs)this.lastPositionAbs=this.positionAbs;if(this.options.scroll){var e=this.options,f=false;if(this.scrollParent[0]!=document&&this.scrollParent[0].tagName!="HTML"){if(this.overflowOffset.top+this.scrollParent[0].offsetHeight-a.pageY<e.scrollSensitivity)this.scrollParent[0].scrollTop=f=this.scrollParent[0].scrollTop+e.scrollSpeed;else if(a.pageY-this.overflowOffset.top<
e.scrollSensitivity)this.scrollParent[0].scrollTop=f=this.scrollParent[0].scrollTop-e.scrollSpeed;if(this.overflowOffset.left+this.scrollParent[0].offsetWidth-a.pageX<e.scrollSensitivity)this.scrollParent[0].scrollLeft=f=this.scrollParent[0].scrollLeft+e.scrollSpeed;else if(a.pageX-this.overflowOffset.left<e.scrollSensitivity)this.scrollParent[0].scrollLeft=f=this.scrollParent[0].scrollLeft-e.scrollSpeed}else{if(a.pageY-c(document).scrollTop()<e.scrollSensitivity)f=c(document).scrollTop(c(document).scrollTop()-
e.scrollSpeed);else if(c(window).height()-(a.pageY-c(document).scrollTop())<e.scrollSensitivity)f=c(document).scrollTop(c(document).scrollTop()+e.scrollSpeed);if(a.pageX-c(document).scrollLeft()<e.scrollSensitivity)f=c(document).scrollLeft(c(document).scrollLeft()-e.scrollSpeed);else if(c(window).width()-(a.pageX-c(document).scrollLeft())<e.scrollSensitivity)f=c(document).scrollLeft(c(document).scrollLeft()+e.scrollSpeed)}f!==false&&c.ui.ddmanager&&!e.dropBehaviour&&c.ui.ddmanager.prepareOffsets(this,
a)}this.positionAbs=this._convertPositionTo("absolute");if(!this.options.axis||this.options.axis!="y")this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||this.options.axis!="x")this.helper[0].style.top=this.position.top+"px";for(e=this.items.length-1;e>=0;e--){f=this.items[e];var h=f.item[0],l=this._intersectsWithPointer(f);if(l)if(h!=this.currentItem[0]&&this.placeholder[l==1?"next":"prev"]()[0]!=h&&!c.ui.contains(this.placeholder[0],h)&&(this.options.type=="semi-dynamic"?!c.ui.contains(this.element[0],
h):true)){this.direction=l==1?"down":"up";if(this.options.tolerance=="pointer"||this._intersectsWithSides(f))this._rearrange(a,f);else break;this._trigger("change",a,this._uiHash());break}}this._contactContainers(a);c.ui.ddmanager&&c.ui.ddmanager.drag(this,a);this._trigger("sort",a,this._uiHash());this.lastPositionAbs=this.positionAbs;return false},_mouseStop:function(a,e){if(a){c.ui.ddmanager&&!this.options.dropBehaviour&&c.ui.ddmanager.drop(this,a);if(this.options.revert){var f=this,h=f.placeholder.offset();
f.reverting=true;c(this.helper).animate({left:h.left-this.offset.parent.left-f.margins.left+(this.offsetParent[0]==document.body?0:this.offsetParent[0].scrollLeft),top:h.top-this.offset.parent.top-f.margins.top+(this.offsetParent[0]==document.body?0:this.offsetParent[0].scrollTop)},parseInt(this.options.revert,10)||500,function(){f._clear(a)})}else this._clear(a,e);return false}},cancel:function(){if(this.dragging){this._mouseUp({target:null});this.options.helper=="original"?this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper"):
...
{helper:null,dragging:false,reverting:false,_noFinalSort:null});this.domPosition.prev?c(this.domPosition.prev).after(this.currentItem):c(this.domPosition.parent).prepend(this.currentItem)}return this},serialize:function(a){var e=this._getItemsAsjQuery(a&&a.connected),f=[];a=a||{};c(e).each(function(){var h=(c(a.item||this).attr(a.attribute||"id")||"").match(a.expression||/(.+)[-=_](.+)/);if(h)f.push((a.key||h[1]+"[]")+"="+(a.key&&a.expression?h[1]:h[2]))});!f.length&&a.key&&f.push(a.key+"=");return f.join("&")},
toArray:function(a){var e=this._getItemsAsjQuery(a&&a.connected),f=[];a=a||{};e.each(function(){f.push(c(a.item||this).attr(a.attribute||"id")||"")});return f},_intersectsWith:function(a){var e=this.positionAbs.left,f=e+this.helperProportions.width,h=this.positionAbs.top,l=h+this.helperProportions.height,n=a.left,v=n+a.width,D=a.top,C=D+a.height,O=this.offset.click.top,P=this.offset.click.left;return this.options.tolerance=="pointer"||this.options.forcePointerForContainers||this.options.tolerance!=
"pointer"&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?h+O>D&&h+O<C&&e+P>n&&e+P<v:n<e+this.helperProportions.width/2&&f-this.helperProportions.width/2<v&&D<h+this.helperProportions.height/2&&l-this.helperProportions.height/2<C},_intersectsWithPointer:function(a){var e=c.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,a.top,a.height);a=c.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,a.left,a.width);e=e&&a;a=this._getDragVerticalDirection();
var f=this._getDragHorizontalDirection();if(!e)return false;return this.floating?f&&f=="right"||a=="down"?2:1:a&&(a=="down"?2:1)},_intersectsWithSides:function(a){var e=c.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,a.top+a.height/2,a.height);a=c.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,a.left+a.width/2,a.width);var f=this._getDragVerticalDirection(),h=this._getDragHorizontalDirection();return this.floating&&h?h=="right"&&a||h=="left"&&!a:f&&(f=="down"&&e||f=="up"&&!e)},
_getDragVerticalDirection:function(){var a=this.positionAbs.top-this.lastPositionAbs.top;return a!=0&&(a>0?"down":"up")},_getDragHorizontalDirection:function(){var a=this.positionAbs.left-this.lastPositionAbs.left;return a!=0&&(a>0?"right":"left")},refresh:function(a){this._refreshItems(a);this.refreshPositions();return this},_connectWith:function(){var a=this.options;return a.connectWith.constructor==String?[a.connectWith]:a.connectWith},_getItemsAsjQuery:function(a){var e=[],f=[],h=this._connectWith();
if(h&&a)for(a=h.length-1;a>=0;a--)for(var l=c(h[a]),n=l.length-1;n>=0;n--){var v=c.data(l[n],"sortable");if(v&&v!=this&&!v.options.disabled)f.push([c.isFunction(v.options.items)?v.options.items.call(v.element):c(v.options.items,v.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),v])}f.push([c.isFunction(this.options.items)?this.options.items.call(this.element,null,{options:this.options,item:this.currentItem}):c(this.options.items,this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),
this]);for(a=f.length-1;a>=0;a--)f[a][0].each(function(){e.push(this)});return c(e)},_removeCurrentsFromItems:function(){for(var a=this.currentItem.find(":data(sortable-item)"),e=0;e<this.items.length;e++)for(var f=0;f<a.length;f++)a[f]==this.items[e].item[0]&&this.items.splice(e,1)},_refreshItems:function(a){this.items=[];this.containers=[this];var e=this.items,f=[[c.isFunction(this.options.items)?this.options.items.call(this.element[0],a,{item:this.currentItem}):c(this.options.items,this.element),
this]],h=this._connectWith();if(h)for(var l=h.length-1;l>=0;l--)for(var n=c(h[l]),v=n.length-1;v>=0;v--){var D=c.data(n[v],"sortable");if(D&&D!=this&&!D.options.disabled){f.push([c.isFunction(D.options.items)?D.options.items.call(D.element[0],a,{item:this.currentItem}):c(D.options.items,D.element),D]);this.containers.push(D)}}for(l=f.length-1;l>=0;l--){a=f[l][1];h=f[l][0];v=0;for(n=h.length;v<n;v++){D=c(h[v]);D.data("sortable-item",a);e.push({item:D,instance:a,width:0,height:0,left:0,top:0})}}},refreshPositions:function(a){if(this.offsetParent&&
this.helper)this.offset.parent=this._getParentOffset();for(var e=this.items.length-1;e>=0;e--){var f=this.items[e];if(!(f.instance!=this.currentContainer&&this.currentContainer&&f.item[0]!=this.currentItem[0])){var h=this.options.toleranceElement?c(this.options.toleranceElement,f.item):f.item;if(!a){f.width=h.outerWidth();f.height=h.outerHeight()}h=h.offset();f.left=h.left;f.top=h.top}}if(this.options.custom&&this.options.custom.refreshContainers)this.options.custom.refreshContainers.call(this);else for(e=
this.containers.length-1;e>=0;e--){h=this.containers[e].element.offset();this.containers[e].containerCache.left=h.left;this.containers[e].containerCache.top=h.top;this.containers[e].containerCache.width=this.containers[e].element.outerWidth();this.containers[e].containerCache.height=this.containers[e].element.outerHeight()}return this},_createPlaceholder:function(a){var e=a||this,f=e.options;if(!f.placeholder||f.placeholder.constructor==String){var h=f.placeholder;f.placeholder={element:function(){var l=
c(document.createElement(e.currentItem[0].nodeName)).addClass(h||e.currentItem[0].className+" ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];if(!h)l.style.visibility="hidden";return l},update:function(l,n){if(!(h&&!f.forcePlaceholderSize)){n.height()||n.height(e.currentItem.innerHeight()-parseInt(e.currentItem.css("paddingTop")||0,10)-parseInt(e.currentItem.css("paddingBottom")||0,10));n.width()||n.width(e.currentItem.innerWidth()-parseInt(e.currentItem.css("paddingLeft")||0,10)-parseInt(e.currentItem.css("paddingRight")||
0,10))}}}}e.placeholder=c(f.placeholder.element.call(e.element,e.currentItem));e.currentItem.after(e.placeholder);f.placeholder.update(e,e.placeholder)},_contactContainers:function(a){for(var e=null,f=null,h=this.containers.length-1;h>=0;h--)if(!c.ui.contains(this.currentItem[0],this.containers[h].element[0]))if(this._intersectsWith(this.containers[h].containerCache)){if(!(e&&c.ui.contains(this.containers[h].element[0],e.element[0]))){e=this.containers[h];f=h}}else if(this.containers[h].containerCache.over){this.containers[h]._trigger("out",
a,this._uiHash(this));this.containers[h].containerCache.over=0}if(e)if(this.containers.length===1){this.containers[f]._trigger("over",a,this._uiHash(this));this.containers[f].containerCache.over=1}else if(this.currentContainer!=this.containers[f]){e=1E4;h=null;for(var l=this.positionAbs[this.containers[f].floating?"left":"top"],n=this.items.length-1;n>=0;n--)if(c.ui.contains(this.containers[f].element[0],this.items[n].item[0])){var v=this.items[n][this.containers[f].floating?"left":"top"];if(Math.abs(v-
l)<e){e=Math.abs(v-l);h=this.items[n]}}if(h||this.options.dropOnEmpty){this.currentContainer=this.containers[f];h?this._rearrange(a,h,null,true):this._rearrange(a,null,this.containers[f].element,true);this._trigger("change",a,this._uiHash());this.containers[f]._trigger("change",a,this._uiHash(this));this.options.placeholder.update(this.currentContainer,this.placeholder);this.containers[f]._trigger("over",a,this._uiHash(this));this.containers[f].containerCache.over=1}}},_createHelper:function(a){var e=
...
document:window).width()-this.helperProportions.width-this.margins.left,(c(a.containment=="document"?document:window).height()||document.body.parentNode.scrollHeight)-this.helperProportions.height-this.margins.top];if(!/^(document|window|parent)$/.test(a.containment)){var e=c(a.containment)[0];a=c(a.containment).offset();var f=c(e).css("overflow")!="hidden";this.containment=[a.left+(parseInt(c(e).css("borderLeftWidth"),10)||0)+(parseInt(c(e).css("paddingLeft"),10)||0)-this.margins.left,a.top+(parseInt(c(e).css("borderTopWidth"),
10)||0)+(parseInt(c(e).css("paddingTop"),10)||0)-this.margins.top,a.left+(f?Math.max(e.scrollWidth,e.offsetWidth):e.offsetWidth)-(parseInt(c(e).css("borderLeftWidth"),10)||0)-(parseInt(c(e).css("paddingRight"),10)||0)-this.helperProportions.width-this.margins.left,a.top+(f?Math.max(e.scrollHeight,e.offsetHeight):e.offsetHeight)-(parseInt(c(e).css("borderTopWidth"),10)||0)-(parseInt(c(e).css("paddingBottom"),10)||0)-this.helperProportions.height-this.margins.top]}},_convertPositionTo:function(a,e){if(!e)e=
this.position;var f=a=="absolute"?1:-1,h=this.cssPosition=="absolute"&&!(this.scrollParent[0]!=document&&c.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,l=/(html|body)/i.test(h[0].tagName);return{top:e.top+this.offset.relative.top*f+this.offset.parent.top*f-(c.browser.safari&&this.cssPosition=="fixed"?0:(this.cssPosition=="fixed"?-this.scrollParent.scrollTop():l?0:h.scrollTop())*f),left:e.left+this.offset.relative.left*f+this.offset.parent.left*f-(c.browser.safari&&
this.cssPosition=="fixed"?0:(this.cssPosition=="fixed"?-this.scrollParent.scrollLeft():l?0:h.scrollLeft())*f)}},_generatePosition:function(a){var e=this.options,f=this.cssPosition=="absolute"&&!(this.scrollParent[0]!=document&&c.ui.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,h=/(html|body)/i.test(f[0].tagName);if(this.cssPosition=="relative"&&!(this.scrollParent[0]!=document&&this.scrollParent[0]!=this.offsetParent[0]))this.offset.relative=this._getRelativeOffset();
...
this.offset.click.top-this.offset.relative.top-this.offset.parent.top+(c.browser.safari&&this.cssPosition=="fixed"?0:this.cssPosition=="fixed"?-this.scrollParent.scrollTop():h?0:f.scrollTop()),left:l-this.offset.click.left-this.offset.relative.left-this.offset.parent.left+(c.browser.safari&&this.cssPosition=="fixed"?0:this.cssPosition=="fixed"?-this.scrollParent.scrollLeft():h?0:f.scrollLeft())}},_rearrange:function(a,e,f,h){f?f[0].appendChild(this.placeholder[0]):e.item[0].parentNode.insertBefore(this.placeholder[0],
this.direction=="down"?e.item[0]:e.item[0].nextSibling);this.counter=this.counter?++this.counter:1;var l=this,n=this.counter;window.setTimeout(function(){n==l.counter&&l.refreshPositions(!h)},0)},_clear:function(a,e){this.reverting=false;var f=[];!this._noFinalSort&&this.currentItem.parent().length&&this.placeholder.before(this.currentItem);this._noFinalSort=null;if(this.helper[0]==this.currentItem[0]){for(var h in this._storedCSS)if(this._storedCSS[h]=="auto"||this._storedCSS[h]=="static")this._storedCSS[h]=
"";this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper")}else this.currentItem.show();this.fromOutside&&!e&&f.push(function(l){this._trigger("receive",l,this._uiHash(this.fromOutside))});if((this.fromOutside||this.domPosition.prev!=this.currentItem.prev().not(".ui-sortable-helper")[0]||this.domPosition.parent!=this.currentItem.parent()[0])&&!e)f.push(function(l){this._trigger("update",l,this._uiHash())});if(!c.ui.contains(this.element[0],this.currentItem[0])){e||f.push(function(l){this._trigger("remove",
l,this._uiHash())});for(h=this.containers.length-1;h>=0;h--)if(c.ui.contains(this.containers[h].element[0],this.currentItem[0])&&!e){f.push(function(l){return function(n){l._trigger("receive",n,this._uiHash(this))}}.call(this,this.containers[h]));f.push(function(l){return function(n){l._trigger("update",n,this._uiHash(this))}}.call(this,this.containers[h]))}}for(h=this.containers.length-1;h>=0;h--){e||f.push(function(l){return function(n){l._trigger("deactivate",n,this._uiHash(this))}}.call(this,
this.containers[h]));if(this.containers[h].containerCache.over){f.push(function(l){return function(n){l._trigger("out",n,this._uiHash(this))}}.call(this,this.containers[h]));this.containers[h].containerCache.over=0}}this._storedCursor&&c("body").css("cursor",this._storedCursor);this._storedOpacity&&this.helper.css("opacity",this._storedOpacity);if(this._storedZIndex)this.helper.css("zIndex",this._storedZIndex=="auto"?"":this._storedZIndex);this.dragging=false;if(this.cancelHelperRemoval){if(!e){this._trigger("beforeStop",
a,this._uiHash());for(h=0;h<f.length;h++)f[h].call(this,a);this._trigger("stop",a,this._uiHash())}return false}e||this._trigger("beforeStop",a,this._uiHash());this.placeholder[0].parentNode.removeChild(this.placeholder[0]);this.helper[0]!=this.currentItem[0]&&this.helper.remove();this.helper=null;if(!e){for(h=0;h<f.length;h++)f[h].call(this,a);this._trigger("stop",a,this._uiHash())}this.fromOutside=false;return true},_trigger:function(){c.Widget.prototype._trigger.apply(this,arguments)===false&&this.cancel()},
...
!p.test||!p.exec||!(p.ignoreCase||p.ignoreCase===false))};y.isNull=function(p){return p===null};y.isUndefined=function(p){return p===void 0};y.noConflict=function(){a._=e;return this};y.identity=function(p){return p};y.times=function(p,d,B){for(var J=0;J<p;J++)d.call(B,J)};y.escape=function(p){return(""+p).replace(/&(?!\w+;|#\d+;|#x[\da-f]+;)/gi,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};y.mixin=function(p){aa(y.functions(p),
...
(function(c,a){var e,f=/:([\w\d]+)/g,h=/\?([^#]*)$/,l=function(r){return Array.prototype.slice.call(r)},n=function(r){return Object.prototype.toString.call(r)==="[object Function]"},v=function(r){return Object.prototype.toString.call(r)==="[object Array]"},D=function(r){return decodeURIComponent((r||"").replace(/\+/g," "))},C=encodeURIComponent,O=function(r){return String(r).replace(/&(?!\w+;)/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")},P=function(r){return function(u,
A){return this.route.apply(this,[r,u,A])}},X={},ea=!!(a.history&&history.pushState),ma=[];e=function(){var r=l(arguments),u,A;e.apps=e.apps||{};if(r.length===0||r[0]&&n(r[0]))return e.apply(e,["body"].concat(r));else if(typeof(A=r.shift())=="string"){u=e.apps[A]||new e.Application;u.element_selector=A;r.length>0&&c.each(r,function(H,Z){u.use(Z)});u.element_selector!=A&&delete e.apps[A];return e.apps[u.element_selector]=u}};e.VERSION="0.7.0";e.addLogger=function(r){ma.push(r)};e.log=function(){var r=
l(arguments);r.unshift("["+Date()+"]");c.each(ma,function(u,A){A.apply(e,r)})};if(typeof a.console!="undefined")n(a.console.log.apply)?e.addLogger(function(){a.console.log.apply(a.console,arguments)}):e.addLogger(function(){a.console.log(arguments)});else typeof console!="undefined"&&e.addLogger(function(){console.log.apply(console,arguments)});c.extend(e,{makeArray:l,isFunction:n,isArray:v});e.Object=function(r){return c.extend(this,r||{})};c.extend(e.Object.prototype,{escapeHTML:O,h:O,toHash:function(){var r=
{};c.each(this,function(u,A){n(A)||(r[u]=A)});return r},toHTML:function(){var r="";c.each(this,function(u,A){n(A)||(r+="<strong>"+u+"</strong> "+A+"<br />")});return r},keys:function(r){var u=[];for(var A in this)if(!n(this[A])||!r)u.push(A);return u},has:function(r){return this[r]&&c.trim(this[r].toString())!==""},join:function(){var r=l(arguments),u=r.shift();return r.join(u)},log:function(){e.log.apply(e,arguments)},toString:function(r){var u=[];c.each(this,function(A,H){if(!n(H)||r)u.push('"'+
A+'": '+H.toString())});return"Sammy.Object: {"+u.join(",")+"}"}});e.DefaultLocationProxy=function(r,u){this.app=r;this.is_native=false;this.has_history=ea;this._startPolling(u)};e.DefaultLocationProxy.fullPath=function(r){var u=r.toString().match(/^[^#]*(#.+)$/);return[r.pathname,r.search,u?u[1]:""].join("")};e.DefaultLocationProxy.prototype={bind:function(){var r=this,u=this.app,A=e.DefaultLocationProxy;c(a).bind("hashchange."+this.app.eventNamespace(),function(H,Z){if(r.is_native===false&&!Z){r.is_native=
...
c(a).unbind("popstate."+this.app.eventNamespace());c("a").die("click.history-"+this.app.eventNamespace());e.DefaultLocationProxy._bindings--;e.DefaultLocationProxy._bindings<=0&&a.clearInterval(e.DefaultLocationProxy._interval)},getLocation:function(){return e.DefaultLocationProxy.fullPath(a.location)},setLocation:function(r){if(/^([^#\/]|$)/.test(r))r=ea?"/"+r:"#!/"+r;if(r!=this.getLocation())if(ea&&/^\//.test(r)){history.pushState({path:r},a.title,r);this.app.trigger("location-changed")}else return a.location=
r},_startPolling:function(r){var u=this;if(!e.DefaultLocationProxy._interval){r||(r=10);var A=function(){var H=u.getLocation();if(typeof e.DefaultLocationProxy._last_location=="undefined"||H!=e.DefaultLocationProxy._last_location)a.setTimeout(function(){c(a).trigger("hashchange",[true])},0);e.DefaultLocationProxy._last_location=H};A();e.DefaultLocationProxy._interval=a.setInterval(A,r)}}};e.Application=function(r){var u=this;this.routes={};this.listeners=new e.Object({});this.arounds=[];this.befores=
[];this.namespace=(new Date).getTime()+"-"+parseInt(Math.random()*1E3,10);this.context_prototype=function(){e.EventContext.apply(this,arguments)};this.context_prototype.prototype=new e.EventContext;n(r)&&r.apply(this,[this]);this._location_proxy||this.setLocationProxy(new e.DefaultLocationProxy(this,this.run_interval_every));this.debug&&this.bindToAllEvents(function(A,H){u.log(u.toString(),A.cleaned_type,H||{})})};e.Application.prototype=c.extend({},e.Object.prototype,{ROUTE_VERBS:["get","post","put",
...
else r[u]=[r[u],A];else r[u]=A;return r},_listen:function(r,u){return this.$element().bind([r,this.eventNamespace()].join("."),u)},_unlisten:function(r,u){return this.$element().unbind([r,this.eventNamespace()].join("."),u)}});e.RenderContext=function(r){this.event_context=r;this.callbacks=[];this.content=this.previous_content=null;this.waiting=this.next_engine=false};e.RenderContext.prototype=c.extend({},e.Object.prototype,{then:function(r){if(!n(r))if(typeof r==="string"&&r in this.event_context){var u=
...
u)})}});e.EventContext=function(r,u,A,H,Z){this.app=r;this.verb=u;this.path=A;this.params=new e.Object(H);this.target=Z};e.EventContext.prototype=c.extend({},e.Object.prototype,{$element:function(){return this.app.$element(l(arguments).shift())},engineFor:function(r){var u;if(n(r))return r;r=(r||this.app.template_engine).toString();if(u=r.match(/\.([^\.\?\#]+)$/))r=u[1];if(r&&n(this[r]))return this[r];if(this.app.template_engine)return this.engineFor(this.app.template_engine);return function(A){return A}},
interpolate:function(r,u,A,H){return this.engineFor(A).apply(this,[r,u,H])},render:function(r,u,A,H){return(new e.RenderContext(this)).render(r,u,A,H)},renderEach:function(r,u,A,H){return(new e.RenderContext(this)).renderEach(r,u,A,H)},load:function(r,u,A){return(new e.RenderContext(this)).load(r,u,A)},partial:function(r,u){return(new e.RenderContext(this)).partial(r,u)},send:function(){var r=new e.RenderContext(this);return r.send.apply(r,arguments)},redirect:function(){var r;r=l(arguments);var u=
...
(function(c){function a(f){f=unescape(f);return f==="true"?true:f==="false"?false:f}function e(f,h,l){var n;if(h.match(/^[^\[]+$/))f[h]=a(l);else if(n=h.match(/^([^\[]+)\[\](.*)$/)){h=n[1];n=n[2];if(f[h]&&!c.isArray(f[h]))throw"400 Bad Request";if(n){n=n.match(/^\[([^\]]+)\](.*)$/);if(!n)throw"400 Bad Request";if(f[h])f[h][f[h].length-1][n[1]]?f[h].push(e({},n[1]+n[2],l)):c.extend(true,f[h][f[h].length-1],e({},n[1]+n[2],l));else f[h]=[e({},n[1]+n[2],l)]}else if(f[h])f[h].push(a(l));else f[h]=[a(l)]}else if(n=
h.match(/^([^\[]+)\[([^\[]+)\](.*)$/)){h=n[1];n=n[2]+n[3];if(f[h]&&c.isArray(f[h]))throw"400 Bad Request";if(f[h])c.extend(true,f[h],e(f[h],n,l));else f[h]=e({},n,l)}return f}Sammy=Sammy||{};Sammy.NestedParams=function(f){f._parseParamPair=e}})(jQuery);
(function(){if(!window.JSON)window.JSON={};(function(){function c(C){return C<10?"0"+C:C}function a(C){h.lastIndex=0;return h.test(C)?'"'+C.replace(h,function(O){var P=v[O];return typeof P==="string"?P:"\\u"+("0000"+O.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+C+'"'}function e(C,O){var P,X,ea,ma,r=l,u,A=O[C];if(A&&typeof A==="object"&&typeof A.toJSON==="function")A=A.toJSON(C);if(typeof D==="function")A=D.call(O,C,A);switch(typeof A){case "string":return a(A);case "number":return isFinite(A)?
String(A):"null";case "boolean":case "null":return String(A);case "object":if(!A)return"null";l+=n;u=[];if(Object.prototype.toString.apply(A)==="[object Array]"){ma=A.length;for(P=0;P<ma;P+=1)u[P]=e(P,A)||"null";ea=u.length===0?"[]":l?"[\n"+l+u.join(",\n"+l)+"\n"+r+"]":"["+u.join(",")+"]";l=r;return ea}if(D&&typeof D==="object"){ma=D.length;for(P=0;P<ma;P+=1){X=D[P];if(typeof X==="string")if(ea=e(X,A))u.push(a(X)+(l?": ":":")+ea)}}else for(X in A)if(Object.hasOwnProperty.call(A,X))if(ea=e(X,A))u.push(a(X)+
...
h=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,l,n,v={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},D;if(typeof JSON.stringify!=="function")JSON.stringify=function(C,O,P){var X;n=l="";if(typeof P==="number")for(X=0;X<P;X+=1)n+=" ";else if(typeof P==="string")n=P;if((D=O)&&typeof O!=="function"&&(typeof O!=="object"||typeof O.length!=="number"))throw new Error("JSON.stringify");return e("",
{"":C})};if(typeof JSON.parse!=="function")JSON.parse=function(C,O){function P(ea,ma){var r,u,A=ea[ma];if(A&&typeof A==="object")for(r in A)if(Object.hasOwnProperty.call(A,r)){u=P(A,r);if(u!==undefined)A[r]=u;else delete A[r]}return O.call(ea,ma,A)}var X;f.lastIndex=0;if(f.test(C))C=C.replace(f,function(ea){return"\\u"+("0000"+ea.charCodeAt(0).toString(16)).slice(-4)});if(/^[\],:{}\s]*$/.test(C.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
...
var Mustache=function(){var c=function(){};c.prototype={otag:"{{",ctag:"}}",pragmas:{},buffer:[],pragmas_implemented:{"IMPLICIT-ITERATOR":true},context:{},render:function(a,e,f,h){if(!h){this.context=e;this.buffer=[]}if(!this.includes("",a))if(h)return a;else{this.send(a);return}a=this.render_pragmas(a);a=this.render_section(a,e,f);if(h)return this.render_tags(a,e,f,h);this.render_tags(a,e,f,h)},send:function(a){a!==""&&this.buffer.push(a)},render_pragmas:function(a){if(!this.includes("%",a))return a;
var e=this;return a.replace(new RegExp(this.otag+"%([\\w-]+) ?([\\w]+=[\\w]+)?"+this.ctag,"g"),function(f,h,l){if(!e.pragmas_implemented[h])throw{message:"This implementation of mustache doesn't understand the '"+h+"' pragma"};e.pragmas[h]={};if(l){f=l.split("=");e.pragmas[h][f[0]]=f[1]}return""})},render_partial:function(a,e,f){a=this.trim(a);if(!f||f[a]===undefined)throw{message:"unknown_partial '"+a+"'"};if(typeof e[a]!="object")return this.render(f[a],e,f,true);return this.render(f[a],e[a],f,
true)},render_section:function(a,e,f){if(!this.includes("#",a)&&!this.includes("^",a))return a;var h=this;return a.replace(new RegExp(this.otag+"(\\^|\\#)\\s*(.+)\\s*"+this.ctag+"\n*([\\s\\S]+?)"+this.otag+"\\/\\s*\\2\\s*"+this.ctag+"\\s*","mg"),function(l,n,v,D){l=h.find(v,e);if(n=="^")return!l||h.is_array(l)&&l.length===0?h.render(D,e,f,true):"";else if(n=="#")return h.is_array(l)?h.map(l,function(C){return h.render(D,h.create_context(C),f,true)}).join(""):h.is_object(l)?h.render(D,h.create_context(l),
f,true):typeof l==="function"?l.call(e,D,function(C){return h.render(C,e,f,true)}):l?h.render(D,e,f,true):""})},render_tags:function(a,e,f,h){var l=this,n=function(){return new RegExp(l.otag+"(=|!|>|\\{|%)?([^\\/#\\^]+?)\\1?"+l.ctag+"+","g")},v=n(),D=function(O,P,X){switch(P){case "!":return"";case "=":l.set_delimiters(X);v=n();return"";case ">":return l.render_partial(X,e,f);case "{":return l.find(X,e);default:return l.escape(l.find(X,e))}};a=a.split("\n");for(var C=0;C<a.length;C++){a[C]=a[C].replace(v,
D,this);h||this.send(a[C])}if(h)return a.join("\n")},set_delimiters:function(a){a=a.split(" ");this.otag=this.escape_regex(a[0]);this.ctag=this.escape_regex(a[1])},escape_regex:function(a){if(!arguments.callee.sRE)arguments.callee.sRE=new RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\)","g");return a.replace(arguments.callee.sRE,"\\$1")},find:function(a,e){a=this.trim(a);var f;if(e[a]===false||e[a]===0||e[a])f=e[a];else if(this.context[a]===false||this.context[a]===0||this.context[a])f=
this.context[a];if(typeof f==="function")return f.apply(e);if(f!==undefined)return f;return""},includes:function(a,e){return e.indexOf(this.otag+a)!=-1},escape:function(a){return String(a===null?"":a).replace(/&(?!\w+;)|["'<>\\]/g,function(e){switch(e){case "&":return"&amp;";case "\\":return"\\\\";case '"':return"&quot;";case "'":return"&#39;";case "<":return"&lt;";case ">":return"&gt;";default:return e}})},create_context:function(a){if(this.is_object(a))return a;else{var e=".";if(this.pragmas["IMPLICIT-ITERATOR"])e=
this.pragmas["IMPLICIT-ITERATOR"].iterator;var f={};f[e]=a;return f}},is_object:function(a){return a&&typeof a=="object"},is_array:function(a){return Object.prototype.toString.call(a)==="[object Array]"},trim:function(a){return a.replace(/^\s*|\s*$/g,"")},map:function(a,e){if(typeof a.map=="function")return a.map(e);else{for(var f=[],h=a.length,l=0;l<h;l++)f.push(e(a[l]));return f}}};return{name:"mustache.js",version:"0.3.1-dev",to_html:function(a,e,f,h){var l=new c;if(h)l.send=h;l.render(a,e,f);
if(!h)return l.buffer.join("\n")}}}();(function(c){Sammy=Sammy||{};Sammy.Mustache=function(a,e){e||(e="mustache");a.helper(e,function(f,h,l){h=c.extend({},this,h);l=c.extend({},h.partials,l);return Mustache.to_html(f,h,l)})}})(jQuery);
window.Modernizr=function(c,a,e){function f(){v.input=function(Q){for(var p=0,d=Q.length;p<d;p++)ca[Q[p]]=!!(Q[p]in X);return ca}("autocomplete autofocus list placeholder max min multiple pattern required step".split(" "));v.inputtypes=function(Q){for(var p=0,d,B,J,R=Q.length;p<R;p++){X.setAttribute("type",B=Q[p]);(d=X.type!=="text")&&(X.value=ea,X.style.cssText="position:absolute;visibility:hidden;",/^range$/.test(B)&&X.style.WebkitAppearance!==e?(D.appendChild(X),J=a.defaultView,d=J.getComputedStyle&&
...
e)||(d[p]=e),d.removeAttribute(p)));return B}}(),Ba={}.hasOwnProperty,sa;n(Ba,e)||n(Ba.call,e)?(sa=function(Q,p){return p in Q&&n(Q.constructor.prototype[p],e)}):(sa=function(Q,p){return Ba.call(Q,p)});H.flexbox=function(){var Q=a.createElement("div"),p=a.createElement("div");(function(B,J,R,Y){J+=":";B.style.cssText=(J+r.join(R+";"+J)).slice(0,-J.length)+(Y||"")})(Q,"display","box","width:42px;padding:0;");p.style.cssText=r.join("box-flex:1;")+"width:10px;";Q.appendChild(p);D.appendChild(Q);var d=
...
"no-")+aa));v.input||f();v.crosswindowmessaging=v.postmessage;v.historymanagement=v.history;v.addTest=function(Q,p){Q=Q.toLowerCase();if(!v[Q]){p=!!p();D.className+=" "+(p?"":"no-")+Q;v[Q]=p;return v}};P.cssText="";O=X=null;c.attachEvent&&function(){var Q=a.createElement("div");Q.innerHTML="<elem></elem>";return Q.childNodes.length!==1}()&&function(Q,p){function d(wa,xa){for(var Ca=-1,ya=wa.length,Sa,$a=[];++Ca<ya;){Sa=wa[Ca];(xa=Sa.media||xa)!="screen"&&$a.push(d(Sa.imports,xa),Sa.cssText)}return $a.join("")}
...
var Model=function(c,a){var e=function(f){this.attributes=jQuery.extend({},f);this.changes={};this.errors=new Model.Errors(this);this.uid=[c,Model.UID.generate()].join("-");jQuery.isFunction(this.initialize)&&this.initialize()};Model.Module.extend.call(e,Model.Module);e._name=c;e.collection=[];e.unique_key="id";e.extend(Model.Callbacks).extend(Model.ClassMethods);e.prototype=new Model.Base;e.prototype.constructor=e;jQuery.isFunction(a)&&a.call(e,e,e.prototype);return e};
Model.Callbacks={bind:function(c,a){this.callbacks=this.callbacks||{};this.callbacks[c]=this.callbacks[c]||[];this.callbacks[c].push(a);return this},trigger:function(c,a){this.callbacks=this.callbacks||{};var e=this.callbacks[c];if(e)for(var f=0;f<e.length;f++)e[f].apply(this,a||[]);return this},unbind:function(c,a){this.callbacks=this.callbacks||{};if(a)for(var e=this.callbacks[c]||[],f=0;f<e.length;f++)e[f]===a&&this.callbacks[c].splice(f,1);else delete this.callbacks[c];return this}};
Model.ClassMethods={add:function(c){var a=c.id();if(jQuery.inArray(c,this.collection)===-1&&!(a&&this.find(a))){this.collection.push(c);this.trigger("add",[c])}return this},all:function(){return this.collection.slice()},chain:function(c){return jQuery.extend({},this,{collection:c})},count:function(){return this.all().length},detect:function(c){for(var a=this.all(),e,f=0,h=a.length;f<h;f++){e=a[f];if(c.call(e,e,f))return e}},each:function(c,a){for(var e=this.all(),f=0,h=e.length;f<h;f++)c.call(a||
e[f],e[f],f,e);return this},find:function(c){return this.detect(function(){return this.id()==c})},first:function(){return this.all()[0]},load:function(c){if(this._persistence){var a=this;this._persistence.read(function(e){for(var f=0,h=e.length;f<h;f++)a.add(e[f]);c&&c.call(a,e)})}return this},last:function(){var c=this.all();return c[c.length-1]},map:function(c,a){for(var e=this.all(),f=[],h=0,l=e.length;h<l;h++)f.push(c.call(a||e[h],e[h],h,e));return f},persistence:function(c){if(arguments.length==
0)return this._persistence;else{var a=Array.prototype.slice.call(arguments,1);a.unshift(this);this._persistence=c.apply(c,a);return this}},pluck:function(c){for(var a=this.all(),e=[],f=0,h=a.length;f<h;f++)e.push(a[f].attr(c));return e},remove:function(c){for(var a,e=0,f=this.collection.length;e<f;e++)if(this.collection[e]===c){a=e;break}if(a!=undefined){this.collection.splice(a,1);this.trigger("remove",[c]);return true}else return false},reverse:function(){return this.chain(this.all().reverse())},
select:function(c,a){for(var e=this.all(),f=[],h,l=0,n=e.length;l<n;l++){h=e[l];if(c.call(a||h,h,l,e))f.push(h)}return this.chain(f)},sort:function(c){return this.chain(this.all().sort(c))},sortBy:function(c){var a=jQuery.isFunction(c);return this.sort(function(e,f){var h=a?c.call(e):e.attr(c),l=a?c.call(f):f.attr(c);return h<l?-1:h>l?1:0})},use:function(c){var a=Array.prototype.slice.call(arguments,1);a.unshift(this);c.apply(this,a);return this}};
...
Model.InstanceMethods={asJSON:function(){return this.attr()},attr:function(c,a){if(arguments.length===0)return jQuery.extend({},this.attributes,this.changes);else if(arguments.length===2){if(this.attributes[c]===a)delete this.changes[c];else this.changes[c]=a;return this}else if(typeof c==="object"){for(var e in c)this.attr(e,c[e]);return this}else return c in this.changes?this.changes[c]:this.attributes[c]},callPersistMethod:function(c,a){var e=this,f=function(h){if(h){e.merge(e.changes).reset();
c==="destroy"?e.constructor.remove(e):e.constructor.add(e);e.trigger(c)}var l;if(a)l=a.apply(e,arguments);return l};this.constructor._persistence?this.constructor._persistence[c](this,f):f.call(this,true)},destroy:function(c){this.callPersistMethod("destroy",c);return this},id:function(){return this.attributes[this.constructor.unique_key]},merge:function(c){jQuery.extend(this.attributes,c);return this},newRecord:function(){return this.id()===undefined},reset:function(){this.errors.clear();this.changes=
...
Model.localStorage=function(c){if(!window.localStorage)return{create:function(h,l){l(true)},destroy:function(h,l){l(true)},read:function(h){h([])},update:function(h,l){l(true)}};var a=[c._name,"collection"].join("-"),e=function(){var h=localStorage[a];return h?JSON.parse(h):[]},f=function(h){localStorage.setItem(h.uid,JSON.stringify(h.asJSON()));h=h.uid;var l=e();if(jQuery.inArray(h,l)===-1){l.push(h);localStorage.setItem(a,JSON.stringify(l))}};return{create:function(h,l){f(h);l(true)},destroy:function(h,
l){localStorage.removeItem(h.uid);var n=h.uid,v=e();n=jQuery.inArray(n,v);if(n>-1){v.splice(n,1);localStorage.setItem(a,JSON.stringify(v))}l(true)},read:function(h){if(!h)return false;for(var l=c.map(function(){return this.uid}),n=e(),v=[],D,C,O=0,P=n.length;O<P;O++){C=n[O];if(jQuery.inArray(C,l)==-1){D=JSON.parse(localStorage[C]);D=new c(D);D.uid=C;v.push(D)}}h(v)},update:function(h,l){f(h);l(true)}}};Model.Log=function(){window.console&&window.console.log.apply(window.console,arguments)};
...
jQuery.cookie=function(c,a,e){if(typeof a!="undefined"){e=e||{};if(a===null){a="";e.expires=-1}var f="";if(e.expires&&(typeof e.expires=="number"||e.expires.toUTCString)){if(typeof e.expires=="number"){f=new Date;f.setTime(f.getTime()+e.expires*24*60*60*1E3)}else f=e.expires;f="; expires="+f.toUTCString()}var h=e.path?"; path="+e.path:"",l=e.domain?"; domain="+e.domain:"";e=e.secure?"; secure":"";document.cookie=[c,"=",encodeURIComponent(a),f,h,l,e].join("")}else{a=null;if(document.cookie&&document.cookie!=
""){e=document.cookie.split(";");for(f=0;f<e.length;f++){h=jQuery.trim(e[f]);if(h.substring(0,c.length+1)==c+"="){a=decodeURIComponent(h.substring(c.length+1));break}}}return a}};
var Asset=Model("asset",function(){this.persistence(Model.REST,"/admin/assets");this.include({initialize:function(){this.attr("uuid",Asset.generate_uuid())},load:function(c){var a=this,e="/admin/assets/"+a.id()+".json";jQuery.ajax({type:"GET",url:e,dataType:"json",success:function(f){a.merge(f);c.call(this)}})},toMustache:function(c){this.merge({query_path:c?"?"+decodeURIComponent(jQuery.param({query:c})):"",query:c});return this.attr()},toMustacheWithNeighbors:function(c){Asset.all().indexOf(this);
c=this.toMustache(c);jQuery("<img />")[0].src="/images/"+c.id+"/"+c.file_name;return{asset:c}},upload:function(c,a){var e=new XMLHttpRequest,f=JSON.stringify({folder_id:this.attr("folder_id")});Asset.callback=a;e.upload.uuid=this.attr("uuid");console.log(this.attr("uuid"));e.upload.filename=c.name;e.upload.addEventListener("loadstart",Asset.onloadstartHandler,false);e.upload.addEventListener("progress",Asset.onprogressHandler);e.upload.addEventListener("load",Asset.onloadHandler,false);e.addEventListener("readystatechange",
Asset.onreadystatechangeHandler,false);e.open("POST","/admin/assets.json",true);e.setRequestHeader("Content-Type","application/octet-stream");e.setRequestHeader("X-File-Name",c.name);e.setRequestHeader("X-Params",f);e.setRequestHeader("X-File-Upload","true");e.send(c);a.before&&a.before.call(this,this)}});this.extend({find_all_by_folder_id:function(c){return this.select(function(){return this.attr("folder_id")==c})},toMustache:function(c){var a=c?"?"+decodeURIComponent(jQuery.param({query:c})):"";
return this.map(function(e){e.merge({query_path:a,query:c});return e.attr()})},asJSON:function(){return Asset.map(function(c){return c.attr()})},tags:function(){tags=[];Asset.map(function(){tags=tags.concat(this.attr("tags"))});return tags},searchRemote:function(c,a){var e=c!=null?decodeURIComponent(jQuery.param({query:c})):"";Asset.each(function(){Asset.remove(this)});jQuery.ajax({type:"get",url:"/search.json",contentType:"application/json",dataType:"json",data:e,success:function(f){jQuery.each(f,
function(h,l){var n=new Asset({id:l.id});n.merge(l);Asset.add(n)});a.call(this)}})},searchAdmin:function(c,a){Asset.each(function(){Asset.remove(this)});jQuery.ajax({type:"get",url:"/admin/assets.json",contentType:"application/json",dataType:"json",data:c,success:function(e){$.each(e,function(f,h){var l=new Asset({id:h.id});l.merge(h);Asset.add(l)});a.call(this)}})},onloadstartHandler:function(){},onloadHandler:function(){},onprogressHandler:function(c){var a=Math.round(c.loaded/c.total*100);Asset.callback.progress&&
Asset.callback.progress.call(this,c.target.uuid,a)},onreadystatechangeHandler:function(c){var a=null;try{a=c.target.status}catch(e){return}if(a=="200"&&c.target.readyState==4&&c.target.responseText){c=JSON.parse(c.target.responseText);asset.merge(c);Asset.callback.success&&Asset.callback.success.call(this,asset)}},generate_uuid:function(){for(var c=[],a=0;a<32;a++)c[a]="0123456789ABCDEF".substr(Math.floor(Math.random()*16),1);c[12]="4";c[16]="0123456789ABCDEF".substr(c[16]&3|8,1);return c.join("")}})}),
Folder=Model("folder",function(){this.persistence(Model.SinatraREST,"/admin/folders");this.include({loadAssets:function(c){Asset.each(function(){Asset.remove(this)});var a="/admin/folders/"+this.attr("id")+"/assets.json";jQuery.ajax({type:"get",url:a,contentType:"application/json",dataType:"json",success:function(e){jQuery.each(e,function(f,h){var l=new Asset({id:h.id});l.merge(h);Asset.add(l)});c&&c.call(this)}})}});this.extend({asJSON:function(){return Folder.map(function(c){return c.attr()})}})}),
Page=Model("page",function(){this.persistence(Model.SinatraREST,"/admin/pages");this.include({initialize:function(){},children:function(){return Page.find_all_by_parent_id(this.id())},childrenAsJSON:function(){return this.children().map(function(c){return c.attr()})},setPartAttributes:function(c,a){var e=this.attr("contents"),f;jQuery.each(e,function(h,l){if(c==l.id){if(a.content)l.content=a.content;if(a.asset_id)l.asset_id=a.asset_id;if(a.path)l.path=a.path;f=l}});return f},findPartByName:function(c){var a=
this.attr("contents"),e;jQuery.each(a,function(f,h){if(c==h.name){e=h;return false}});return e},findPartById:function(c){var a=this.attr("contents"),e;jQuery.each(a,function(f,h){if(c==h.id){e=h;return false}});return e},getChildren:function(c){var a=this,e="/admin/pages/"+a.id()+"/children.json";jQuery.ajax({type:"GET",url:e,dataType:"json",success:function(f){$.each(f,function(h,l){var n=new Page({id:l.id});n.merge(l);Page.add(n)});a.attr({"children?":true,children:a.childrenAsJSON()});c&&c.call(this,
f)}})},has_children:function(){if(this.children().all().length>0)return true},parent:function(){return Page.find(this.attr("parent_id"))},assets:function(){for(var c=this.attr("assets"),a=0,e=c.length;a<e;++a){var f=c[a],h=new Asset({id:f.id});h.merge(f);Asset.add(h)}return Asset},parts:function(){var c=this.attr("contents"),a=c.length;Part.each(function(){Part.remove(this)});for(var e=0;e<a;++e){var f=c[e],h=new Part({id:f.id});h.merge(f);h.attr("page_id",this.id());Part.add(h)}return Part},load:function(c){var a=
this,e="/admin/pages/"+a.id()+".json";jQuery.ajax({type:"GET",url:e,dataType:"json",success:function(f){a.merge(f);c.call(this)}})}});this.extend({toMustache:function(){return{pages:this.map(function(c){return c.attr()})}},root:function(){return this.detect(function(){return this.attr("parent_id")==null})},find_by_parent_id:function(c){return this.detect(function(){return this.attr("parent_id")==c})},find_all_by_parent_id:function(c){return this.select(function(){return this.attr("parent_id")==c})},
find_by_path:function(c){return this.detect(function(){return this.attr("path")==c})},load_by_id:function(c,a){jQuery.ajax({type:"GET",url:"/admin/pages/"+c+".json",dataType:"json",success:function(e){var f=Page.find(e.id);f||(f=new Page({id:e.id}));f.merge(e);Page.add(f);a&&a.call(this,e)}})},create:function(c,a){jQuery.ajax({type:"post",url:"/admin/pages.json",dataType:"json",data:{page:c},success:function(e){var f=new Page({id:e.id});f.merge(e);Page.add(f);a.call(this,e)}})}})}),Layout=Model("layout",
function(){this.persistence(Model.SinatraREST,"/admin/templates");this.include({load:function(c){var a=this,e="/admin/templates/"+a.id()+".json";jQuery.ajax({type:"GET",url:e,dataType:"json",success:function(f){a.merge(f);c.call(this,f)}})}});this.extend({toMustache:function(){return{layouts:this.map(function(c){return c.attr()})}},asLayoutJSON:function(c){return Layout.find_all_by_class("Layout").map(function(a){c==a.id()?a.attr("selected",'selected="selected"'):a.attr("selected","");return a.attr()})},
find_by_class:function(c){return this.detect(function(){return this.attr("klass")==c})},find_all_by_class:function(c){return this.select(function(){return this.attr("klass")==c})},asJSON_by_class:function(c){return this.find_all_by_class(function(){return c.map(function(a){return a.attributes})})}})}),Part=Model("part",function(){this.include({deleteRemote:function(c,a){var e="/admin/pages/"+c.id()+"/parts/"+this.id()+".json";jQuery.ajax({type:"DELETE",url:e,dataType:"json",success:function(f){c.merge(f);
a.call(this)}})}});this.extend({toMustache:function(){return{parts:this.map(function(c){return c.attr()})}},create:function(c,a){var e="/admin/templates/"+c.template_id+"/parts.json",f=Layout.find(c.template_id);jQuery.ajax({type:"post",url:e,dataType:"json",data:{part:c},success:function(h){f.merge(h);a.call(this)}})}})}),Site=Model("site",function(){this.persistence(Model.SinatraREST,"/admin/sites");this.include({});this.extend({toMustache:function(){return{sites:this.map(function(c){return c.attr()})}}})}),
User=Model("user",function(){this.persistence(Model.SinatraREST,"/admin/users");this.include({});this.extend({toMustache:function(){return{users:this.map(function(c){return c.attr()})}}})}),Galerie={open:function(c,a){$("body").append('<div id="overlay"></div>').append('<div id="modal_wrapper"><div id="modal"></div></div>');var e=$("#modal");e.html(c);var f=$("#modal_wrapper"),h=$(window).height();e=e.height()+42;e=(h-e)/2;$("#overlay").css({height:h}).hide().fadeIn("fast");f.hide().fadeIn("fast").css({top:e});
...
loadModal:function(c,a){var e=this,f=jQuery(c);if(f.length){Loader.start();var h=f.find("img");setTimeout(function(){f.height()<20?h.load(function(){e.resizeModal(h,f,a)}):e.resizeModal(h,f,a)},13)}},resizeModal:function(c,a,e){var f=c.clone();f=f[0].width/f[0].height;var h=jQuery(window).width(),l=jQuery(window).height();if(a.height()>l-40){c.height(l-40).width((l-40)*f);a.height(l-40).width((l-40)*f)}if(a.width()>h-40){c.height((h-40)/f).width(h-40);a.height((h-40)/f).width(h-40);a.css({"margin-top":(l-
(h-40)/f)/2})}a.width()<h-40&&a.height()<l-40&&a.css({width:a.height()*f+"px","margin-top":(l-a.height())/2});Loader.stop();e&&e.call(this)},notice:function(c,a){a=a||{};var e=jQuery(".notice"),f=a["class"]||"message";e.html(c).addClass(f).fadeIn("fast",function(){setTimeout(function(){a.persist||e.fadeOut("slow")},1800)})},hideNotice:function(){jQuery(".notice").fadeOut("slow")},setTimestamp:function(){window.timestamp=(new Date).getTime()},keyboard_nav:function(){jQuery("body").keydown(function(c){switch(c.keyCode){case 37:$("a.previous").click();
...
40+"px"})},67)}},stop:function(c){c=jQuery("#loader");if(c.length){c.hide();clearInterval(Loader.timer)}}},Updater={setup:function(c,a){jQuery.each(c,function(e,f){var h=new a({id:f.id});h.merge(f);a.add(h)})},update:function(){window.ninja=true;jQuery.ajax({url:"/admin/activity.json",type:"POST",data:{updated:window.timestamp},success:function(c){jQuery.each(c.models,function(a,e){Page.find(e.id).merge(e);Utilities.setTimestamp()});window.ninja=false}})}},aceModes={javascript:require("ace/mode/javascript").Mode,
html:require("ace/mode/html").Mode,css:require("ace/mode/css").Mode,scss:require("ace/mode/scss").Mode,sass:require("ace/mode/scss").Mode,textile:require("ace/mode/textile").Mode,none:require("ace/mode/scss").Mode},delay=function(){var c=0;return function(a,e){clearTimeout(c);c=setTimeout(a,e)}}(),Editor={initialize:function(){var c=jQuery("#editor-buttons input[type=button]"),a=jQuery("#editor-buttons input#save");c.click(function(){var e=jQuery(this).data("cmd"),f=jQuery(this).data("value");if(f==
"promptUser")f=prompt(jQuery(this).data("text"));var h=jQuery("iframe")[0];e&&h.contentDocument.execCommand(e,false,f)});a.click(function(){var e=document.location.pathname.split("/"),f=Page.find(e[e.length-1]),h={};jQuery("iframe").contents().find("div.editable").each(function(){var l=jQuery(this),n=l.attr("id").split("-")[1];h[n]=l.html()});jQuery.each(h,function(l,n){n=Editor.textilize(n);f.setPartAttributes(l,{content:n})});f.save()})},textilize:function(c,a){c=c.replace(/\s*<p>((.|[\r\n])*?)<\/p>\s*/gi,
...
var iFramer={initialize:function(c,a){var e=jQuery(c);jQuery("#loader");e.length&&e.load(function(){var f=$(this).contents();f.find("div.editable").attr("contenteditable","true").css({background:"hsla(30, 17.7%, 61%, 0.3)"});f.find("a").click(function(h){var l=jQuery(this).attr("href").split("?")[0].replace("/preview","");if(l=Page.find_by_path(l)){h.preventDefault();Pages.setLocation(l.attr("admin_path"))}});f.find("a.insert-image").click(function(h){h.preventDefault();h=jQuery(this).attr("href");
Base.trigger("image-browser",h)});a&&a.call(this)})},setEditFlags:function(c){c.css({position:"relative",display:"block",height:"0",width:"0","text-decoration":"none"}).find("span").css({display:"block",position:"absolute",top:"-24px",left:"12px",padding:"4px 8px",width:"100px",background:"rgba(255, 255, 0, 0.7)"})}},Base=Sammy(function(c){c.debug=false;c.use(Sammy.JSON);c.use(Sammy.Mustache);c.use(Sammy.NestedParams);c.template_engine="mustache";c.helpers({setup:function(a,e){jQuery.each(a,function(f,
h){var l=new e({id:h.id});l.merge(h);e.add(l)})},update:function(){var a=this;window.ninja=true;jQuery.ajax({url:"/admin/activity.json",type:"POST",data:{updated:window.timestamp},success:function(e){jQuery.each(e.models,function(f,h){h.class_name=="Page"&&a.trigger("update-page",h);h.class_name=="Layout"&&a.trigger("update-layout",h);Utilities.setTimestamp()});window.ninja=false}})}});c.bind("run",function(){var a=this;jQuery("#sidebar .opener").live("click",function(){a.trigger("toggle-children",
this);return false});a.trigger("toggle-sidebar")});c.bind("set-active-tab",function(a,e){var f=jQuery("div#tabs a.tab"),h=e.split("?")[0].split("/")[2];h=jQuery("#"+h+"-tab");f.removeClass("active");h.addClass("active")});c.bind("update-page",function(a,e){var f=Page.find(e.id);f.merge(e);f.save();jQuery("li#page-"+e.id).find("span.title a").text(f.attr("title"));jQuery("h1#page-title-"+f.id()).text(f.attr("title"));jQuery("#page-iframe-"+f.id()).length&&Utilities.notice('<a class="page-reload" href="'+
f.attr("admin_path")+'">This page has been changed. Click here to reload.</span>',{persist:true,"class":"warning"})});c.bind("update-layout",function(a,e){var f=Layout.find(e.id);f.merge(e);f.save();jQuery("li#layout-"+e.id).find("span.title a").text(f.attr("name"))});c.bind("image-browser",function(a,e){var f=this,h=e.split("/")[3],l=e.split("/")[5],n=Page.find(h),v=n.findPartById(l);Asset.searchAdmin({limit:12,page:1},function(){f.load(jQuery("script#admin-image_parts-index")).interpolate({assets:Asset.asJSON(),
...
"sass"?'selected="selected"':""},{name:"SCSS",value:"scss",selected:a.attr("filter")=="scss"?'selected="selected"':""},{name:"Partial",value:"none",selected:a.attr("filter")=="none"?'selected="selected"':""}]},"mustache").replace("#editor").then(function(){var e=a.attr("mode");e=aceModes[e];window.editor=ace.edit("layout_content");window.editor.setTheme("ace/theme/textmate");window.editor.getSession().setMode(new e);window.editor.session.setUseWrapMode(true);window.editor.getSession().setValue(a.attr("content"));
jQuery("a.tab").click(function(f){f.preventDefault();jQuery(".pane").hide();jQuery(jQuery(this).attr("href")).show()})})}});this.bind("run",function(){c.refresh_templates=true;c.refresh_pages=true;c.modal=false});this.get("/admin/templates",function(a){c.refresh_templates=false;jQuery("#editor").html('<h1 class="section">Templates</div>');a.renderLayoutIndex(Layout.all())});this.get("/admin/templates/new/:klass",function(a){var e=$("<div />").attr({id:"new-page-container","class":"small-modal"}),
f=a.params.klass;$("#modal").length==0&&Galerie.open(e);a.load(jQuery("#admin-templates-new")).interpolate({klass:f,file:f=="upload"?true:false},"mustache").replace("#new-page-container");a.renderLayoutIndex(Layout.all())});this.post("/admin/templates",function(a){(new Layout(a.params.template)).save(function(e,f){var h=JSON.parse(f.responseText);if(h.errors)Utilities.notice(JSON.stringify(h));else{a.redirect("/admin/templates");Utilities.notice("Successfully saved template")}})});this.get("/admin/templates/:id/edit",
function(a){c.refresh_pages=true;var e=Layout.find(a.params.id);a.renderLayout(e);a.renderLayoutIndex(Layout.all())});this.put("/admin/templates/:id",function(a){var e=Layout.find(a.params.id);a.params.layout.content=window.editor.getSession().getValue();e.attr(a.params.layout);e.save(function(f){if(f){a.renderLayoutIndex();Utilities.notice("Successfully saved template");f=aceModes[e.attr("mode")];window.editor.getSession().setUseSoftTabs(true);window.editor.getSession().setTabSize(2);window.editor.getSession().setMode(new f)}})});
...
a.params.id;Part.create(a.params.part,function(){a.redirect("/admin/templates/"+e+"/edit")})})})}),Assets=Sammy(function(c){var a=this;c.helpers({send_files:function(e,f){var h=this.load(jQuery("script#admin-assets-loading")),l=this.load(jQuery("script#admin-assets-asset"));jQuery.each(e,function(n,v){asset=new Asset({file_name:v.fileName,folder_id:f.folder_id});asset.upload(v,{before:function(D){h.interpolate({uuid:D.attr("uuid"),title:D.attr("file_name").split(".")[0]},"mustache").appendTo("#assets")},
success:function(D){Asset.add(D);l.interpolate(D.attr(),"mustache").replace("#asset-"+D.attr("uuid"))}})})}});c.bind("render-asset",function(e,f,h){this.load(jQuery("script#admin-assets-edit")).interpolate(f.toMustacheWithNeighbors(h),"mustache").appendTo("body").then(function(){Utilities.loadModal("div#asset-editor",function(){jQuery("div#asset-editor").fadeIn("fast");window.modal=true})})});c.bind("render-index",function(e,f){var h=f.query,l=f.folder_id,n=this,v=jQuery("script#admin-assets-asset").html();
n.load(jQuery("script#admin-assets-index")).interpolate({assets:Asset.toMustache(h),folder_id:l,query:h,partials:{asset:v}},"mustache").replace("#editor").then(function(){jQuery("#ajax_uploader").attr("multiple","multiple").bind("change",function(){jQuery(this).parents("form:first").submit()});n.trigger("set_draggable_assets");n.trigger("set_droppable_folders")})});c.bind("set_draggable_assets",function(){jQuery("li.asset").draggable({revert:true,stack:".asset"})});c.bind("set_droppable_folders",
function(){jQuery("li.folder").droppable({hoverClass:"active",drop:function(e,f){var h=e.target.id.split("-")[1],l=Folder.find(h),n=f.draggable[0].id.split("-")[1];n=Asset.find(n);n.attr("folder_id",h);f.draggable.fadeOut("fast");n.save(function(v){v?Utilities.notice("Asset added to "+l.attr("name")):f.draggable.fadeIn("fast")})}})});c.bind("show_info",function(e,f){var h=Asset.find(f.current_asset_id),l=jQuery("#asset-"+h.id()),n=l.find(".info");jQuery(".modal-strip").remove();n.length||this.load(jQuery("#admin-assets-info")).interpolate({asset:h.toMustache()},
"mustache").appendTo(l).then(function(){jQuery(".modal-strip").fadeIn("fast")})});c.bind("show_remove_dialog",function(e,f){var h=Asset.find(f.current_asset_id),l=jQuery("#asset-"+h.id()),n=l.find(".remove");jQuery(".modal-strip").remove();n.length||this.load(jQuery("script#admin-assets-remove")).interpolate({asset:h.toMustache()},"mustache").appendTo(jQuery("body")).then(function(){var v=jQuery(".modal-strip");v.css({top:l.offset().top+l.height()/2,left:l.offset().left+l.width()/2});v.fadeIn("fast")})});
c.get("/admin/assets",function(e){jQuery("#overlay").remove();var f=e.params.query,h={query:f};h.limit=e.params.limit||96;h.page=e.params.page||1;if(f){e.renderFolderTree();Asset.searchAdmin(h,function(){e.trigger("render-index",{query:f})})}else e.redirect(Folder.first().attr("admin_path"))});c.get("/admin/assets/new",function(e){e.load(jQuery("script#admin-assets-new")).interpolate({},"mustache").replace("#editor").then(function(){jQuery("#ajax_uploader").attr("multiple","multiple")});a.first_run=
false});c.post("/admin/assets",function(e){var f=document.getElementById("ajax_uploader").files,h=e.params.asset.folder_id,l=e.params.query?e.params.query:null;jQuery("form#new_asset");l=l?{query:l}:{};l.limit=e.params.limit||48;l.page=e.params.page||1;l.folder_id=h;this.send_files(f,l,function(){});return false});c.get("/admin/assets/:id/edit",function(e){jQuery("#overlay").remove();var f=e.params.query?e.params.query:"",h=f?{query:e.params.query}:{},l=Asset.find(e.params.id);l?e.trigger("render-asset",
l,f):Asset.searchAdmin(h,function(){var n=Asset.find(e.params.id);console.log(n.attr("folder_id"));e.trigger("render-index",{folder_id:n.attr("folder_id")});e.renderFolderTree();e.trigger("render-asset",n,f)})});c.put("/admin/assets/:id",function(e){var f=Asset.find(e.params.id);if(f){f.attr(e.params.asset);f.save(function(h){h&&Utilities.notice("Successfully saved asset")})}else{f=new Asset({id:e.params.id});f.load(function(){f.attr(e.params.asset);f.save(function(h){h&&Utilities.notice("Successfully saved asset")})})}});
c.del("/admin/assets/:id",function(e){var f=e.params.query?e.params.query:null;f&&decodeURIComponent(jQuery.param({query:f}));f=Asset.find(e.params.id);var h=f.attr("folder_id");f.destroy(function(l){if(l){Utilities.notice("Asset removed");jQuery(".modal-strip").remove();e.redirect("/admin/folders/"+h)}})})}),Folders=Sammy(function(c){this.helpers({renderFolderTree:function(a){if(jQuery("ul#folders").length)a&&a.call(this);else this.load(jQuery("script#admin-folders-index")).interpolate({folders:Folder.asJSON()},
"mustache").replace("#sidebar").then(function(){a&&a.call(this)})}});this.get("/admin/folders/new/?",function(a){$("#modal").length==0&&Galerie.open();a.renderFolderTree(function(){jQuery("ul#folders li").removeClass("active")});a.load(jQuery("#admin-folders-new")).interpolate({},"mustache").replace("#modal")});c.get("/admin/folders/:id",function(a){jQuery("#overlay").remove();var e=a.params.id,f=Folder.find(e);a.renderFolderTree(function(){jQuery("ul#folders li").removeClass("active");jQuery("#folder-"+
e).addClass("active")});f.loadAssets(function(){a.trigger("render-index",{folder_id:f.id()})})});this.post("/admin/folders",function(a){var e=new Folder(a.params.folder);e.save(function(f,h){var l=JSON.parse(h.responseText);if(l.errors)alert(JSON.stringify(l));else{alert(e.attr("admin_path"));a.load(jQuery("script#admin-folders-index")).interpolate({folders:Folder.asJSON()},"mustache").replace("#sidebar");a.redirect(e.attr("admin_path"))}})})}),Pages=Sammy(function(c){c.helpers({renderPagePreview:function(a,
e){var f=this;f.load(jQuery("script#admin-pages-show")).interpolate({page:a.asJSON(),layouts:Layout.asLayoutJSON(a.attr("layout_id")),base_page_id:a.id()},"mustache").replace("#editor").then(function(){iFramer.initialize(".preview iframe",function(){e&&e.call(this)});f.trigger("set-active-page",a);Editor.initialize()})},renderPageEditor:function(a,e){var f=this;if(jQuery("#page-editor").length){e&&e.call(this);f.trigger("set-active-page",a)}else f.load(jQuery("script#admin-pages-edit")).interpolate({page:a.asJSON()},
"mustache").replace("#editor").then(function(){jQuery("li.node").removeClass("active");jQuery("#page-"+a.id()).addClass("active");e&&e.call(this);f.trigger("set-active-page",a)})},renderPageProperties:function(a,e){this.load(jQuery("script#admin-pages-form")).interpolate({page:a.asJSON(),layouts:Layout.asLayoutJSON(a.attr("layout_id")),base_page_id:a.id(),timestamp:window.timestamp},"mustache").replace("#page-tabs-"+a.id()).then(function(){e&&e.call(this)})},renderPageMenu:function(){var a=Page.root(),
e=Page.all(),f=jQuery.cookie("active_page_ids")?jQuery.cookie("active_page_ids").split(","):[];jQuery.each(e,function(h,l){var n=Page.root()==l||_.include(f,l.id())?true:false;l.attr({children:l.childrenAsJSON(),"open?":n})});this.load(jQuery("script#admin-pages-index")).interpolate({root:a.asJSON(),partials:{node:jQuery("script#admin-pages-node").html()}},"mustache").replace("#sidebar")}});c.bind("show-page-menu",function(a,e){var f=this;if(e.children().count()==0&&e.attr("child_count")!=0)e.getChildren(function(){e.attr("open?",
true);f.renderPageMenu(e)});else{if(e.attr("child_count")==0)e=e.parent();f.renderPageMenu(e)}});c.bind("open-page-children",function(a,e){var f=this,h=Page.find(e),l=jQuery("li#page-"+h.id()),n=jQuery.cookie("active_page_ids")?jQuery.cookie("active_page_ids").split(","):[];h.getChildren(function(){h.attr("open?",true);h.attr("children",h.childrenAsJSON());n.push(h.id());jQuery.cookie("active_page_ids",Utilities.unique(n).join(","),{path:"/admin"});f.load(jQuery("script#admin-pages-children")).interpolate({page:h.asJSON(),
partials:{node:jQuery("script#admin-pages-node").html()}},"mustache").appendTo(l)})});c.bind("close-page-children",function(a,e){var f=Page.find(e);jQuery("li#page-"+f.id()).find("ul.page-children").remove();f.children().each(function(h){Page.remove(h)})});c.bind("set-active-page",function(a,e){jQuery("li.node").removeClass("active");jQuery("li#page-"+e.id()).addClass("active")});c.bind("reload-page",function(a,e){var f=e.id(),h=jQuery("iframe#page-iframe-"+f);jQuery("li#page-"+f).find("span.title a").text(e.attr("title"));
jQuery("h1#page-title-"+f).text(e.attr("title"));h.attr("src",h.attr("src"))});this.get("/admin/pages/?",function(a){var e=Page.first();a.redirect(e.attr("admin_path"))});this.get("/admin/pages/:id/new/?",function(a){var e=Page.find(a.params.id),f=$("<div />").attr({id:"new-page-container","class":"small-modal"});$("#modal").length==0&&Galerie.open(f);a.trigger("page-index");a.load(jQuery("#admin-pages-new")).interpolate({parent:e.asJSON(),layouts:Layout.asLayoutJSON(e.attr("layout_id"))},"mustache").replace("#new-page-container")});
this.post("/admin/pages/:page_id/?",function(a){Page.find(a.params.page_id);(new Page(a.params.page)).save(function(e,f){var h=JSON.parse(f.responseText);if(h.errors)alert(JSON.stringify(h));else{Utilities.notice("Successfully created page");a.redirect(h.admin_path)}})});this.get("/admin/pages/:id/?",function(a){jQuery("#overlay").remove();jQuery(".modal-editor").remove();var e=Page.find(a.params.id);if(e)a.renderPagePreview(e);else{e=new Page({id:a.params.id});e.load(function(){a.renderPagePreview(e)})}a.trigger("show-page-menu",
e)});this.get("/admin/pages/:id/edit/?",function(a){var e=Page.find(a.params.id);a.renderPageEditor(e,function(){a.renderPageProperties(e)});a.trigger("show-page-menu",e)});this.put("/admin/pages/:page_id",function(a){var e=Page.find(a.params.page_id),f=jQuery("span.timestamp").text();e.attr(a.params.page);f<window.timestamp?alert("Someone else has edited this page, please reload and try again"):e.save(function(h){if(h){Utilities.setTimestamp();Utilities.notice("Successfully saved page");a.trigger("reload-page",
e);a.redirect(e.attr("admin_path"))}})});this.get("/admin/pages/:id/remove",function(a){var e=Page.find(a.params.id),f=$("<div />").attr({id:"remove-page-container","class":"small-modal"});$("#modal").length==0&&Galerie.open(f);a.trigger("page-index");a.load(jQuery("#admin-pages-remove")).interpolate({page:e.asJSON()},"mustache").replace("#remove-page-container")});this.del("/admin/pages/:id",function(a){var e=Page.find(a.params.id);e.destroy(function(f){if(f){jQuery("#page-"+e.id()).remove();a.redirect("/admin/pages")}})})}),
Parts=Sammy(function(c){c.helpers({renderPart:function(a,e,f){var h=this;h.load(jQuery("script#admin-"+f+"-edit")).interpolate({part:a.asJSON(),page:e.asJSON(),assets:Asset.asJSON(),timestamp:window.timestamp},"mustache").replace("#page-tabs-"+e.id()).then(function(){var l=aceModes.textile;window.editor=ace.edit("part-"+a.id()+"-content");window.editor.setTheme("ace/theme/textmate");window.editor.getSession().setMode(new l);window.editor.session.setUseWrapMode(true);window.editor.getSession().setValue(a.attr("content"));
jQuery(".toolbar a.tab").removeClass("active");jQuery(".toolbar a."+a.attr("name")+"-tab").addClass("active");h.trigger("set_asset_links");jQuery("#ajax_uploader").attr("multiple","multiple").change(function(){var n=jQuery(this).parents("form:first");jQuery(".progress").slideDown("slow",function(){n.submit()})});h.trigger("page-index")})}});this.bind("set_asset_links",function(){jQuery("#search-results-container li.asset").each(function(a,e){var f=jQuery(e).find("a"),h=jQuery(e).attr("id").split("-")[1],
l=f.find("img").attr("src");f.click(function(n){n.preventDefault();jQuery("input#part-asset-id").attr("value",h);jQuery("form#edit-part img.preview").attr("src",l.replace("icon","thumbnail"))})})});this.get("/admin/pages/:page_id/parts/:id/edit",function(a){jQuery(".modal-editor").remove();$("iframe");var e=Page.find(a.params.page_id),f=e.parts().find(a.params.id);a.trigger("show-page-menu",e);a.renderPageEditor(e,function(){a.renderPart(f,e,"parts")})});this.get("/admin/pages/:page_id/image_parts/:id/edit",
function(a){var e=Page.find(a.params.page_id),f=e.parts().find(a.params.id);$("iframe");Asset.searchAdmin({limit:"24"},function(){a.trigger("show-page-menu",e);a.renderPageEditor(e,function(){a.renderPart(f,e,"image_parts")})})});this.get("/admin/pages/:page_id/parts/:id/results",function(a){Page.find(a.params.page_id);Part.find(a.params.id);var e=a.params.query?a.params.query:null;Asset.searchAdmin(e?{query:e}:{},function(){a.load(jQuery("#admin-pages-search_results")).interpolate(Asset.toMustache(),
"mustache").replace("#search-results-container").then(function(){a.trigger("set_asset_links")})})});this.put("#/pages/:page_id/parts/:id",function(a){var e=Page.find(a.params.page_id),f=e.parts().find(a.params.id),h=e.attr("contents"),l=h.length;a.params.part.content=window.editor.getSession().getValue();for(var n=0;n<l;++n){f=h[n];if(a.params.id==f.id){f.content=a.params.part.content;f.asset_id=a.params.part.asset_id;var v=Part.find(f.id);v.attr({asset_id:a.params.part.asset_id,content:a.params.part.content});
v.save()}}e.save(function(D){if(D){Utilities.setTimestamp();Utilities.notice(v.attr("name")+" saved");window.editor.getSession().setUseSoftTabs(true);window.editor.getSession().setTabSize(2);window.editor.getSession().setMode(new editorMode)}})});this.post("#/pages/:page_id/image_parts/:id/assets",function(a){Page.find(a.params.page_id).parts().find(a.params.id);var e=document.getElementById("ajax_uploader").files,f=a.params.query?a.params.query:null;jQuery("form#new_asset");f=f?{query:f}:{};f.limit=
a.params.limit||48;f.page=a.params.page||1;this.send_files(e,f,function(){a.load(jQuery("#admin-pages-search_results")).interpolate(Asset.toMustache(),"mustache").replace("#search-results-container").then(function(){jQuery("#ajax_uploader").attr("files",null);jQuery(".progress").slideUp("slow",function(){jQuery(this).html("")});a.trigger("set_asset_links")})})})}),Users=Sammy(function(){this.helpers({loadUsers:function(c){if(User.all().length==0)User.load(function(){c&&c.call(this)});else c&&c.call(this)},
...
c.renderUserIndex()})});this.post("/admin/users",function(c){(new User(c.params.user)).save(function(a,e){var f=JSON.parse(e.responseText);f.errors?alert(JSON.stringify(f)):c.redirect("/admin/users")})});this.get("/admin/users/:id/edit",function(c){c.loadUsers(function(){user=User.find(c.params.id);if(jQuery("#users").length){jQuery(".user-form").html("");c.load(jQuery("script#admin-users-edit")).interpolate({user:user.asJSON()},"mustache").replace("#user-form-"+user.id())}else c.renderUserIndex(function(){jQuery(".user-form").html("");
c.load(jQuery("script#admin-users-edit")).interpolate({user:user.asJSON()},"mustache").replace("#user-form-"+user.id())})})});this.put("/admin/users/:id",function(c){var a=User.find(c.params.id);a.attr(c.params.user);a.save(function(e,f){var h=JSON.parse(f.responseText);h.errors?alert(JSON.stringify(h)):c.redirect("/admin/users")})})});
