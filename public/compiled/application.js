...
(function (Hogan) {
  ...
  Hogan.compile = function(text, options) {
    ...
    return this.cache[key] = template;
        ...
        this.HoganTemplates || (this.HoganTemplates = {});
        this.HoganTemplates["assets/index"] = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<header class=\"header\" id=\"folder-info\">");t.b("\n" + i);t.b("    ");t.b("\n" + i);t.b("</header>");t.b("\n");t.b("\n" + i);t.b("<ul id=\"assets\" class=\"unstyled\">");t.b("\n" + i);if(t.s(t.f("assets",c,p,1),c,p,0,106,125,"{{ }}")){t.rs(c,p,function(c,p,t){t.b(t.rp("<node0",c,p,"    "));});c.pop();}t.b("</ul>");t.b("\n");t.b("\n");t.b("\n");return t.fl(); },partials: {"<node0":{name:"node", partials: {}, subs: {  }}}, subs: {  }}, "", Hogan, {});
        this.HoganTemplates || (this.HoganTemplates = {});
        ...
        this.HoganTemplates || (this.HoganTemplates = {});
        this.HoganTemplates["layouts/form"] = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"hidden\">");t.b("\n" + i);t.b("  <input type=\"hidden\" id=\"template-klass\" name=\"klass\" value=\"");t.b(t.v(t.f("klass",c,p,0)));t.b("\" class=\"hidden\" />   ");t.b("\n" + i);t.b("</div>");t.b("\n");t.b("\n" + i);t.b("<div class=\"control-group\"> ");t.b("\n" + i);t.b("  <label class=\"control-label\" for=\"template-name\">Name</label>");t.b("\n" + i);t.b("  <div class=\"controls\">");t.b("\n" + i);t.b("    <input type=\"text\" id=\"template-name\" name=\"name\" value=\"");t.b(t.v(t.f("name",c,p,0)));t.b("\" class=\"textfield\" />  ");t.b("\n" + i);t.b("  </div>");t.b("\n" + i);t.b("</div>");t.b("\n");t.b("\n" + i);t.b("<div>");t.b("\n" + i);t.b("  <p>");t.b("\n" + i);t.b("    Short description of what parts are and what they do.");t.b("\n" + i);t.b("  </p>");t.b("\n" + i);t.b("  ");t.b("\n" + i);if(t.s(t.f("part_types",c,p,1),c,p,0,456,580,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("  <div class=\"part\">");t.b("\n" + i);t.b("    <strong>");t.b(t.v(t.f("name",c,p,0)));t.b("</strong>: Description goes here");t.b("\n" + i);t.b("    <a class=\"js-remove-part\">x</a>");t.b("\n" + i);t.b("  </div>");t.b("\n" + i);});c.pop();}if(t.s(t.f("types",c,p,1),c,p,0,612,679,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("    <a class=\"js-add-part\" data-id=\"");t.b(t.v(t.f("id",c,p,0)));t.b("\">Add a ");t.b(t.v(t.d(".",c,p,0)));t.b("</a>");t.b("\n" + i);});c.pop();}t.b("</div>");t.b("\n");t.b("\n");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "", Hogan, {});
        this.HoganTemplates || (this.HoganTemplates = {});
        ...
        this.HoganTemplates || (this.HoganTemplates = {});
        this.HoganTemplates["settings/index"] = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<section>");t.b("\n" + i);t.b("  <h2>");t.b("\n" + i);t.b("    Page Types");t.b("\n" + i);t.b("    <span class=\"modify\">");t.b("\n" + i);t.b("      <a href=\"/admin/page_types/new\" class=\"js-new\">+</a>");t.b("\n" + i);t.b("    </span>");t.b("\n" + i);t.b("  </h2>");t.b("\n" + i);t.b("  <ul class=\"unstyled\">");t.b("\n" + i);if(t.s(t.f("page_types",c,p,1),c,p,0,180,304,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("  <li>");t.b("\n" + i);t.b("    ");t.b(t.v(t.f("name",c,p,0)));t.b("\n" + i);t.b("    <a href=\"/admin/page_types/");t.b(t.v(t.f("id",c,p,0)));t.b("/remove\" data-id=\"");t.b(t.v(t.f("id",c,p,0)));t.b("\" class=\"js-remove\">x</a>");t.b("\n" + i);t.b("  </li>");t.b("\n" + i);});c.pop();}t.b("  </ul>");t.b("\n" + i);t.b("</section>");t.b("\n");t.b("\n" + i);t.b("<section>");t.b("\n" + i);t.b("  <h2>Sites</h2>");t.b("\n" + i);t.b("  <ul class=\"unstyled\">");t.b("\n" + i);if(t.s(t.f("sites",c,p,1),c,p,0,407,436,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("    <li>");t.b(t.v(t.f("domain",c,p,0)));t.b("</li>");t.b("\n" + i);});c.pop();}t.b("  </ul>");t.b("\n" + i);t.b("</section>");t.b("\n");t.b("\n" + i);t.b("<section>");t.b("\n" + i);t.b("  <h2>Users</h2>");t.b("\n" + i);t.b("  <ul class=\"unstyled\">");t.b("\n" + i);if(t.s(t.f("users",c,p,1),c,p,0,534,562,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("    <li>");t.b(t.v(t.f("email",c,p,0)));t.b("</li>");t.b("\n" + i);});c.pop();}t.b("  </ul>");t.b("\n" + i);t.b("</section>");t.b("\n");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "", Hogan, {});
        this.HoganTemplates || (this.HoganTemplates = {});
        ...
        this.HoganTemplates || (this.HoganTemplates = {});
        this.HoganTemplates["templates/add_parts"] = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");if(t.s(t.f("layout",c,p,1),c,p,0,13,706,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<div class=\"modal hide\">");t.b("\n" + i);t.b("  <div class=\"modal-header\">");t.b("\n" + i);t.b("    <a class=\"close\" data-dismiss=\"modal\">×</a>");t.b("\n" + i);t.b("    <h3>");t.b(t.v(t.f("name",c,p,0)));t.b(" Parts</h3>");t.b("\n" + i);t.b("  </div>");t.b("\n" + i);t.b("  <form method=\"post\" class=\"js-update form-horizontal\">");t.b("\n" + i);t.b("    <div class=\"modal-body\">   ");t.b("\n" + i);t.b("      <p>");t.b("\n" + i);t.b("        Short description of what parts are and what they do.");t.b("\n" + i);t.b("      </p>");t.b("\n" + i);if(t.s(t.f("part_types",c,p,1),c,p,0,350,494,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("      <div class=\"part\">");t.b("\n" + i);t.b("        <strong>");t.b(t.v(t.f("name",c,p,0)));t.b("</strong>: Description goes here");t.b("\n" + i);t.b("        <a class=\"js-remove-part\">x</a>");t.b("\n" + i);t.b("      </div>");t.b("\n" + i);});c.pop();}if(t.s(t.f("types",c,p,1),c,p,0,530,605,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("        <a class=\"js-add-part\" data-id=\"");t.b(t.v(t.f("id",c,p,0)));t.b("\">Add a ");t.b(t.v(t.d(".",c,p,0)));t.b("</a>");t.b("\n" + i);});c.pop();}t.b("    </div>");t.b("\n" + i);t.b("    ");t.b("\n" + i);t.b("    <div class=\"modal-footer\">");t.b("\n" + i);t.b("      &nbsp;");t.b("\n" + i);t.b("    </div>");t.b("\n" + i);t.b("  </form>");t.b("\n" + i);t.b("</div>");t.b("\n" + i);});c.pop();}t.b("\n");t.b("\n");return t.fl(); },partials: {}, subs: {  }}, "", Hogan, {});
        this.HoganTemplates || (this.HoganTemplates = {});
        this.HoganTemplates["templates/edit"] = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");if(t.s(t.f("layout",c,p,1),c,p,0,13,371,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<header class=\"header\">");t.b("\n" + i);t.b("  <h1 id=\"layout-title-");t.b(t.v(t.f("id",c,p,0)));t.b("\">");t.b(t.v(t.f("name",c,p,0)));t.b("</h1>");t.b("\n" + i);t.b("  <div class=\"buttons\">");t.b("\n" + i);t.b("    <a class=\"btn js-settings\">Settings</a>");t.b("\n" + i);t.b("    <!-- a class=\"btn js-parts\">Parts</a -->");t.b("\n" + i);t.b("    <a class=\"btn js-insert\">Insert</a>");t.b("\n" + i);t.b("    <a class=\"btn js-remove\">Remove</a>");t.b("\n" + i);t.b("  </div>");t.b("\n" + i);t.b("</header>    ");t.b("\n" + i);t.b("<pre id=\"code-editor\" class=\"");t.b(t.v(t.f("klass",c,p,0)));t.b(" ");t.b(t.v(t.f("mode",c,p,0)));t.b(" pane\"></pre>  ");t.b("\n" + i);});c.pop();}return t.fl(); },partials: {}, subs: {  }}, "", Hogan, {});
        this.HoganTemplates || (this.HoganTemplates = {});
