  ...
  module Cache
    ...
    def self.new(app, options={})
      ...
      Rack::Cache.new(app, {
          ...
          :entitystore => "verlag:tmp/cache/entity",
          :metastore => "verlag:tmp/cache/meta",
          :verbose => true,
          :allow_reload => false,
    ...
    class EntityStore < Rack::Cache::EntityStore::Disk
      def initialize(root="#{Rails.root}/tmp/cache/entity")
        super
        Verlag::Cache.entity_stores << self
      end
    ...
    class MetaStore < Rack::Cache::MetaStore::Disk
      ...
      def restore_response(hash, body=nil)
        ...
        if Verlag::Cache.use_x_sendfile
          ...
          entity_path = File.expand_path(Verlag::Cache.entity_stores.first.root)
          virtual_path[entity_path] = Verlag::Cache.use_x_accel_redirect
...
class Rack::Cache::EntityStore
  VERLAG = Verlag::Cache::EntityStore
end

class Rack::Cache::MetaStore
  VERLAG = Verlag::Cache::MetaStore
end