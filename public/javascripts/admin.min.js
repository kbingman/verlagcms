...
d.uaMatch(G);G.browser&&(d.browser[G.browser]=true,d.browser.version=G.version);d.browser.webkit&&(d.browser.safari=true);k.test("\u00a0")&&(n=/^[\s\xA0]+/,p=/[\s\xA0]+$/);f=d(X);X.addEventListener?(D=function(){X.removeEventListener("DOMContentLoaded",D,false);d.ready()}):X.attachEvent&&(D=function(){X.readyState==="complete"&&(X.detachEvent("onreadystatechange",D),d.ready())});return d}(),A="done fail isResolved isRejected promise then always pipe".split(" "),L=[].slice;c.extend({_Deferred:function(){var a=
...
e){e==null&&(e=b,b=null);return arguments.length>0?this.bind(d,b,e):this.trigger(d)};c.attrFn&&(c.attrFn[d]=true)});(function(){function a(o,u,G,I,D,J){D=0;for(var U=I.length;D<U;D++){var Z=I[D];if(Z){var ra=false;for(Z=Z[o];Z;){if(Z.sizcache===G){ra=I[Z.sizset];break}if(Z.nodeType===1){J||(Z.sizcache=G,Z.sizset=D);if(typeof u!="string"){if(Z===u){ra=true;break}}else if(t.filter(u,[Z]).length>0){ra=Z;break}}Z=Z[o]}I[D]=ra}}}function d(o,u,G,I,D,J){D=0;for(var U=I.length;D<U;D++){var Z=I[D];if(Z){var ra=
false;for(Z=Z[o];Z;){if(Z.sizcache===G){ra=I[Z.sizset];break}Z.nodeType===1&&!J&&(Z.sizcache=G,Z.sizset=D);if(Z.nodeName.toLowerCase()===u){ra=Z;break}Z=Z[o]}I[D]=ra}}}var b=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e=0,f=Object.prototype.toString,i=false,k=true,n=/\\/g,p=/\W/;[0,0].sort(function(){k=false;return 0});var t=function(o,u,G,I){G=G||[];var D=u=u||X;if(u.nodeType!==1&&u.nodeType!==9)return[];if(!o||
typeof o!="string")return G;var J,U,Z,ra,Ma,Ja,Sa=true,v=t.isXML(u),K=[],da=o;do{b.exec("");if(J=b.exec(da)){da=J[3];K.push(J[1]);if(J[2]){ra=J[3];break}}}while(J);if(K.length>1&&C.exec(o))if(K.length===2&&w.relative[K[0]])U=Ca(K[0]+K[1],u);else for(U=w.relative[K[0]]?[u]:t(K.shift(),u);K.length;){o=K.shift();w.relative[o]&&(o+=K.shift());U=Ca(o,U)}else{!I&&K.length>1&&u.nodeType===9&&!v&&w.match.ID.test(K[0])&&!w.match.ID.test(K[K.length-1])&&(Ma=t.find(K.shift(),u,v),u=Ma.expr?t.filter(Ma.expr,
...
else for(o=0;Z[o]!=null;o++)Z[o]&&Z[o].nodeType===1&&G.push(U[o]);else G.push.apply(G,Z);else ka(Z,G);ra&&(t(ra,D,G,I),t.uniqueSort(G));return G};t.uniqueSort=function(o){if(za){i=k;o.sort(za);if(i)for(var u=1;u<o.length;u++)o[u]===o[u-1]&&o.splice(u--,1)}return o};t.matches=function(o,u){return t(o,null,null,u)};t.matchesSelector=function(o,u){return t(u,null,null,[o]).length>0};t.find=function(o,u,G){var I;if(!o)return[];for(var D=0,J=w.order.length;D<J;D++){var U,Z=w.order[D];if(U=w.leftMatch[Z].exec(o)){var ra=
U[1];U.splice(1,1);if(ra.substr(ra.length-1)!=="\\"){U[1]=(U[1]||"").replace(n,"");I=w.find[Z](U,u,G);if(I!=null){o=o.replace(w.match[Z],"");break}}}}I||(I=typeof u.getElementsByTagName!="undefined"?u.getElementsByTagName("*"):[]);return{set:I,expr:o}};t.filter=function(o,u,G,I){for(var D,J,U=o,Z=[],ra=u,Ma=u&&u[0]&&t.isXML(u[0]);o&&u.length;){for(var Ja in w.filter)if((D=w.leftMatch[Ja].exec(o))!=null&&D[2]){var Sa,v,K=w.filter[Ja];v=D[1];J=false;D.splice(1,1);if(v.substr(v.length-1)!=="\\"){ra===
Z&&(Z=[]);if(w.preFilter[Ja])if(D=w.preFilter[Ja](D,ra,G,Z,I,Ma)){if(D===true)continue}else J=Sa=true;if(D)for(var da=0;(v=ra[da])!=null;da++)if(v){Sa=K(v,D,da,ra);var Y=I^!!Sa;G&&Sa!=null?Y?(J=true):(ra[da]=false):Y&&(Z.push(v),J=true)}if(Sa!==g){G||(ra=Z);o=o.replace(w.match[Ja],"");if(!J)return[];break}}}if(o===U)if(J==null)t.error(o);else break;U=o}return ra};t.error=function(o){throw"Syntax error, unrecognized expression: "+o;};var w=t.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,
CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},
leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(o){return o.getAttribute("href")},type:function(o){return o.getAttribute("type")}},relative:{"+":function(o,u){var G=typeof u=="string",I=G&&!p.test(u);G=G&&!I;I&&(u=u.toLowerCase());I=0;for(var D=o.length,J;I<D;I++)if(J=o[I]){for(;(J=J.previousSibling)&&J.nodeType!==1;);o[I]=G||J&&J.nodeName.toLowerCase()===u?J||false:J===u}G&&t.filter(u,o,true)},">":function(o,u){var G,I=typeof u=="string",D=0,J=o.length;if(I&&
!p.test(u))for(u=u.toLowerCase();D<J;D++){if(G=o[D]){G=G.parentNode;o[D]=G.nodeName.toLowerCase()===u?G:false}}else{for(;D<J;D++)(G=o[D])&&(o[D]=I?G.parentNode:G.parentNode===u);I&&t.filter(u,o,true)}},"":function(o,u,G){var I,D=e++,J=a;typeof u=="string"&&!p.test(u)&&(u=u.toLowerCase(),I=u,J=d);J("parentNode",u,D,o,I,G)},"~":function(o,u,G){var I,D=e++,J=a;typeof u=="string"&&!p.test(u)&&(u=u.toLowerCase(),I=u,J=d);J("previousSibling",u,D,o,I,G)}},find:{ID:function(o,u,G){if(typeof u.getElementById!=
...
(" "+U.className+" ").replace(/[\t\n\r]/g," ").indexOf(o)>=0)?G||I.push(U):G&&(u[J]=false));return false},ID:function(o){return o[1].replace(n,"")},TAG:function(o){return o[1].replace(n,"").toLowerCase()},CHILD:function(o){if(o[1]==="nth"){o[2]||t.error(o[0]);o[2]=o[2].replace(/^\+|\s*/g,"");var u=/(-?)(\d*)(?:n([+\-]?\d*))?/.exec(o[2]==="even"&&"2n"||o[2]==="odd"&&"2n+1"||!/\D/.test(o[2])&&"0n+"+o[2]||o[2]);o[2]=u[1]+(u[2]||1)-0;o[3]=u[3]-0}else o[2]&&t.error(o[0]);o[0]=e++;return o},ATTR:function(o,
u,G,I,D,J){u=o[1]=o[1].replace(n,"");!J&&w.attrMap[u]&&(o[1]=w.attrMap[u]);o[4]=(o[4]||o[5]||"").replace(n,"");o[2]==="~="&&(o[4]=" "+o[4]+" ");return o},PSEUDO:function(o,u,G,I,D){if(o[1]==="not")if((b.exec(o[3])||"").length>1||/^\w/.test(o[3]))o[3]=t(o[3],null,null,u);else{o=t.filter(o[3],u,G,true^D);G||I.push.apply(I,o);return false}else if(w.match.POS.test(o[0])||w.match.CHILD.test(o[0]))return true;return o},POS:function(o){o.unshift(true);return o}},filters:{enabled:function(o){return o.disabled===
false&&o.type!=="hidden"},disabled:function(o){return o.disabled===true},checked:function(o){return o.checked===true},selected:function(o){return o.selected===true},parent:function(o){return!!o.firstChild},empty:function(o){return!o.firstChild},has:function(o,u,G){return!!t(G[3],o).length},header:function(o){return/h\d/i.test(o.nodeName)},text:function(o){var u=o.getAttribute("type"),G=o.type;return o.nodeName.toLowerCase()==="input"&&"text"===G&&(u===G||u===null)},radio:function(o){return o.nodeName.toLowerCase()===
...
u,G){return u>G[3]-0},nth:function(o,u,G){return G[3]-0===u},eq:function(o,u,G){return G[3]-0===u}},filter:{PSEUDO:function(o,u,G,I){var D=u[1],J=w.filters[D];if(J)return J(o,G,u,I);if(D==="contains")return(o.textContent||o.innerText||t.getText([o])||"").indexOf(u[3])>=0;if(D==="not"){u=u[3];G=0;for(I=u.length;G<I;G++)if(u[G]===o)return false;return true}t.error(D)},CHILD:function(o,u){var G=u[1],I=o;switch(G){case "only":case "first":for(;I=I.previousSibling;)if(I.nodeType===1)return false;if(G===
...
u},CLASS:function(o,u){return(" "+(o.className||o.getAttribute("class"))+" ").indexOf(u)>-1},ATTR:function(o,u){var G=u[1];G=w.attrHandle[G]?w.attrHandle[G](o):o[G]!=null?o[G]:o.getAttribute(G);var I=G+"",D=u[2],J=u[4];return G==null?D==="!=":D==="="?I===J:D==="*="?I.indexOf(J)>=0:D==="~="?(" "+I+" ").indexOf(J)>=0:J?D==="!="?I!==J:D==="^="?I.indexOf(J)===0:D==="$="?I.substr(I.length-J.length)===J:D==="|="?I===J||I.substr(0,J.length+1)===J+"-":false:I&&G!==false},POS:function(o,u,G,I){var D=w.setFilters[u[2]];
if(D)return D(o,G,u,I)}}},C=w.match.POS,R=function(o,u){return"\\"+(u-0+1)};for(var ba in w.match){w.match[ba]=new RegExp(w.match[ba].source+/(?![^\[]*\])(?![^\(]*\))/.source);w.leftMatch[ba]=new RegExp(/(^(?:.|\r|\n)*?)/.source+w.match[ba].source.replace(/\\(\d+)/g,R))}var ka=function(o,u){o=Array.prototype.slice.call(o,0);if(u){u.push.apply(u,o);return u}return o};try{Array.prototype.slice.call(X.documentElement.childNodes,0)}catch(Ia){ka=function(o,u){var G=0,I=u||[];if(f.call(o)==="[object Array]")Array.prototype.push.apply(I,
o);else if(typeof o.length=="number")for(var D=o.length;G<D;G++)I.push(o[G]);else for(;o[G];G++)I.push(o[G]);return I}}var za,Ba;X.documentElement.compareDocumentPosition?(za=function(o,u){if(o===u){i=true;return 0}if(!o.compareDocumentPosition||!u.compareDocumentPosition)return o.compareDocumentPosition?-1:1;return o.compareDocumentPosition(u)&4?-1:1}):(za=function(o,u){if(o===u){i=true;return 0}if(o.sourceIndex&&u.sourceIndex)return o.sourceIndex-u.sourceIndex;var G,I,D=[],J=[];G=o.parentNode;I=
u.parentNode;var U=G;if(G===I)return Ba(o,u);if(!G)return-1;if(!I)return 1;for(;U;){D.unshift(U);U=U.parentNode}for(U=I;U;){J.unshift(U);U=U.parentNode}G=D.length;I=J.length;for(U=0;U<G&&U<I;U++)if(D[U]!==J[U])return Ba(D[U],J[U]);return U===G?Ba(o,J[U],-1):Ba(D[U],u,1)},Ba=function(o,u,G){if(o===u)return G;for(o=o.nextSibling;o;){if(o===u)return-1;o=o.nextSibling}return 1});t.getText=function(o){for(var u="",G,I=0;o[I];I++){G=o[I];G.nodeType===3||G.nodeType===4?(u+=G.nodeValue):G.nodeType!==8&&(u+=
t.getText(G.childNodes))}return u};(function(){var o=X.createElement("div"),u="script"+(new Date).getTime(),G=X.documentElement;o.innerHTML="<a name='"+u+"'/>";G.insertBefore(o,G.firstChild);X.getElementById(u)&&(w.find.ID=function(I,D,J){if(typeof D.getElementById!="undefined"&&!J)return(D=D.getElementById(I[1]))?D.id===I[1]||typeof D.getAttributeNode!="undefined"&&D.getAttributeNode("id").nodeValue===I[1]?[D]:g:[]},w.filter.ID=function(I,D){var J=typeof I.getAttributeNode!="undefined"&&I.getAttributeNode("id");
return I.nodeType===1&&J&&J.nodeValue===D});G.removeChild(o);G=o=null})();(function(){var o=X.createElement("div");o.appendChild(X.createComment(""));o.getElementsByTagName("*").length>0&&(w.find.TAG=function(u,G){var I=G.getElementsByTagName(u[1]);if(u[1]==="*"){for(var D=[],J=0;I[J];J++)I[J].nodeType===1&&D.push(I[J]);I=D}return I});o.innerHTML="<a href='#'></a>";o.firstChild&&typeof o.firstChild.getAttribute!="undefined"&&o.firstChild.getAttribute("href")!=="#"&&(w.attrHandle.href=function(u){return u.getAttribute("href",
...
D,J,U)};for(var G in o)t[G]=o[G];u=null}}();(function(){var o=X.documentElement,u=o.matchesSelector||o.mozMatchesSelector||o.webkitMatchesSelector||o.msMatchesSelector;if(u){var G=!u.call(X.createElement("div"),"div"),I=false;try{u.call(X.documentElement,"[test!='']:sizzle")}catch(D){I=true}t.matchesSelector=function(J,U){U=U.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!t.isXML(J))try{if(I||!w.match.PSEUDO.test(U)&&!/!=/.test(U)){var Z=u.call(J,U);if(Z||!G||J.document&&J.document.nodeType!==11)return Z}}catch(ra){}return t(U,
null,null,[J]).length>0}}})();(function(){var o=X.createElement("div");o.innerHTML="<div class='test e'></div><div class='test'></div>";if(o.getElementsByClassName&&o.getElementsByClassName("e").length!==0){o.lastChild.className="e";if(o.getElementsByClassName("e").length!==1){w.order.splice(1,0,"CLASS");w.find.CLASS=function(u,G,I){if(typeof G.getElementsByClassName!="undefined"&&!I)return G.getElementsByClassName(u[1])};o=null}}})();X.documentElement.contains?(t.contains=function(o,u){return o!==
u&&(o.contains?o.contains(u):true)}):X.documentElement.compareDocumentPosition?(t.contains=function(o,u){return!!(o.compareDocumentPosition(u)&16)}):(t.contains=function(){return false});t.isXML=function(o){return(o=(o?o.ownerDocument||o:0).documentElement)?o.nodeName!=="HTML":false};var Ca=function(o,u){for(var G,I=[],D="",J=u.nodeType?[u]:u;G=w.match.PSEUDO.exec(o);){D+=G[0];o=o.replace(w.match.PSEUDO,"")}o=w.relative[o]?o+"*":o;G=0;for(var U=J.length;G<U;G++)t(o,J[G],I);return t.filter(D,I)};c.find=
...
abort:function(){d&&d.onload(0,1)}}}});var bb=h.ActiveXObject?function(){for(var a in pb)pb[a](0,1)}:false,Ua=0,pb;c.ajaxSettings.xhr=h.ActiveXObject?function(){var a;if(!(a=!this.isLocal&&F()))a:{try{a=new h.ActiveXObject("Microsoft.XMLHTTP");break a}catch(d){}a=void 0}return a}:F;(function(a){c.extend(c.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(c.ajaxSettings.xhr());c.support.ajax&&c.ajaxTransport(function(a){if(!a.crossDomain||c.support.cors){var d;return{send:function(b,e){var f=a.xhr(),
...
(c.style(this,w,(ka||1)+Ia),ba=(ka||1)/k.cur()*ba,c.style(this,w,ba+Ia)),R[1]&&(ka=(R[1]==="-="?-1:1)*ka+ba),k.custom(ba,ka,Ia)):k.custom(ba,t,""))}return true})},stop:function(a,d){a&&this.queue([]);this.each(function(){var b=c.timers,e=b.length;for(d||c._unmark(true,this);e--;)b[e].elem===this&&(d&&b[e](true),b.splice(e,1))});d||this.dequeue();return this}});c.each({slideDown:s("show",1),slideUp:s("hide",1),slideToggle:s("toggle",1),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},
...
(function(h,g){var j,l=/:([\w\d]+)/g,s=/\?([^#]*)$/,q=function(m){return Array.prototype.slice.call(m)},x=function(m){return Object.prototype.toString.call(m)==="[object Function]"},F=function(m){return Object.prototype.toString.call(m)==="[object Array]"},B=function(m){return decodeURIComponent((m||"").replace(/\+/g," "))},z=encodeURIComponent,N=function(m){return String(m).replace(/&(?!\w+;)/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")},P=function(m){return function(r,
y){return this.route.apply(this,[m,r,y])}},la={},pa=!!(g.history&&history.pushState),na=[];j=function(){var m=q(arguments),r,y;j.apps=j.apps||{};if(m.length===0||m[0]&&x(m[0]))return j.apply(j,["body"].concat(m));else if(typeof(y=m.shift())=="string"){r=j.apps[y]||new j.Application;r.element_selector=y;m.length>0&&h.each(m,function(E,ca){r.use(ca)});r.element_selector!=y&&delete j.apps[y];return j.apps[r.element_selector]=r}};j.VERSION="0.7.0";j.addLogger=function(m){na.push(m)};j.log=function(){var m=
q(arguments);m.unshift("["+Date()+"]");h.each(na,function(r,y){y.apply(j,m)})};if(typeof g.console!="undefined")x(g.console.log.apply)?j.addLogger(function(){g.console.log.apply(g.console,arguments)}):j.addLogger(function(){g.console.log(arguments)});else typeof console!="undefined"&&j.addLogger(function(){console.log.apply(console,arguments)});h.extend(j,{makeArray:q,isFunction:x,isArray:F});j.Object=function(m){return h.extend(this,m||{})};h.extend(j.Object.prototype,{escapeHTML:N,h:N,toHash:function(){var m=
{};h.each(this,function(r,y){x(y)||(m[r]=y)});return m},toHTML:function(){var m="";h.each(this,function(r,y){x(y)||(m+="<strong>"+r+"</strong> "+y+"<br />")});return m},keys:function(m){var r=[];for(var y in this)if(!x(this[y])||!m)r.push(y);return r},has:function(m){return this[m]&&h.trim(this[m].toString())!==""},join:function(){var m=q(arguments),r=m.shift();return m.join(r)},log:function(){j.log.apply(j,arguments)},toString:function(m){var r=[];h.each(this,function(y,E){if(!x(E)||m)r.push('"'+
...
function(E,ca){m._unlisten(r,ca)})});this._running=false;return this},bindToAllEvents:function(m){var r=this;h.each(this.APP_EVENTS,function(y,E){r.bind(E,m)});h.each(this.listeners.keys(true),function(y,E){h.inArray(E,r.APP_EVENTS)==-1&&r.bind(E,m)});return this},routablePath:function(m){return m.replace(s,"")},lookupRoute:function(m,r){var y=false,E=0,ca,oa;if(typeof this.routes[m]!="undefined")for(ca=this.routes[m].length;E<ca;E++){oa=this.routes[m][E];if(this.routablePath(r).match(oa.path)){y=
...
r).swap()},send:function(){var m=this,r=q(arguments),y=r.shift();if(F(r[0]))r=r[0];return this.then(function(){r.push(function(E){m.next(E)});m.wait();y.apply(y,r);return false})},collect:function(m,r,y){var E=this,ca=function(){if(x(m)){r=m;m=this.content}var oa=[],T=false;h.each(m,function(fa,ga){var xa=r.apply(E,[fa,ga]);if(xa.jquery&&xa.length==1){xa=xa[0];T=true}oa.push(xa);return xa});return T?oa:oa.join("")};return y?ca():this.then(ca)},renderEach:function(m,r,y,E){if(F(r)){E=y;y=r;r=null}return this.load(m).then(function(ca){var oa=
this;y||(y=F(this.previous_content)?this.previous_content:[]);if(E)h.each(y,function(T,fa){var ga={},xa=this.next_engine||m;r?(ga[r]=fa):(ga=fa);E(fa,oa.event_context.interpolate(ca,ga,xa))});else return this.collect(y,function(T,fa){var ga={},xa=this.next_engine||m;r?(ga[r]=fa):(ga=fa);return this.event_context.interpolate(ca,ga,xa)},true)})},interpolate:function(m,r,y){var E=this;return this.then(function(ca,oa){if(!m&&oa)m=oa;if(this.next_engine){r=this.next_engine;this.next_engine=false}var T=
...
(function(h){function g(l){l=unescape(l);return l==="true"?true:l==="false"?false:l}function j(l,s,q){var x;if(s.match(/^[^\[]+$/))l[s]=g(q);else if(x=s.match(/^([^\[]+)\[\](.*)$/)){s=x[1];x=x[2];if(l[s]&&!h.isArray(l[s]))throw"400 Bad Request";if(x){x=x.match(/^\[([^\]]+)\](.*)$/);if(!x)throw"400 Bad Request";if(l[s])l[s][l[s].length-1][x[1]]?l[s].push(j({},x[1]+x[2],q)):h.extend(true,l[s][l[s].length-1],j({},x[1]+x[2],q));else l[s]=[j({},x[1]+x[2],q)]}else if(l[s])l[s].push(g(q));else l[s]=[g(q)]}else if(x=
s.match(/^([^\[]+)\[([^\[]+)\](.*)$/)){s=x[1];x=x[2]+x[3];if(l[s]&&h.isArray(l[s]))throw"400 Bad Request";if(l[s])h.extend(true,l[s],j(l[s],x,q));else l[s]=j({},x,q)}return l}Sammy=Sammy||{};Sammy.NestedParams=function(l){l._parseParamPair=j}})(jQuery);
(function(){if(!window.JSON)window.JSON={};(function(){function h(z){return z<10?"0"+z:z}function g(z){s.lastIndex=0;return s.test(z)?'"'+z.replace(s,function(N){var P=F[N];return typeof P==="string"?P:"\\u"+("0000"+N.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+z+'"'}function j(z,N){var P,la,pa,na,m=q,r,y=N[z];if(y&&typeof y==="object"&&typeof y.toJSON==="function")y=y.toJSON(z);if(typeof B==="function")y=B.call(N,z,y);switch(typeof y){case "string":return g(y);case "number":return isFinite(y)?
String(y):"null";case "boolean":case "null":return String(y);case "object":if(!y)return"null";q+=x;r=[];if(Object.prototype.toString.apply(y)==="[object Array]"){na=y.length;for(P=0;P<na;P+=1)r[P]=j(P,y)||"null";pa=r.length===0?"[]":q?"[\n"+q+r.join(",\n"+q)+"\n"+m+"]":"["+r.join(",")+"]";q=m;return pa}if(B&&typeof B==="object"){na=B.length;for(P=0;P<na;P+=1){la=B[P];if(typeof la==="string")if(pa=j(la,y))r.push(g(la)+(q?": ":":")+pa)}}else for(la in y)if(Object.hasOwnProperty.call(y,la))if(pa=j(la,
y))r.push(g(la)+(q?": ":":")+pa);pa=r.length===0?"{}":q?"{\n"+q+r.join(",\n"+q)+"\n"+m+"}":"{"+r.join(",")+"}";q=m;return pa}}if(typeof Date.prototype.toJSON!=="function"){Date.prototype.toJSON=function(){return this.getUTCFullYear()+"-"+h(this.getUTCMonth()+1)+"-"+h(this.getUTCDate())+"T"+h(this.getUTCHours())+":"+h(this.getUTCMinutes())+":"+h(this.getUTCSeconds())+"Z"};String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()}}var l=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
s=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,q,x,F={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},B;if(typeof JSON.stringify!=="function")JSON.stringify=function(z,N,P){var la;x=q="";if(typeof P==="number")for(la=0;la<P;la+=1)x+=" ";else if(typeof P==="string")x=P;if((B=N)&&typeof N!=="function"&&(typeof N!=="object"||typeof N.length!=="number"))throw new Error("JSON.stringify");
...
(function(h){if(!window.Mustache)var g=function(){var j=function(){};j.prototype={otag:"{{",ctag:"}}",pragmas:{},buffer:[],pragmas_implemented:{"IMPLICIT-ITERATOR":true},context:{},render:function(l,s,q,x){if(!x){this.context=s;this.buffer=[]}if(!this.includes("",l))if(x)return l;else{this.send(l);return}l=this.render_pragmas(l);l=this.render_section(l,s,q);if(x)return this.render_tags(l,s,q,x);this.render_tags(l,s,q,x)},send:function(l){l!=""&&this.buffer.push(l)},render_pragmas:function(l){if(!this.includes("%",
l))return l;var s=this;return l.replace(new RegExp(this.otag+"%([\\w-]+) ?([\\w]+=[\\w]+)?"+this.ctag),function(q,x,F){if(!s.pragmas_implemented[x])throw{message:"This implementation of mustache doesn't understand the '"+x+"' pragma"};s.pragmas[x]={};if(F){q=F.split("=");s.pragmas[x][q[0]]=q[1]}return""})},render_partial:function(l,s,q){l=this.trim(l);if(!q||q[l]===undefined)throw{message:"unknown_partial '"+l+"'"};if(typeof s[l]!="object")return this.render(q[l],s,q,true);return this.render(q[l],
s[l],q,true)},render_section:function(l,s,q){if(!this.includes("#",l)&&!this.includes("^",l))return l;var x=this;return l.replace(new RegExp(this.otag+"(\\^|\\#)\\s*(.+)\\s*"+this.ctag+"\n*([\\s\\S]+?)"+this.otag+"\\/\\s*\\2\\s*"+this.ctag+"\\s*","mg"),function(F,B,z,N){F=x.find(z,s);if(B=="^")return!F||x.is_array(F)&&F.length===0?x.render(N,s,q,true):"";else if(B=="#")return x.is_array(F)?x.map(F,function(P){return x.render(N,x.create_context(P),q,true)}).join(""):x.is_object(F)?x.render(N,x.create_context(F),
q,true):typeof F==="function"?F.call(s,N,function(P){return x.render(P,s,q,true)}):F?x.render(N,s,q,true):""})},render_tags:function(l,s,q,x){var F=this,B=function(){return new RegExp(F.otag+"(=|!|>|\\{|%)?([^\\/#\\^]+?)\\1?"+F.ctag+"+","g")},z=B(),N=function(la,pa,na){switch(pa){case "!":return"";case "=":F.set_delimiters(na);z=B();return"";case ">":return F.render_partial(na,s,q);case "{":return F.find(na,s);default:return F.escape(F.find(na,s))}};l=l.split("\n");for(var P=0;P<l.length;P++){l[P]=
l[P].replace(z,N,this);x||this.send(l[P])}if(x)return l.join("\n")},set_delimiters:function(l){l=l.split(" ");this.otag=this.escape_regex(l[0]);this.ctag=this.escape_regex(l[1])},escape_regex:function(l){if(!arguments.callee.sRE)arguments.callee.sRE=new RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\)","g");return l.replace(arguments.callee.sRE,"\\$1")},find:function(l,s){l=this.trim(l);var q;if(s[l]===false||s[l]===0||s[l])q=s[l];else if(this.context[l]===false||this.context[l]===0||
this.context[l])q=this.context[l];if(typeof q==="function")return q.apply(s);if(q!==undefined)return q;return""},includes:function(l,s){return s.indexOf(this.otag+l)!=-1},escape:function(l){return String(l===null?"":l).replace(/&(?!\w+;)|["<>\\]/g,function(s){switch(s){case "&":return"&amp;";case "\\":return"\\\\";case '"':return'"';case "<":return"&lt;";case ">":return"&gt;";default:return s}})},create_context:function(l){if(this.is_object(l))return l;else{var s=".";if(this.pragmas["IMPLICIT-ITERATOR"])s=
this.pragmas["IMPLICIT-ITERATOR"].iterator;var q={};q[s]=l;return q}},is_object:function(l){return l&&typeof l=="object"},is_array:function(l){return Object.prototype.toString.call(l)==="[object Array]"},trim:function(l){return l.replace(/^\s*|\s*$/g,"")},map:function(l,s){if(typeof l.map=="function")return l.map(s);else{for(var q=[],x=l.length,F=0;F<x;F++)q.push(s(l[F]));return q}}};return{name:"mustache.js",version:"0.3.1-dev",to_html:function(l,s,q,x){var F=new j;if(x)F.send=x;F.render(l,s,q);
if(!x)return F.buffer.join("\n")}}}();Sammy=Sammy||{};Sammy.Mustache=function(j,l){l||(l="mustache");j.helper(l,function(s,q,x){q=h.extend({},this,q);x=h.extend({},q.partials,x);return g.to_html(s,q,x)})}})(jQuery);
window.Modernizr=function(h,g,j){function l(){F.input=function(Q){for(var V=0,c=Q.length;V<c;V++)oa[Q[V]]=!!(Q[V]in la);return oa}("autocomplete autofocus list placeholder max min multiple pattern required step".split(" "));F.inputtypes=function(Q){for(var V=0,c,A,L,M=Q.length;V<M;V++){la.setAttribute("type",A=Q[V]);(c=la.type!=="text")&&(la.value=pa,la.style.cssText="position:absolute;visibility:hidden;",/^range$/.test(A)&&la.style.WebkitAppearance!==j?(B.appendChild(la),L=g.defaultView,c=L.getComputedStyle&&
L.getComputedStyle(la,null).WebkitAppearance!=="textfield"&&la.offsetHeight!==0,B.removeChild(la)):/^(search|tel)$/.test(A)||(/^(url|email)$/.test(A)?(c=la.checkValidity&&la.checkValidity()===false):/^color$/.test(A)?(B.appendChild(la),c=la.value!=pa,B.removeChild(la)):(c=la.value!=pa)));ca[Q[V]]=!!c}return ca}("search tel url email datetime date month week time datetime-local number range color".split(" "))}function s(Q,V){var c=Q.charAt(0).toUpperCase()+Q.substr(1);c=(Q+" "+r.join(c+" ")+c).split(" ");
return!!q(c,V)}function q(Q,V){for(var c in Q)if(P[Q[c]]!==j&&(!V||V(Q[c],N)))return true}function x(Q,V){return typeof Q===V}var F={},B=g.documentElement,z=g.head||g.getElementsByTagName("head")[0],N=g.createElement("modernizr"),P=N.style,la=g.createElement("input"),pa=":)",na=Object.prototype.toString,m=" -webkit- -moz- -o- -ms- -khtml- ".split(" "),r="Webkit Moz O ms Khtml".split(" "),y={svg:"http://www.w3.org/2000/svg"},E={},ca={},oa={},T=[],fa,ga=function(Q){var V=g.createElement("style"),c=
...
B.appendChild(Q);var c=V.offsetWidth===42;Q.removeChild(V);B.removeChild(Q);return c};E.canvas=function(){var Q=g.createElement("canvas");return Q.getContext&&Q.getContext("2d")};E.canvastext=function(){return F.canvas&&x(g.createElement("canvas").getContext("2d").fillText,"function")};E.webgl=function(){return!!h.WebGLRenderingContext};E.touch=function(){return"ontouchstart"in h||ga("@media ("+m.join("touch-enabled),(")+"modernizr)")};E.geolocation=function(){return!!navigator.geolocation};E.postmessage=
...
"background-color:rgba(150,255,150,.5)";return(""+P.backgroundColor).indexOf("rgba")!==-1};E.hsla=function(){P.cssText="background-color:hsla(120,40%,100%,.5)";return(""+P.backgroundColor).indexOf("rgba")!==-1||(""+P.backgroundColor).indexOf("hsla")!==-1};E.multiplebgs=function(){P.cssText="background:url(//:),url(//:),red url(//:)";return/(url\s*\(.*?){3}/.test(P.background)};E.backgroundsize=function(){return s("backgroundSize")};E.borderimage=function(){return s("borderImage")};E.borderradius=
function(){return s("borderRadius","",function(Q){return(""+Q).indexOf("orderRadius")!==-1})};E.boxshadow=function(){return s("boxShadow")};E.textshadow=function(){return g.createElement("div").style.textShadow===""};E.opacity=function(){var Q=m.join("opacity:.55;")+"";P.cssText=Q;return/^0.55$/.test(P.opacity)};E.cssanimations=function(){return s("animationName")};E.csscolumns=function(){return s("columnCount")};E.cssgradients=function(){var Q=("background-image:"+m.join("gradient(linear,left top,right bottom,from(#9f9),to(white));background-image:")+
m.join("linear-gradient(left top,#9f9, white);background-image:")).slice(0,-17);P.cssText=Q;return(""+P.backgroundImage).indexOf("gradient")!==-1};E.cssreflections=function(){return s("boxReflect")};E.csstransforms=function(){return!!q(["transformProperty","WebkitTransform","MozTransform","OTransform","msTransform"])};E.csstransforms3d=function(){var Q=!!q(["perspectiveProperty","WebkitPerspective","MozPerspective","OPerspective","msPerspective"]);Q&&"webkitPerspective"in B.style&&(Q=ga("@media ("+
m.join("transform-3d),(")+"modernizr)"));return Q};E.csstransitions=function(){return s("transitionProperty")};E.fontface=function(){var Q,V,c=z||B,A=g.createElement("style");V=g.implementation||{hasFeature:function(){return false}};A.type="text/css";c.insertBefore(A,c.firstChild);Q=A.sheet||A.styleSheet;V=(V.hasFeature("CSS2","")?function(L){if(!Q||!L)return false;var M=false;try{Q.insertRule(L,0);M=/src/i.test(Q.cssRules[0].cssText);Q.deleteRule(Q.cssRules.length-1)}catch(S){}return M}:function(L){if(!Q||
...
X)&&(fa=X.toLowerCase(),F[fa]=E[X](),T.push((F[fa]?"":"no-")+fa));F.input||l();F.crosswindowmessaging=F.postmessage;F.historymanagement=F.history;F.addTest=function(Q,V){Q=Q.toLowerCase();if(!F[Q]){V=!!V();B.className+=" "+(V?"":"no-")+Q;F[Q]=V;return F}};P.cssText="";N=la=null;h.attachEvent&&function(){var Q=g.createElement("div");Q.innerHTML="<elem></elem>";return Q.childNodes.length!==1}()&&function(Q,V){function c(aa,ha){for(var sa=-1,ta=aa.length,La,gb=[];++sa<ta;){La=aa[sa];(ha=La.media||ha)!=
...
g);F._enableHTML5=true;F._version="1.7";B.className=B.className.replace(/\bno-js\b/,"")+" js "+T.join(" ");return F}(this,this.document);
...
Model.ClassMethods={add:function(h){var g=h.id();if(jQuery.inArray(h,this.collection)===-1&&!(g&&this.find(g))){this.collection.push(h);this.trigger("add",[h])}return this},all:function(){return this.collection.slice()},chain:function(h){return jQuery.extend({},this,{collection:h})},count:function(){return this.all().length},detect:function(h){for(var g=this.all(),j,l=0,s=g.length;l<s;l++){j=g[l];if(h.call(j,j,l))return j}},each:function(h,g){for(var j=this.all(),l=0,s=j.length;l<s;l++)h.call(g||
j[l],j[l],l,j);return this},find:function(h){return this.detect(function(){return this.id()==h})},first:function(){return this.all()[0]},load:function(h){if(this._persistence){var g=this;this._persistence.read(function(j){for(var l=0,s=j.length;l<s;l++)g.add(j[l]);h&&h.call(g,j)})}return this},last:function(){var h=this.all();return h[h.length-1]},map:function(h,g){for(var j=this.all(),l=[],s=0,q=j.length;s<q;s++)l.push(h.call(g||j[s],j[s],s,j));return l},persistence:function(h){if(arguments.length==
0)return this._persistence;else{var g=Array.prototype.slice.call(arguments,1);g.unshift(this);this._persistence=h.apply(h,g);return this}},pluck:function(h){for(var g=this.all(),j=[],l=0,s=g.length;l<s;l++)j.push(g[l].attr(h));return j},remove:function(h){for(var g,j=0,l=this.collection.length;j<l;j++)if(this.collection[j]===h){g=j;break}if(g!=undefined){this.collection.splice(g,1);this.trigger("remove",[h]);return true}else return false},reverse:function(){return this.chain(this.all().reverse())},
select:function(h,g){for(var j=this.all(),l=[],s,q=0,x=j.length;q<x;q++){s=j[q];if(h.call(g||s,s,q,j))l.push(s)}return this.chain(l)},sort:function(h){return this.chain(this.all().sort(h))},sortBy:function(h){var g=jQuery.isFunction(h);return this.sort(function(j,l){var s=g?h.call(j):j.attr(h),q=g?h.call(l):l.attr(h);return s<q?-1:s>q?1:0})},use:function(h){var g=Array.prototype.slice.call(arguments,1);g.unshift(this);h.apply(this,g);return this}};
...
Model.localStorage=function(h){if(!window.localStorage)return{create:function(s,q){q(true)},destroy:function(s,q){q(true)},read:function(s){s([])},update:function(s,q){q(true)}};var g=[h._name,"collection"].join("-"),j=function(){var s=localStorage[g];return s?JSON.parse(s):[]},l=function(s){localStorage.setItem(s.uid,JSON.stringify(s.asJSON()));s=s.uid;var q=j();if(jQuery.inArray(s,q)===-1){q.push(s);localStorage.setItem(g,JSON.stringify(q))}};return{create:function(s,q){l(s);q(true)},destroy:function(s,
q){localStorage.removeItem(s.uid);var x=s.uid,F=j();x=jQuery.inArray(x,F);if(x>-1){F.splice(x,1);localStorage.setItem(g,JSON.stringify(F))}q(true)},read:function(s){if(!s)return false;for(var q=h.map(function(){return this.uid}),x=j(),F=[],B,z,N=0,P=x.length;N<P;N++){z=x[N];if(jQuery.inArray(z,q)==-1){B=JSON.parse(localStorage[z]);B=new h(B);B.uid=z;F.push(B)}}s(F)},update:function(s,q){l(s);q(true)}}};Model.Log=function(){window.console&&window.console.log.apply(window.console,arguments)};
...
Model.REST=function(h,g,j){var l=/:([\w\d]+)/g,s=function(){for(var q=[],x;(x=l.exec(g))!==null;)q.push(x[1]);return q}();return jQuery.extend({path:function(q){var x=g;jQuery.each(s,function(F,B){x=x.replace(":"+B,q.attributes[B])});return x},create:function(q,x){return this.xhr("POST",this.create_path(q),q,x)},create_path:function(q){return this.path(q)},destroy:function(q,x){return this.xhr("DELETE",this.destroy_path(q),q,x)},destroy_path:function(q){return this.update_path(q)},params:function(q){var x;
if(q){var F=q.asJSON();delete F[q.constructor.unique_key];x={};x[q.constructor._name.toLowerCase()]=F}else x=null;if(jQuery.ajaxSettings.data)x=jQuery.extend({},jQuery.ajaxSettings.data,x);return x},read:function(q){return this.xhr("GET",this.read_path(),null,function(x,F,B){B=jQuery.makeArray(B);x=[];F=0;for(var z=B.length;F<z;F++)x.push(new h(B[F]));q(x)})},read_path:function(){return g},update:function(q,x){return this.xhr("PUT",this.update_path(q),q,x)},update_path:function(q){return[this.path(q),
q.id()].join("/")},xhr:function(q,x,F,B){var z=this,N=q=="GET"?undefined:this.params(F);return jQuery.ajax({type:q,url:x+".json",dataType:"json",data:N,dataFilter:function(P){return/\S/.test(P)?P:undefined},complete:function(P,la){z.xhrComplete(P,la,F,B)}})},xhrComplete:function(q,x,F,B){var z=Model.REST["handle"+q.status];z&&z.call(this,q,x,F);x=x==="success";z=Model.REST.parseResponseData(q);x&&F&&z&&F.attr(z);B&&B.call(F,x,q,z)}},j)};Model.RestPersistence=Model.REST;
...
Model.SinatraREST=function(h,g,j){var l=/:([\w\d]+)/g,s=function(){for(var q=[],x;(x=l.exec(g))!==null;)q.push(x[1]);return q}();return jQuery.extend({path:function(q){var x=g;jQuery.each(s,function(F,B){x=x.replace(":"+B,q.attributes[B])});return x},create:function(q,x){return this.xhr("POST",this.create_path(q),q,x)},create_path:function(q){return this.path(q)},destroy:function(q,x){return this.xhr("DELETE",this.destroy_path(q),q,x)},destroy_path:function(q){return this.update_path(q)},params:function(q){var x;
if(q){var F=q.asJSON();delete F[q.constructor.unique_key];x={};x[q.constructor._name.toLowerCase()]=F}else x=null;if(jQuery.ajaxSettings.data)x=jQuery.extend({},jQuery.ajaxSettings.data,x);return x},read:function(q){return this.xhr("GET",this.read_path(),null,function(x,F,B){B=jQuery.makeArray(B);x=[];F=0;for(var z=B.length;F<z;F++)x.push(new h(B[F]));q(x)})},read_path:function(){return g},update:function(q,x){return this.xhr("PUT",this.update_path(q),q,x)},update_path:function(q){return[this.path(q),
q.id()].join("/")},xhr:function(q,x,F,B){var z=this,N=q=="GET"?undefined:this.params(F);return jQuery.ajax({type:q,url:x+".json",dataType:"json",data:N,complete:function(P,la){z.xhrComplete(P,la,F,B)}})},xhrComplete:function(q,x,F,B){var z=Model.REST["handle"+q.status];z&&z.call(this,q,x,F);x=x==="success";z=Model.REST.parseResponseData(q);x&&F&&z&&F.attr(z);B&&B.call(F,x,q,z)}},j)};
...
L[M]=S}return L}function j(c,A,L){return c.startState?c.startState(A,L):true}function l(c){this.pos=this.start=0;this.string=c}function s(c,A){this.styles=A||[c,null];this.stateAfter=null;this.text=c;this.marked=this.gutterMarker=this.className=null}function q(c,A,L,M){for(var S=0,ja=0,ia=0;ja<A;S+=2){var wa=L[S],Ga=ja+wa.length;if(ia==0){Ga>c&&M.push(wa.slice(c-ja,Math.min(wa.length,A-ja)),L[S+1]);if(Ga>=c)ia=1}else if(ia==1)Ga>A?M.push(wa.slice(0,A-ja),L[S+1]):M.push(wa,L[S+1]);ja=Ga}}function x(){this.time=
...
s.prototype={replace:function(c,A,L){var M=[],S=this.marked;q(0,c,this.styles,M);L&&M.push(L,null);q(A,this.text.length,this.styles,M);this.styles=M;this.text=this.text.slice(0,c)+L+this.text.slice(A);this.stateAfter=null;if(S){c=L.length-(A-c);L=this.text.length;for(M=0;M<S.length;++M){var ja=S[M],ia=false;if(ja.from>=L)ia=true;else{ja.from=ja.from<=Math.min(A,A+c)?ja.from:ja.from+c;if(ja.to!=null)ja.to=ja.to<=Math.min(A,A+c)?ja.to:ja.to+c}if(ia||ja.from>=ja.to){S.splice(M,1);M--}}}},split:function(c,
A){var L=[A,null];q(c,this.text.length,this.styles,L);return new s(A+this.text.slice(c),L)},addMark:function(c,A,L){c={from:c,to:A,style:L};if(this.marked==null)this.marked=[];this.marked.push(c);this.marked.sort(function(M,S){return M.from-S.from});return c},removeMark:function(c){var A=this.marked;if(A)for(var L=0;L<A.length;++L)if(A[L]==c){A.splice(L,1);break}},highlight:function(c,A){var L=new l(this.text),M=this.styles,S=0,ja=false,ia=M[0],wa;for(this.text==""&&c.blankLine&&c.blankLine(A);!L.eol();){var Ga=
...
jQuery.cookie=function(h,g,j){if(typeof g!="undefined"){j=j||{};if(g===null){g="";j.expires=-1}var l="";if(j.expires&&(typeof j.expires=="number"||j.expires.toUTCString)){if(typeof j.expires=="number"){l=new Date;l.setTime(l.getTime()+j.expires*24*60*60*1E3)}else l=j.expires;l="; expires="+l.toUTCString()}var s=j.path?"; path="+j.path:"",q=j.domain?"; domain="+j.domain:"";j=j.secure?"; secure":"";document.cookie=[h,"=",encodeURIComponent(g),l,s,q,j].join("")}else{g=null;if(document.cookie&&document.cookie!=
""){j=document.cookie.split(";");for(l=0;l<j.length;l++){s=jQuery.trim(j[l]);if(s.substring(0,h.length+1)==h+"="){g=decodeURIComponent(s.substring(h.length+1));break}}}return g}};
...
Sanskrit.removeClassName=function(h,g){for(var j=(Sanskrit.getClassName(h)||"").split(" "),l=[],s=0;s<j.length;s++)j[s]!=g&&l.push(j[s]);l=l.join(" ");Sanskrit.setClassName(h,l);return l};Sanskrit.defaultStyle="html { padding:0; cursor:text; } body { font-size:90%; margin:0; padding:0.5em; cursor:text; } p { margin: 0.5em 0; }";Sanskrit.editors=[];
...
var g=h.toolbar;(h=h.toggleTextarea())?g.activateListItem("textile"):g.deactivateListItem("textile");for(var j in g.actions)if(g.actions.hasOwnProperty(j)&&j!=="textile")h?g.hideListItem(j):g.showListItem(j);return false}},callbacks:{},createAction:function(h,g){var j=this,l=h.onclick||function(){};return function(){l();if(j.actions[g](j.editor)!==false){var s="on"+g.slice(0,1).toUpperCase()+g.slice(1);typeof j.callbacks[s]==="function"&&j.callbacks[s].call(j.editor);j.updateListStatus(j.editor.getCurrentAncestors());
...
CodeMirror.defineMode("javascript",function(h,g){function j(H,ea){for(var aa=false,ha;(ha=H.next())!=null;){if(ha==ea&&!aa)return false;aa=!aa&&ha=="\\"}return aa}function l(H,ea,aa){ia=H;wa=aa;return ea}function s(H,ea){var aa=H.next();if(aa=='"'||aa=="'"){aa=q(aa);ea.tokenize=aa;return aa(H,ea)}else if(/[\[\]{}\(\),;\:\.]/.test(aa))return l(aa);else if(aa=="0"&&H.eat(/x/i)){H.eatWhile(/[\da-f]/i);return l("number","js-atom")}else if(/\d/.test(aa)){H.match(/^\d*(?:\.\d*)?(?:e[+\-]?\d+)?/);return l("number",
...
aa)}}function q(H){return function(ea,aa){if(!j(ea,H))aa.tokenize=s;return l("string","js-string")}}function x(H,ea){for(var aa=false,ha;ha=H.next();){if(ha=="/"&&aa){ea.tokenize=s;break}aa=ha=="*"}return l("comment","js-comment")}function F(H,ea,aa,ha,sa,ta){this.indented=H;this.column=ea;this.type=aa;this.prev=sa;this.info=ta;if(ha!=null)this.align=ha}function B(){for(var H=arguments.length-1;H>=0;H--)ua.cc.push(arguments[H])}function z(){B.apply(null,arguments);return true}function N(H){var ea=
...
CodeMirror.defineMode("xml",function(h,g){function j(T,fa){function ga(Oa){fa.tokenize=Oa;return Oa(T,fa)}var xa=T.next();if(xa=="<")if(T.eat("!"))if(T.eat("["))return T.match("CDATA[")?ga(q("xml-cdata","]]\>")):null;else if(T.match("--"))return ga(q("xml-comment","--\>"));else if(T.match("DOCTYPE")){T.eatWhile(/[\w\._\-]/);return ga(q("xml-doctype",">"))}else return null;else if(T.eat("?")){T.eatWhile(/[\w\._\-]/);fa.tokenize=q("xml-processing","?>");return"xml-processing"}else{E=T.eat("/")?"closeTag":
"openTag";T.eatSpace();for(y="";xa=T.eat(/[^\s\u00a0=<>\"\'\/?]/);)y+=xa;fa.tokenize=l;return"xml-tag"}else if(xa=="&"){T.eatWhile(/[^;]/);T.eat(";");return"xml-entity"}else{T.eatWhile(/[^&<]/);return null}}function l(T,fa){var ga=T.next();if(ga==">"||ga=="/"&&T.eat(">")){fa.tokenize=j;E=ga==">"?"endTag":"selfcloseTag";return"xml-tag"}else if(ga=="="){E="equals";return null}else if(/[\'\"]/.test(ga)){fa.tokenize=s(ga);return fa.tokenize(T,fa)}else{T.eatWhile(/[^\s\u00a0=<>\"\'\/?]/);return"xml-word"}}
function s(T){return function(fa,ga){for(;!fa.eol();)if(fa.next()==T){ga.tokenize=l;break}return"xml-attribute"}}function q(T,fa){return function(ga,xa){for(;!ga.eol();){if(ga.match(fa)){xa.tokenize=j;break}ga.next()}return T}}function x(){for(var T=arguments.length-1;T>=0;T--)ca.cc.push(arguments[T])}function F(){x.apply(null,arguments);return true}function B(T,fa){var ga=m.doNotIndent.hasOwnProperty(T)||ca.context&&ca.context.noIndent;ca.context={prev:ca.context,tagName:T,indent:ca.indented,startOfLine:fa,
...
function P(T){if(T=="endTag")return F();return x()}function la(T){if(T=="xml-word"){oa="xml-attname";return F(la)}if(T=="equals")return F(pa,la);return x()}function pa(T){if(T=="xml-word"&&m.allowUnquoted){oa="xml-attribute";return F()}if(T=="xml-attribute")return F();return x()}var na=h.indentUnit,m=g.htmlMode?{autoSelfClosers:{br:true,img:true,hr:true,link:true,input:true,meta:true,col:true,frame:true,base:true,area:true},doNotIndent:{pre:true,"!cdata":true},allowUnquoted:true}:{autoSelfClosers:{},
...
CodeMirror.defineMode("css",function(h){function g(B,z){F=z;return B}function j(B,z){var N=B.next();if(N=="@"){B.eatWhile(/\w/);return g("css-at",B.current())}else if(N=="/"&&B.eat("*")){z.tokenize=l;return l(B,z)}else if(N=="<"&&B.eat("!")){z.tokenize=s;return s(B,z)}else if(N=="=")g(null,"compare");else if((N=="~"||N=="|")&&B.eat("="))return g(null,"compare");else if(N=='"'||N=="'"){z.tokenize=q(N);return z.tokenize(B,z)}else if(N=="#"){B.eatWhile(/\w/);return g("css-selector","hash")}else if(N==
"!"){B.match(/^\s*\w*/);return g("css-important","important")}else if(/\d/.test(N)){B.eatWhile(/[\w.%]/);return g("css-unit","unit")}else if(/[,.+>*\/]/.test(N))return g(null,"select-op");else if(/[;{}:\[\]]/.test(N))return g(null,N);else{B.eatWhile(/[\w\\\-_]/);return g("css-identifier","identifier")}}function l(B,z){for(var N=false,P;(P=B.next())!=null;){if(N&&P=="/"){z.tokenize=j;break}N=P=="*"}return g("css-comment","comment")}function s(B,z){for(var N=0,P;(P=B.next())!=null;){if(N>=2&&P==">"){z.tokenize=
j;break}N=P=="-"?N+1:0}return g("css-comment","comment")}function q(B){return function(z,N){for(var P=false,la;(la=z.next())!=null;){if(la==B&&!P)break;P=!P&&la=="\\"}if(!P)N.tokenize=j;return g("css-string","string")}}var x=h.indentUnit,F;return{startState:function(B){return{tokenize:j,baseIndent:B||0,stack:[]}},token:function(B,z){if(B.eatSpace())return null;var N=z.tokenize(B,z),P=z.stack[z.stack.length-1];if(F=="hash"&&P=="rule")N="css-colorcode";else if(N=="css-identifier")if(P=="rule")N="css-value";
...
CodeMirror.defineMode("liquid",function(h){function g(B,z){var N=q.token(B,z.htmlState);if(N=="xml-tag"&&B.current()==">"&&z.htmlState.context)if(/^script$/i.test(z.htmlState.context.tagName)){z.token=l;z.localState=x.startState(q.indent(z.htmlState,""))}else if(/^style$/i.test(z.htmlState.context.tagName)){z.token=s;z.localState=F.startState(q.indent(z.htmlState,""))}return N}function j(B,z,N){var P=B.current();z=P.search(z);z>-1&&B.backUp(P.length-z);return N}function l(B,z){if(B.match(/^<\/\s*script\s*>/i,
false)){z.token=g;z.curState=null;return g(B,z)}return j(B,/<\/\s*script\s*>/,x.token(B,z.localState))}function s(B,z){if(B.match(/^<\/\s*style\s*>/i,false)){z.token=g;z.localState=null;return g(B,z)}return j(B,/<\/\s*style\s*>/,F.token(B,z.localState))}var q=CodeMirror.getMode(h,{name:"xml",htmlMode:true}),x=CodeMirror.getMode(h,"javascript"),F=CodeMirror.getMode(h,"css");return{startState:function(){var B=q.startState();return{token:g,localState:null,htmlState:B}},copyState:function(B){if(B.localState)var z=
CodeMirror.copyState(B.token==s?F:x,B.localState);return{token:B.token,localState:z,htmlState:CodeMirror.copyState(q,B.htmlState)}},token:function(B,z){return z.token(B,z)},indent:function(B,z){return B.token==g||/^\s*<\//.test(z)?q.indent(B.htmlState,z):B.token==l?x.indent(B.localState,z):F.indent(B.localState,z)},electricChars:"/{}:"}});CodeMirror.defineMIME("text/html","htmlmixed");
var Asset=Model("asset",function(){this.persistence(Model.REST,"/admin/assets");this.include({toMustache:function(h){this.merge({query_path:h?"?"+decodeURIComponent(jQuery.param({query:h})):"",query:h});return this.attr()},toMustacheWithNeighbors:function(h){var g=Asset.all(),j=g.indexOf(this),l=this.toMustache(h),s=g[j+1]?Asset.all()[j+1].toMustache(h):null;h=g[j-1]?Asset.all()[j-1].toMustache(h):null;jQuery("<img />")[0].src="/images/large/"+l.id+"/"+l.file_name;if(s)jQuery("<img />")[0].src="/images/large/"+
s.id+"/"+s.file_name;if(h)jQuery("<img />")[0].src="/images/large/"+h.id+"/"+h.file_name;return{asset:l,next:s,previous:h}}});this.extend({toMustache:function(h){var g=h?"?"+decodeURIComponent(jQuery.param({query:h})):"";return{assets:this.map(function(j){j.merge({query_path:g,query:h});return j.attr()}),query:h}},asJSON:function(){return Asset.map(function(h){return h.attr()})},tags:function(){tags=[];Asset.map(function(){tags=tags.concat(this.attr("tags"))});return tags},searchRemote:function(h,
g){var j=h!=null?decodeURIComponent(jQuery.param({query:h})):"";Asset.each(function(){Asset.remove(this)});jQuery.ajax({type:"get",url:"/search.json",contentType:"application/json",dataType:"json",data:j,success:function(l){jQuery.each(l,function(s,q){var x=new Asset({id:q.id});x.merge(q);Asset.add(x)});g.call(this)}})},searchAdmin:function(h,g){Asset.each(function(){Asset.remove(this)});jQuery.ajax({type:"get",url:"/admin/assets.json",contentType:"application/json",dataType:"json",data:h,success:function(j){$.each(j,
function(l,s){var q=new Asset({id:s.id});q.merge(s);Asset.add(q)});g.call(this)}})},keys:{},create:function(h,g){Asset.callback=g;var j=new XMLHttpRequest,l=Asset.generate_uuid();j.upload.uuid=l;j.upload.filename=h.name;j.upload.addEventListener("loadstart",Asset.onloadstartHandler,false);j.upload.addEventListener("progress",Asset.onprogressHandler);j.upload.addEventListener("load",Asset.onloadHandler,false);j.addEventListener("readystatechange",Asset.onreadystatechangeHandler,false);j.open("POST",
"/admin/assets.json",true);j.setRequestHeader("Content-Type","application/octet-stream");j.setRequestHeader("X-File-Name",h.name);j.setRequestHeader("X-File-Upload","true");j.send(h);g.before&&g.before.call(this,l)},onloadstartHandler:function(){},onloadHandler:function(){},onprogressHandler:function(h){var g=Math.round(h.loaded/h.total*100);Asset.callback.progress&&Asset.callback.progress.call(this,h.target.uuid,g)},onreadystatechangeHandler:function(h){var g=null;try{g=h.target.status}catch(j){return}if(g==
"200"&&h.target.readyState==4&&h.target.responseText){h=JSON.parse(h.target.responseText);g=new Asset({id:h.id});g.merge(h);Asset.add(g);Asset.callback.success&&Asset.callback.success.call(this,g)}},generate_uuid:function(){for(var h=[],g=0;g<32;g++)h[g]="0123456789ABCDEF".substr(Math.floor(Math.random()*16),1);h[12]="4";h[16]="0123456789ABCDEF".substr(h[16]&3|8,1);return h.join("")}})}),Page=Model("page",function(){this.persistence(Model.SinatraREST,"/admin/pages");this.include({children:function(){return Page.find_all_by_parent_id(this.id())},
has_children:function(){if(this.children().all().length>0)return true},assets:function(){for(var h=this.attr("assets"),g=0,j=h.length;g<j;++g){var l=h[g],s=new Asset({id:l.id});s.merge(l);Asset.add(s)}return Asset},parts:function(){for(var h=this.attr("parts"),g=0,j=h.length;g<j;++g){var l=h[g],s=new Part({id:l.id});s.merge(l);s.attr("page_id",this.id());Part.add(s)}return Part},load:function(h){var g=this,j="/admin/pages/"+g.id()+".json";jQuery.ajax({type:"GET",url:j,dataType:"json",success:function(l){g.merge(l);
h.call(this)}})},saveRemote:function(h,g){var j=this,l="/admin/pages/"+this.id()+".json";jQuery.ajax({type:"PUT",url:l,data:h,dataType:"json",success:function(s){if(s.errors){alert(JSON.stringify(s.errors));g.error&&g.error.call(this)}else{j.merge(s);g.success&&g.success.call(this)}}})}});this.extend({toMustache:function(){return{pages:this.map(function(h){return h.attr()})}},asJSON:function(){return Page.map(function(h){return h.attr()})},root:function(){return this.detect(function(){return this.attr("parent_id")==
null})},find_by_parent_id:function(h){return this.detect(function(){return this.attr("parent_id")==h})},find_all_by_parent_id:function(h){return this.select(function(){return this.attr("parent_id")==h})},create:function(h,g){jQuery.ajax({type:"post",url:"/admin/pages.json",dataType:"json",data:{page:h},success:function(j){var l=new Page({id:j.id});l.merge(j);Page.add(l);g.call(this,j)}})}})}),Layout=Model("template",function(){this.persistence(Model.SinatraREST,"/admin/templates");this.include({});
this.extend({toMustache:function(){return{layouts:this.map(function(h){return h.attr()})}},asLayoutJSON:function(h){return Layout.find_all_by_class("Layout").map(function(g){h==g.id()?g.attr("selected",'selected="selected"'):g.attr("selected","");return g.attr()})},find_by_class:function(h){return this.detect(function(){return this.attr("klass")==h})},find_all_by_class:function(h){return this.select(function(){return this.attr("klass")==h})},asJSON_by_class:function(h){return this.find_all_by_class(function(){return h.map(function(g){return g.attributes})})}})}),
Part=Model("part",function(){this.include({deleteRemote:function(h,g){var j="/admin/pages/"+h.id()+"/parts/"+this.id()+".json";jQuery.ajax({type:"DELETE",url:j,dataType:"json",success:function(l){h.merge(l);g.call(this)}})}});this.extend({toMustache:function(){return{parts:this.map(function(h){return h.attr()})}},create:function(h,g){var j="/admin/templates/"+h.template_id+"/parts.json",l=Layout.find(h.template_id);jQuery.ajax({type:"post",url:j,dataType:"json",data:{part:h},success:function(s){l.merge(s);
g.call(this)}})}})}),Site=Model("site",function(){this.persistence(Model.SinatraREST,"/admin/sites");this.include({});this.extend({toMustache:function(){return{sites:this.map(function(h){return h.attr()})}}})}),User=Model("user",function(){this.persistence(Model.SinatraREST,"/admin/users");this.include({});this.extend({toMustache:function(){return{users:this.map(function(h){return h.attr()})}}})}),Galerie={open:function(h,g){$("body").append('<div id="overlay"></div>').append('<div id="modal_wrapper"><div id="modal"></div></div>');
var j=$("#modal");j.html(h);var l=$("#modal_wrapper"),s=$(window).height();j=j.height()+42;j=(s-j)/2;$("#overlay").css({height:s}).hide().fadeIn("fast");l.hide().fadeIn("fast").css({top:j});g&&g.call(this)},close:function(){$("#modal_wrapper").fadeOut("fast",function(){$(this).remove();$("#overlay").fadeOut("fast",function(){$(this).remove()})})}},logger={info:function(h){window.console&&console.log(h)},debug:function(h){window.console&&console.log(h)}},Utilities={notice:function(h){var g=jQuery(".notice");
g.text(h);g.slideDown("slow",function(){setTimeout(function(){g.slideUp("slow")},1E3)})},keyboard_nav:function(){jQuery("body").keydown(function(h){switch(h.keyCode){case 37:$("a.previous").click();break;case 39:$("a.next").click();break}})},check_browser_version:function(){if(!Modernizr.history){jQuery("a").live("click",function(g){g.preventDefault();document.location.hash=$(this).attr("href")});var h=jQuery("form#search-form");h.attr("action","#"+h.attr("action"))}},formObserver:function(h){jQuery(h).keyup(function(){delay(function(){jQuery(h).parents("form:first").submit()},
800)})}},iFramer={initialize:function(h,g){var j=jQuery(h),l=this;j.length&&j.load(function(){var s=$(this).contents().find("span.part-editor"),q=s.find("a");logger.info("load");$(this).fadeIn("fast");l.setEditFlags(s);q.click(function(){window.top.trigger=$(this);window.top.location.hash=$(this).attr("href");return false});g&&g.call(this)})},setEditFlags:function(h){h.css({position:"relative",display:"block",height:"0",width:"0","text-decoration":"none"}).find("span").css({display:"block",position:"absolute",
top:"-24px",left:"12px",padding:"4px 8px",width:"100px",background:"rgba(255, 255, 0, 0.7)"})}},TabControl={initialize:function(h){if(h=jQuery(h)){h.each(function(g,j){$(j).hide()});h.first().show();this.tabControl(jQuery(".tab-control"))}},tabControl:function(h){h.click(function(){var g="tab-"+$(this).find("label").attr("for").split("-")[1];console.log(g);jQuery(".tab").hide();jQuery("#"+g).show()})}},delay=function(){var h=0;return function(g,j){clearTimeout(h);h=setTimeout(g,j)}}();
...
this.post("#/templates",function(g){(new Layout(g.params.template)).save(function(j,l){var s=JSON.parse(l.responseText);if(s.errors)Utilities.notice(JSON.stringify(s));else{g.redirect("#/templates");Utilities.notice("Successfully saved template")}})});this.get("#/templates/:id/edit",function(g){Galerie.close();h.refresh_pages=true;this.loadLayouts(function(){var j=Layout.find(g.params.id);g.renderLayout(j);g.renderLayoutIndex(Layout.all())})});this.put("#/templates/:id",function(g){var j=Layout.find(g.params.id);
...
Assets=Sammy(function(){var h=this;this.debug=false;this.disable_push_state=true;this.use(Sammy.JSON);this.use(Sammy.Mustache);this.use(Sammy.NestedParams);this.swap=function(g){jQuery("#editor").html(g)};this.helpers({loadAssets:function(g,j){if(Asset.all().length==0)Asset.searchAdmin(g,function(){j&&j.call(this)});else j&&j.call(this)},send_files:function(g,j,l){for(var s=0,q=0;q<g.length;q++){var x=g[q];Asset.create(x,{before:function(F){jQuery(".progress").append('<p id="progress-'+F+'">'+x.name+
'<span class="percentage"></span></p>')},progress:function(F,B){jQuery("#progress-"+F+" .percentage").text(" "+B+"%")},success:function(){s+=1;s==g.length&&Asset.searchAdmin(j,function(){l&&l.call(this)})}})}}});this.bind("run",function(){h.modal=false;h.first_run=true});this.get("#/assets",function(g){var j=g.params.query,l=j?{query:j}:{};l.limit=g.params.limit||48;l.page=g.params.page||1;Galerie.close();h.modal||Asset.searchAdmin(l,function(){g.render("/templates/admin/assets/index.mustache",Asset.toMustache(j)).replace("#editor").then(function(){jQuery("#ajax_uploader").attr("multiple",
"multiple")})});h.modal=false;h.first_run=false});this.get("#/assets/new",function(g){g.render("/templates/admin/assets/new.mustache").replace("#editor").then(function(){jQuery("#ajax_uploader").attr("multiple","multiple")});h.first_run=false});this.post("/admin/assets",function(g){var j=this,l=document.getElementById("ajax_uploader").files,s=g.params.query?g.params.query:null;jQuery("form#new_asset");var q=s?{query:s}:{};q.limit=g.params.limit||48;q.page=g.params.page||1;this.send_files(l,q,function(){j.render("/templates/admin/assets/index.mustache",
Asset.toMustache(q.query)).replace("#editor").then(function(){jQuery("#ajax_uploader").attr("multiple","multiple")})});return false});this.get("#/assets/:id/edit",function(g){var j=g.params.query?g.params.query:null;this.loadAssets(j?{query:g.params.query}:{},function(){var l=Asset.find(g.params.id);g.render("/templates/admin/assets/edit.mustache",l.toMustacheWithNeighbors(j)).replace("#editor").then(function(){setTimeout(function(){$("img.fade-in").fadeIn("slow")},100);Utilities.formObserver(".image-info input[type=text], .image-info textarea")})});
h.modal=false});this.put("#/assets/:id",function(g){var j=Asset.find(g.params.id);j.attr(g.params.asset);j.save(function(l){l&&Utilities.notice("Successfully saved asset")})});this.get("#/assets/:id/remove",function(g){var j=g.params.query?g.params.query:null,l=j?{query:g.params.query}:null;Galerie.close();Galerie.open(jQuery("<div />").attr({id:"remove-asset-container","class":"wide-modal"}));this.loadAssets(l,function(){var s=Asset.find(g.params.id);g.render("/templates/admin/assets/remove.mustache",
{asset:s.toMustache(j)}).replace("#remove-asset-container");h.first_run&&g.render("/templates/admin/assets/index.mustache",Asset.toMustache(j)).replace("#editor")})});this.del("#/assets/:id",function(g){var j=g.params.query?g.params.query:null,l=j?"?"+decodeURIComponent(jQuery.param({query:j})):"";Asset.find(g.params.id).destroy(function(s){if(s){Galerie.close();Utilities.notice("Successfully saved asset");g.redirect("#/assets"+l)}})})});
Pages=Sammy(function(h){var g=this;this.debug=false;this.disable_push_state=true;this.use(Sammy.JSON);this.use(Sammy.Mustache);this.use(Sammy.NestedParams);h.helpers({loadPages:function(j){if(Page.all().length==0)Page.load(function(){Layout.load(function(){j&&j.call(this)})});else j&&j.call(this)},renderTree:function(j,l){var s=this;s.render("/templates/admin/pages/node.mustache",{pages:[j.asJSON()]}).replace("#sidebar").then(function(){s.renderNode(j,l)})},renderNode:function(j,l){var s=this;pageNode=
s.render("/templates/admin/pages/node.mustache",j.children().toMustache());pageNode.appendTo("#page-"+j.id()).then(function(){j.children().each(function(q){q.id()==l.id()&&jQuery("li#page-"+q.id()).addClass("active");if(q.has_children()==true){jQuery("#page-"+q.id()).addClass("open");s.renderNode(q,l)}})})},renderPagePreview:function(j,l){g.modal||this.render("/templates/admin/pages/show.mustache",{page:j.asJSON(),layouts:Layout.asLayoutJSON(j.attr("layout_id")),base_page_id:j.id()}).replace("#editor").then(function(){iFramer.initialize(".preview iframe",
...
true;g.modal=false;jQuery(".add-asset").live("click",function(){g.application.trigger("add-asset");return false});jQuery("#sidebar .opener").live("click",function(){var j=(new Date).getTime();j=$(this).parents("li:first");var l=this.id.split("-")[2],s=Page.find(l),q=jQuery.cookie("active_page_ids");q=q?q.split(","):[];if(j.hasClass("open")){j.toggleClass("open");q=jQuery.grep(q,function(x){return x!=l});jQuery.cookie("active_page_ids",q.join(","),{path:"/admin"});s.children().each(function(x){Page.remove(x)});
jQuery("#page-"+l+" ul").remove()}else{q.push(l);j.toggleClass("open");j=(new Date).getTime();jQuery.cookie("active_page_ids",q.join(","),{path:"/admin"});Page.load(function(){g.application.renderNode(s)})}g.refresh_pages=false;return g.modal=false})});this.get("#/pages/?",function(j){Galerie.close();g.refresh_pages&&j.loadPages(function(){j.renderTree(Page.root(),Page.root());logger.info("pages")});jQuery("#editor").html('<h1 class="section">Pages</div>');g.refresh_pages=true;g.do_not_refresh=false});
this.get("#/pages/:id/new/?",function(j){this.loadPages(function(){var l=Page.find(j.params.id),s=$("<div />").attr({id:"new-page-container","class":"small-modal"});$("#modal").length==0&&Galerie.open(s);if(g.refresh_pages){j.renderTree(Page.root(),l);g.refresh_pages=true}j.render("/templates/admin/pages/new.mustache",{parent:l.asJSON(),layouts:Layout.asLayoutJSON(l.attr("layout_id"))}).replace("#new-page-container")})});this.post("#/pages/:page_id",function(j){Page.find(j.params.page_id);(new Page(j.params.page)).save(function(l,
s){var q=JSON.parse(s.responseText);if(q.errors)alert(JSON.stringify(q));else{g.refresh_pages=true;Utilities.notice("Successfully saved page");j.redirect("#/pages/"+q.id)}})});this.get("#/pages/:id/?",function(j){var l=this;Galerie.close();jQuery(".modal-editor").remove();this.loadPages(function(){var s=j.params.id,q=Page.find(s);if(g.do_not_refresh)l.close_page_editor();else{if(q)j.renderPagePreview(q);else{q=new Page({id:s});q.load(function(){j.renderPagePreview(q)})}g.modal=false;g.do_not_refresh=
false;if(g.refresh_pages){j.renderTree(Page.root(),q);g.refresh_pages=false}}});g.do_not_refresh=false});this.get("#/pages/:id/edit/?",function(j){var l=this;Galerie.close();g.modal=false;this.loadPages(function(){var s=Page.find(j.params.id);if(jQuery("#preview-"+s.id()).length)l.open_page_editor();else{j.renderPagePreview(s,function(){l.open_page_editor()});if(g.refresh_pages){j.renderTree(Page.root(),s);g.refresh_pages=false}}});g.do_not_refresh=true});this.put("#/pages/:page_id",function(j){var l=
Page.find(j.params.page_id);l.attr(j.params.page);l.save(function(s){if(s){g.modal=false;Utilities.notice("Successfully saved page");j.renderTree(Page.root(),l)}})});this.get("#/pages/:id/remove",function(j){this.loadPages(function(){var l=Page.find(j.params.id),s=$("<div />").attr({id:"remove-page-container","class":"small-modal"});$("#modal").length==0&&Galerie.open(s);g.refresh_pages&&j.renderTree(Page.root(),Page.root());j.render("/templates/admin/pages/remove.mustache",{page:l.asJSON()}).replace("#remove-page-container")})});
this.del("/pages/:id",function(j){var l=j.params.id;Page.find(l).destroy(function(s){if(s){jQuery("#page-"+l).remove();g.refresh_pages=false;j.redirect("#/pages")}})});this.get("/pages/:id/results",function(j){this.loadPages(function(){var l=Page.find(j.params.id),s=j.params.query?j.params.query:null;Asset.searchAdmin(s?{query:s}:{},function(){Asset.each(function(q){q.attr("current_page_id",l.id());q.save()});j.render("/templates/admin/pages/search_results.mustache",Asset.toMustache()).replace("#search-results-container")})})});
this.get("#/pages/:page_id/assets/:id/add",function(j){this.loadPages(function(){var l=j.params.page_id,s=Page.find(l),q=Asset.find(j.params.id),x=jQuery("#page-asset-ids");x.attr("value");var F=x.attr("value")+","+q.id();x.attr("value",F);s.saveRemote({page:{assets_list:F}},{success:function(){var B=jQuery('<div class="asset" />').attr("id","page-asset-"+q.id()),z=jQuery('<a href="#/assets/'+q.id()+'/edit"></a>'),N=jQuery('<br /><a href="#/pages/'+s.id()+"/assets/"+q.id()+'/remove">Remove</a>');
z.append('<img src="/images/icons/'+q.id()+"/"+q.attr("file_name")+'" alt="'+q.attr("title")+'" /></a>');B.html(z);B.append(N);jQuery("#page-assets").append(B);var P=jQuery(".preview iframe");P.hide().attr("src",P.attr("src"));P.load(function(){P.fadeIn("fast")});g.do_not_refresh=true;j.redirect("#/pages/"+l)}})})});this.get("#/pages/:page_id/assets/:id/remove",function(j){this.loadPages(function(){var l=j.params.id,s=j.params.page_id,q=Page.find(s),x=jQuery("#page-asset-ids"),F=x.attr("value").split(","),
B=F.indexOf(l);B!=-1&&F.splice(B,1);x.attr("value",F);q.attr("assets_list",F.join(","));q.save(function(){jQuery("#page-asset-"+l).fadeOut("fast",function(){$(this).remove()});var z=jQuery(".preview iframe");z.hide().attr("src",z.attr("src"));z.load(function(){z.fadeIn("fast")});g.do_not_refresh=true;j.redirect("#/pages/"+s)})})})});
Pages=Sammy(function(h){var g=this;this.debug=false;this.disable_push_state=true;this.use(Sammy.JSON);this.use(Sammy.Mustache);this.use(Sammy.NestedParams);h.helpers({render_part:function(j,l,s){var q=this;q.render("/templates/admin/"+s+"/edit.mustache",{part:j.asJSON(),page:l.asJSON(),assets:Asset.asJSON()}).appendTo(jQuery("body")).then(function(){var x=jQuery(".modal-editor"),F=$("iframe").contents(),B=F.find("#editor-"+j.id());x.fadeIn("fast").css({top:B.offset().top-F.find("body").scrollTop()+
"px",left:B.offset().left+400+"px"});jQuery("#ajax_uploader").attr("multiple","multiple");q.set_asset_links(j,l);g.modal=true})},set_asset_links:function(j,l){jQuery("#search-results-container li.asset").each(function(s,q){var x=jQuery(q).find("a"),F=jQuery(q).attr("id").split("-")[1];x.click(function(B){B.preventDefault();B=l.attr("parts");for(var z=0,N=B.length;z<N;++z){var P=B[z];if(j.id()==P.id){P.asset_id=F;j.attr("asset_id",F);j.save()}}l.save(function(){jQuery(".modal-editor").remove();g.modal=
false;document.location.hash="#/pages/"+l.id()})})})}});this.get("#/pages/:page_id/parts/:id/edit",function(j){var l=this;jQuery(".modal-editor").remove();this.loadPages(function(){var s=Page.find(j.params.page_id),q=s.parts().find(j.params.id);$("iframe").length?l.render_part(q,s,"parts"):j.renderPagePreview(s,function(){l.render_part(q,s,"parts")})})});this.get("#/pages/:page_id/image_parts/:id/edit",function(j){var l=this;jQuery(".modal-editor").remove();this.loadPages(function(){var s=Page.find(j.params.page_id),
q=s.parts().find(j.params.id),x=$("iframe");Asset.searchAdmin({limit:"12"},function(){x.length?l.render_part(q,s,"image_parts"):j.renderPagePreview(s,function(){l.render_part(q,s,"image_parts")})})})});this.get("/pages/:page_id/parts/:id/results",function(j){var l=this;this.loadPages(function(){var s=Page.find(j.params.page_id),q=Part.find(j.params.id),x=j.params.query?j.params.query:null;Asset.searchAdmin(x?{query:x}:{},function(){j.render("/templates/admin/pages/search_results.mustache",Asset.toMustache()).replace("#search-results-container").then(function(){l.set_asset_links(q,
s)})})})});this.put("#/pages/:page_id/parts/:id",function(j){var l=j.params.id,s=j.params.page_id,q=Page.find(s),x=q.parts().find(l);logger.info(j.params.part);for(var F=q.attr("parts"),B=0,z=F.length;B<z;++B){x=F[B];if(l==x.id){var N=j.params.part.content;x.content=N;x=Part.find(x.id);x.attr("content",N);x.save()}}q.save(function(P){if(P){g.modal=false;j.redirect("#/pages/"+s)}})});this.post("#/pages/:page_id/image_parts/:id/assets",function(j){var l=this,s=Page.find(j.params.page_id),q=s.parts().find(j.params.id),
x=document.getElementById("ajax_uploader").files,F=j.params.query?j.params.query:null;jQuery("form#new_asset");F=F?{query:F}:{};F.limit=j.params.limit||48;F.page=j.params.page||1;this.send_files(x,F,function(){j.render("/templates/admin/pages/search_results.mustache",Asset.toMustache()).replace("#search-results-container").then(function(){jQuery("#ajax_uploader").attr("files",null);l.set_asset_links(q,s)})})})});
